...
public abstract class BracketedUnivariateSolverImpl<FUNC extends UnivariateFunction>
        implements BracketedUnivariateSolver<FUNC> {
     ...
     *                                      exceeded.
     */
    public Interval solveInterval(int maxEval, FUNC f, double min, double max)
