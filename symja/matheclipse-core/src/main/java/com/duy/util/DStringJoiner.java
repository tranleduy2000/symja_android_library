...
public final class DStringJoiner {
    ...
    public DStringJoiner(CharSequence delimiter,
                         CharSequence prefix,
                         CharSequence suffix) {
        DObjects.requireNonNull(prefix, "The prefix must not be null");
        DObjects.requireNonNull(delimiter, "The delimiter must not be null");
        DObjects.requireNonNull(suffix, "The suffix must not be null");
