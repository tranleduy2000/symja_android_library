...
public abstract class GusfieldTreeAlgorithmsTestBase
{
    ...
    public abstract void validateAlgorithm(
        SimpleWeightedGraph<Integer, DefaultWeightedEdge> network) throws Throwable;
     ...
     */
    @Test
    public void testTriangleGraph() throws Throwable {
     ...
     */
    @Test
    public void testSquareGraph() throws Throwable {
        SimpleWeightedGraph<Integer, DefaultWeightedEdge> network =
            new SimpleWeightedGraph<>(DefaultWeightedEdge.class);
     ...
     */
    @Test
    public void testGomoryHuExampleGraph() throws Throwable {
        SimpleWeightedGraph<Integer, DefaultWeightedEdge> network =
            new SimpleWeightedGraph<>(DefaultWeightedEdge.class);
        Graphs.addAllVertices(network, Arrays.asList(1, 2, 3, 4, 5, 6));
    ...
    @Test
    public void testGraphWithNoEdges() throws Throwable {
        SimpleWeightedGraph<Integer, DefaultWeightedEdge> network =
            new SimpleWeightedGraph<>(DefaultWeightedEdge.class);
     ...
     */
    @Test
    public void testWikipediaGraph() throws Throwable {
        // Example wikipedia
        SimpleWeightedGraph<Integer, DefaultWeightedEdge> network =
            new SimpleWeightedGraph<>(DefaultWeightedEdge.class);
     ...
     */
    @Test
    public void testDisconnectedGraph() throws Throwable {
        SimpleWeightedGraph<Integer, DefaultWeightedEdge> network =
            new SimpleWeightedGraph<>(DefaultWeightedEdge.class);
    ...
    @Test
    public void testRandomGraphs() throws Throwable {
