...
public class ASTNodeFactory implements INodeParserFactory {
      ...
      if (rhs instanceof FunctionNode) {
        ...
        if (r.size() == 3) {
          if (r.get(0).equals(factory.createSymbol("Set"))) {
            ...
            return factory
                .createFunction(factory.createSymbol("TagSetDelayed"), lhs, r.get(1), r.get(2));
          }
        }
      }
  ...
  private static class DivideOperator extends InfixOperator {
    ...
    public ASTNode createFunction(final INodeParserFactory factory, final ASTNode lhs,
      ...
      if (lhs.equals(IntegerNode.C1)) {
        return factory
            .createFunction(factory.createSymbol("Power"), rhs, factory.createInteger(-1));
      }
  ...
  private static class PreMinusOperator extends PrefixOperator {
    ...
    public ASTNode createFunction(final INodeParserFactory factory, final ASTNode argument) {
      return factory
          .createFunction(factory.createSymbol("Times"), factory.createInteger(-1), argument);
    }
  }
  ...
  static final String[] HEADER_STRINGS = {"MessageName", "Get", "PatternTest", "MapAll", "TimesBy",
      "Plus", "UpSet",
      "CompoundExpression", "Apply", "Map", "Unset", "Apply", "Apply", "ReplaceRepeated", "Less",
      "And", "Divide",
      "Set", "Increment", "Factorial2", "LessEqual", "NonCommutativeMultiply", "Factorial", "Times",
      "Power",
      ...
      "PrePlus",
      "RepeatedNull", "UnsameQ", "Rule", "UpSetDelayed", "PreIncrement", "Function", "Greater",
      "PreDecrement",
  ...
  public static final ApplyOperator APPLY_HEAD_OPERATOR = new ApplyOperator("@", "Apply",
      Precedence.APPLY_HEAD,
      InfixOperator.RIGHT_ASSOCIATIVE);
  public static final ApplyOperator APPLY_OPERATOR = new ApplyOperator("@@", "Apply",
      Precedence.APPLY,
      InfixOperator.RIGHT_ASSOCIATIVE);
  public static final ApplyOperator APPLY_LEVEL_OPERATOR = new ApplyOperator("@@@", "Apply",
      Precedence.APPLY,
      InfixOperator.RIGHT_ASSOCIATIVE);

  public static final TagSetOperator TAG_SET_OPERATOR = new TagSetOperator("/:", "TagSet",
      Precedence.TAGSET,
      InfixOperator.NONE);
    ...
    private static void init() {
      OPERATORS =
          new Operator[]{
              ...
              new InfixOperator("//@", "MapAll", Precedence.MAPALL,
                  InfixOperator.RIGHT_ASSOCIATIVE),
              new InfixOperator("*=", "TimesBy", Precedence.TIMESBY,
                  InfixOperator.RIGHT_ASSOCIATIVE),
              ...
              new InfixOperator("/=", "DivideBy", Precedence.DIVIDEBY,
                  InfixOperator.RIGHT_ASSOCIATIVE),
