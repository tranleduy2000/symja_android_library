...
import com.gx.common.base.Converter;
...
import com.gx.common.collect.MapDifference.ValueDifference;
...
import static com.gx.common.base.Predicates.compose;
import static com.gx.common.collect.CollectPreconditions.checkEntryNotNull;
import static com.gx.common.collect.CollectPreconditions.checkNonnegative;
...
public final class Maps {
     ...
     * com.gx.common.base.Functions#forMap(Map)} or {@link
     * com.gx.common.base.Functions#forMap(Map, Object)}.
     *
     * @since 16.0
     */
    @Beta
    ...
    static class TransformedEntriesMap<K, V1, V2> extends IteratorBasedAbstractMap<K, V2> {
        ...
        Iterator<Entry<K, V2>> entryIterator() {
            return Iterators.transform(
                    fromMap.entrySet().iterator(), Maps.asEntryToEntryFunction(transformer));
        }
