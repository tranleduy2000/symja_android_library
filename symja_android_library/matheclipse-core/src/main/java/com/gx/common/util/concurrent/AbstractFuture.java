 ...
 * com.gx.common.base.Function, Executor) Futures.transform} and {#link
 * Futures#catching(ListenableFuture, Class, com.gx.common.base.Function,
 ...
 * @since 1.0
 */
public abstract class AbstractFuture<V> extends GwtFluentFutureCatchingSpecialization<V> {
