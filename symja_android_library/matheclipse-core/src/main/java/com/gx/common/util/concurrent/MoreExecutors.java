...
import com.gx.common.collect.Queues;
import com.gx.common.util.concurrent.ForwardingListenableFuture.SimpleForwardingListenableFuture;
...
//                    Class.forName("com.gx.appengine.api.ThreadManager")
...
//        }
    ...
    private static boolean isAppEngine() {
        if (System.getProperty("com.gx.appengine.runtime.environment") == null) {
            return false;
        }
//        try {
//            // If the current environment is null, we're not inside AppEngine.
//            return Class.forName("com.gx.apphosting.api.ApiProxy")
