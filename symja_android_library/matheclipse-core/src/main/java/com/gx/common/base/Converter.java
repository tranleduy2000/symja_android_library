 ...
 * example round-trip using {@link com.gx.common.primitives.Doubles#stringConverter}:
 * <p>
 * <ol>
 ...
 * com.gx.common.collect.Maps#asConverter Maps.asConverter}. For example, use this to
 ...
 * com.duy.lambda.Function} is accepted (for example {@link java.util.stream.Stream#map
 * Stream.map}).
