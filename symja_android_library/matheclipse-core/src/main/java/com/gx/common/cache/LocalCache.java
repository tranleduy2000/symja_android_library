...
import com.gx.common.base.Stopwatch;
import com.gx.common.base.Ticker;
import com.gx.common.cache.AbstractCache.SimpleStatsCounter;
import com.gx.common.cache.AbstractCache.StatsCounter;
import com.gx.common.cache.CacheBuilder.NullListener;
import com.gx.common.cache.CacheBuilder.OneWeigher;
import com.gx.common.cache.CacheLoader.InvalidCacheLoadException;
import com.gx.common.cache.CacheLoader.UnsupportedLoadingOperationException;
import com.gx.common.collect.AbstractSequentialIterator;
import com.gx.common.collect.ImmutableMap;
import com.gx.common.collect.ImmutableSet;
import com.gx.common.collect.Iterators;
import com.gx.common.collect.Maps;
...
import com.gx.common.util.concurrent.SettableFuture;
...
import static com.gx.common.cache.CacheBuilder.NULL_TICKER;
import static com.gx.common.cache.CacheBuilder.UNSET_INT;
import static com.gx.common.util.concurrent.Futures.transform;
 ...
 *
 * @author Charles Fry
 * @author Bob Lee ({@code com.gx.common.collect.MapMaker})
...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    private boolean usesKeyReferences() {
        return keyStrength != Strength.STRONG;
    }

    private boolean usesValueReferences() {
    ...
    private int hash(@NullableDecl Object key) {
    ...
    private final Segment<K, V>[] newSegmentArray(int ssize) {
    ...
    private ImmutableMap<K, V> getAllPresent(Iterable<?> keys) {
        int hits = 0;
        int misses = 0;
     ...
     */
    @NullableDecl
    private Map<K, V> loadAll(Set<? extends K> keys, CacheLoader<? super K, V> loader)
    ...
    private void invalidateAll(Iterable<?> keys) {
        // TODO(fry): batch by segment
        for (Object key : keys) {
            remove(key);
        }
