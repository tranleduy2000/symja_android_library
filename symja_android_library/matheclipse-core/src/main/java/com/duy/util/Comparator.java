...
public class Comparator {
  ...
  public static <T> java.util.Comparator<T> comparingInt(
  ...
  public static <T> java.util.Comparator<T> comparing(final ToIntFunction<? super T> keyExtractor) {
    DObjects.requireNonNull(keyExtractor);
    return new java.util.Comparator<T>() {
      @Override
      public int compare(T c1, T c2) {
  ...
  public static <T> java.util.Comparator<T> reserveComparing(
      final ToIntFunction<? super T> keyExtractor) {
    DObjects.requireNonNull(keyExtractor);
    return new java.util.Comparator<T>() {
      @Override
