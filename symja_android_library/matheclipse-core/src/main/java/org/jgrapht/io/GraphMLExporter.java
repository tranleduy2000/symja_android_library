    ...
    GraphExporter<V, E>
{
    ...
    {
        this(
            new IntegerComponentNameProvider<V>(), null, null, new IntegerComponentNameProvider<E>(),
            null, null);
    }
        ...
        ComponentAttributeProvider<E> edgeAttributeProvider)
    {
        super(
            vertexIDProvider,
            DObjects.requireNonNull(edgeIDProvider, "Edge ID provider must not be null"));
