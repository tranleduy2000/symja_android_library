 ...
 * 
 * <p>
 * Weighted variants are also valid if {@link Parameter#EDGE_WEIGHTS} is set. In this case
 ...
 * 
 * <p>
 * In case {@link Parameter#MATRIX_FORMAT_ZERO_WHEN_NO_EDGE} is not set the equivalent
 * format would be:
 * 
 * <pre>
 * ,1,,1,
 ...
 * 
 * <p>
 * Weighted variants are also valid if {@link Parameter#EDGE_WEIGHTS} is set. The above
 ...
 * </pre>
 * 
 * If additionally {@link Parameter#MATRIX_FORMAT_ZERO_WHEN_NO_EDGE} is set then a zero as
 ...
 * 
 * <p>
 * If parameter {@link Parameter#MATRIX_FORMAT_NODEID} is set then node identifiers are
