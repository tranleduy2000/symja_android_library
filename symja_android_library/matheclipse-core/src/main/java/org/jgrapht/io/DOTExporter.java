    ...
    GraphExporter<V, E>
{
    ...
    public DOTExporter()
    {
        this(new IntegerComponentNameProvider<V>(), null, null, null, null, null);
    }
        ...
        ComponentNameProvider<Graph<V, E>> graphIDProvider)
    {
        ...
        this.graphIDProvider =
            (graphIDProvider == null) ? new ComponentNameProvider<Graph<V, E>>() {
                @Override
                public String getName(Graph<V, E> any) {
    ...
    {
        DObjects.requireNonNull(key, "Graph attribute key cannot be null");
    ...
    {
        DObjects.requireNonNull(key, "Graph attribute key cannot be null");
        DObjects.requireNonNull(value, "Graph attribute value cannot be null");
