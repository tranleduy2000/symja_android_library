 ...
 * (which is a rational number), you can use { Aprational#Aprational(double)}.
 *
...
public class Apfloat
     ...
     * @throws java.lang.NumberFormatException In case the number is invalid.
     */
     ...
     * @throws java.lang.IllegalArgumentException If <code>precision</code> is &lt;= 0.
     */
     ...
     * @param pretty <code>true</code> to use a fixed-point notation, <code>false</code> to use an exponential notation.
     * @throws java.io.IOException In case of I/O error writing to the stream.
     */
