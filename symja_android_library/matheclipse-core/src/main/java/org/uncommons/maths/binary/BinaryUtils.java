...
public final class BinaryUtils {
	...
	public static long convertBytesToLong(byte[] bytes, int offset) {
		...
		for (int i = offset; i < offset + 8; i++) {
            byte b = bytes[i];
            value <<= 8;
			// value |= b; - changed because of SpotBugs issue:
			value |= (b & 0xff);
        }
        return value;
    ...
    /**
	 * Converts a floating point value in the range 0 - 1 into a fixed point bit string (where the most significant bit
	 * has a value of 0.5).
	 *
	 * @param value
