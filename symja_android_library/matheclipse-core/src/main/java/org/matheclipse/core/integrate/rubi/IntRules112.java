...
IIntegrate(5649,Int(Sinh(Times(Sqr(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT))),d_DEFAULT)),x_Symbol),
    Condition(Plus(Negate(Dist(Power(C2,-1),Int(Exp(Times(CN1,d,Sqr(Plus(a,Times(b,Log(Times(c,Power(x,n)))))))),x),x)),Dist(C1D2,Int(Exp(Times(d,Sqr(Plus(a,Times(b,Log(Times(c,Power(x,n)))))))),x),x)),FreeQ(List(a,b,c,d,n),x))),
