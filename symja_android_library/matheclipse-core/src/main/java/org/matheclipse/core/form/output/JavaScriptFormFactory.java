 ...
 * </p>
 * <ul>
 * <li><a href="https://github.com/paulmasson/math">github.com/paulmasson/math</a></li>
...
public class JavaScriptFormFactory extends DoubleFormFactory {
	...
	public void convertAST(final StringBuilder buf, final IAST function) {
		...
		if (function.isAST(F.Defer, 2) || //
				function.isAST(F.Evaluate, 2) || //
				function.isAST(F.Hold, 2) || //
				function.isAST(F.Unevaluated, 2)) {
