...
public class ExpTrigsFunctions {
  ...
  private final static class ArcCosh extends AbstractTrigArg1Rewrite
    ...
    public IExpr rewriteLog(IExpr arg1, EvalEngine engine) {
      return
          ...
          F.Log(F.Plus(arg1,
              F.Times(F.Sqrt(F.Plus(F.CN1, arg1)), F.Sqrt(F.Plus(F.C1, arg1))))); // $$;
    }
  }
   ...
   * Inverse_trigonometric functions</a>
   */
  private final static class ArcCot extends AbstractTrigArg1Rewrite implements IRewrite,
      ArcCotRules, DoubleUnaryOperator {
      ...
      return
          ...
          F.Plus(F.Times(F.C1D2, F.CI, F.Log(F.Plus(F.C1, F.Times(F.CNI, F.Power(arg1, F.CN1))))),
              F.Times(F.CN1D2, F.CI,
                  F.Log(F.Plus(F.C1, F.Times(F.CI, F.Power(arg1, F.CN1)))))); // $$;
    }
  }
   ...
   * functions</a>
   */
  private final static class ArcCoth extends AbstractTrigArg1Rewrite implements IRewrite,
      ArcCothRules, DoubleUnaryOperator {
   ...
   */
  private final static class ArcCsc extends AbstractTrigArg1Rewrite implements IRewrite,
      ArcCscRules {
    ...
    public IExpr rewriteLog(IExpr arg1, EvalEngine engine) {
      return
          ...
          F.Times(F.CNI,
              F.Log(F.Plus(F.Sqrt(F.Subtract(F.C1, F.Power(arg1, F.CN2))),
   ...
   * functions</a>
   */
  private final static class ArcCsch extends AbstractTrigArg1Rewrite implements IRewrite,
      ArcCschRules {
   ...
   */
  private final static class ArcSech extends AbstractTrigArg1Rewrite implements IRewrite,
      ArcSechRules {
    ...
    public IExpr rewriteLog(IExpr arg1, EvalEngine engine) {
      return
          ...
          F.Log(F.Plus(
              F.Times(F.Sqrt(F.Plus(F.CN1, F.Power(arg1, F.CN1))),
  ...
  private final static class ArcSec extends AbstractTrigArg1Rewrite implements IRewrite,
      ArcSecRules {
    ...
    public IExpr rewriteLog(IExpr arg1, EvalEngine engine) {
      return
          ...
          F.Plus(F.CPiHalf, F.Times(F.CI, F
              .Log(F.Plus(F.Sqrt(F.Subtract(F.C1, F.Power(arg1, F.CN2))),
                  F.Times(F.CI, F.Power(arg1, F.CN1)))))); // $$;
    }
  }
   ...
   */
  private final static class ArcTan extends AbstractArg12Rewrite implements INumeric, IRewrite,
      ArcTanRules {
    ...
    public IExpr e2ObjArg(final IExpr x, final IExpr y) {
      ...
      if (x.isNumericFunction(true) && yUnitStep.isInteger()) {
        ...
        // -Pi/2 < Arg(x) <= Pi/2
        if (argX.isPresent() && F
            .evalTrue(F.And(F.Less(F.CNPiHalf, argX), F.LessEqual(argX, F.CPiHalf)))) {
    ...
    public IExpr rewriteLog(IExpr arg1, IExpr arg2, EvalEngine engine) {
      return
          ...
          F.Times(F.CNI, F.Log(
              F.Times(F.Plus(arg1, F.Times(F.CI, arg2)),
    ...
    public IExpr rewriteExp(IExpr arg1, EvalEngine engine) {
      return
          ...
          F.Times(F.CN1, F.C2, F.CI,
              F.Power(F.Subtract(F.Exp(F.Times(F.CNI, arg1)), F.Exp(F.Times(F.CI, arg1))),
                  F.CN1)); // $$;
    }
  }
        ...
        if (list.isPresent()) {
          ...
          if (k.isRational()) {
            ...
            if (t.isLT(F.C0)) {
              ...
              return F
                  .Cosh(F.Plus(arg1, F.Times(F.CN2, F.CI, F.Pi, F.IntegerPart(F.Times(F.C1D2, t))),
  ...
  private final static class Csch extends AbstractTrigArg1Rewrite
        ...
        if (list.isPresent()) {
          ...
          if (k.isRational()) {
            ...
            if (t.isLT(F.C0)) {
              ...
              return F
                  .Csch(F.Plus(arg1, F.Times(F.CN2, F.CI, F.Pi, F.IntegerPart(F.Times(F.C1D2, t))),
                      F.Times(F.C2, F.CI, F.Pi)));
            } else if (t.isLT(F.C1D2)) {// t < 1/2
              return F.NIL;
            } else if (t.isLT(F.C1)) {// t < 1
    ...
    public IExpr rewriteExp(IExpr arg1, EvalEngine engine) {
      return
          // [$ 2/(-E^(-arg1) + E^arg1) $]
          F.Times(F.C2,
              F.Power(F.Plus(F.Negate(F.Exp(F.Negate(arg1))), F.Exp(arg1)), F.CN1)); // $$;
    }
  }
  ...
  private static final class Log extends AbstractArg12 implements INumeric, LogRules {
    ...
    public IExpr e2ApfloatArg(final ApfloatNum d0, final ApfloatNum d1) {
      ...
      return F
          .complexNum(ApcomplexMath.log(d0.apfloatValue(precision), d1.apfloatValue(precision)));
    }
  ...
  private final static class Sec extends AbstractTrigArg1Rewrite
    ...
    public IExpr rewriteExp(IExpr arg1, EvalEngine engine) {
      return
          // [$ 2/(E^((-I)*arg1) + E^(I*arg1)) $]
          F.Times(F.C2, F.Power(F.Plus(F.Exp(F.Times(F.CNI, arg1)), F.Exp(F.Times(F.CI, arg1))),
              F.CN1)); // $$;
    }
  }
        ...
        if (list.isPresent()) {
          ...
          if (k.isRational()) {
            ...
            if (t.isLT(F.C0)) {
              ...
              return F
                  .Sech(F.Plus(arg1, F.Times(F.CN2, F.CI, F.Pi, F.IntegerPart(F.Times(F.C1D2, t))),
                      F.Times(F.C2, F.CI, F.Pi)));
            } else if (t.isLT(F.C1D2)) {// t < 1/2
              return F.NIL;
            } else if (t.isLT(F.C1)) {// t < 1
  ...
  private final static class Sin extends AbstractTrigArg1Rewrite
    ...
    public IExpr rewriteExp(IExpr arg1, EvalEngine engine) {
      ...
      return
          ...
          F.Plus(F.Times(F.CN1, F.Power(F.Times(F.C2, F.CI), F.CN1),
              F.Exp(F.Times(F.CN1, arg1, F.CI))),
   ...
   */
  private static class Sinc extends AbstractTrigArg1Rewrite implements INumeric, SincRules,
      DoubleUnaryOperator {
  ...
  private final static class Sinh extends AbstractTrigArg1Rewrite
        ...
        if (list.isPresent()) {
          ...
          if (k.isRational()) {
            ...
            if (t.isLT(F.C0)) {
              ...
              return F
                  .Sinh(F.Plus(arg1, F.Times(F.CN2, F.CI, F.Pi, F.IntegerPart(F.Times(F.C1D2, t))),
                      F.Times(F.C2, F.CI, F.Pi)));
            } else if (t.isLT(F.C1D2)) {// t < 1/2
              return F.NIL;
            } else if (t.isLT(F.C1)) {// t < 1
    ...
    public IExpr rewriteExp(IExpr arg1, EvalEngine engine) {
      return
          // [$ -(1/(E^arg1*2)) + E^arg1/2 $]
          F.Plus(F.Negate(F.Power(F.Times(F.Exp(arg1), F.C2), F.CN1)),
    ...
    public IExpr rewriteExp(IExpr arg1, EvalEngine engine) {
      ...
      return
          ...
          F.Times(F.CI, F.Subtract(F.Exp(F.Times(F.CNI, arg1)), F.Exp(F.Times(F.CI, arg1))),
              F.Power(F.Plus(F.Exp(F.Times(F.CNI, arg1)), F.Exp(F.Times(F.CI, arg1))),
                  F.CN1)); // $$;
    }
  }
        ...
        if (list.isPresent()) {
          ...
          if (k.isRational()) {
            ...
            if (t.isLT(F.C0)) {
              ...
              return F
                  .Tanh(F.Plus(arg1, F.Times(F.CNI, F.Pi, t.integerPart()), F.Times(F.CI, F.Pi)));
            } else if (t.isLT(F.C1D2)) {// t < 1/2
              return F.NIL;
            } else if (t.isLT(F.C1)) {// t < 1
              // Coth(arg1-1/2*I*Pi)
    ...
    public IExpr rewriteExp(IExpr arg1, EvalEngine engine) {
      return
          ...
          F.Plus(F.Negate(
              ...
              F.Times(F.Exp(arg1),
                  F.Power(F.Plus(F.Exp(F.Negate(arg1)), F.Exp(arg1)), F.CN1))); // $$;
    }
  }
  ...
  private static IExpr arcCosCos(final IExpr arg1) {
    ...
    if (k.isInteger()) {
      ...
      IAST result = F
          .Plus(F.Times(F.Power(F.CN1, k), F.Plus(z, F.Times(F.CN1, k, F.Pi), F.CNPiHalf)),
              F.CPiHalf);
