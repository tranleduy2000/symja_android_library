...
IIntegrate(2301,Int(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),Power(x_,-1)),x_Symbol),
    Condition(Simp(Times(Sqr(Plus(a,Times(b,Log(Times(c,Power(x,n)))))),Power(Times(C2,b,n),-1)),x),FreeQ(List(a,b,c,n),x))),
IIntegrate(2302,Int(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,-1)),x_Symbol),
...
IIntegrate(2307,Int(Times(Power(Log(Times(c_DEFAULT,Power(x_,n_))),-1),Power(x_,m_DEFAULT)),x_Symbol),
    Condition(Dist(Power(n,-1),Subst(Int(Power(Log(Times(c,x)),-1),x),x,Power(x,n)),x),And(FreeQ(List(c,m,n),x),EqQ(m,Plus(n,Negate(C1)))))),
IIntegrate(2308,Int(Times(Power(Log(Times(c_DEFAULT,Power(x_,n_))),-1),Power(Times(d_,x_),m_DEFAULT)),x_Symbol),
...
IIntegrate(2315,Int(Times(Log(Times(c_DEFAULT,x_)),Power(Plus(d_,Times(e_DEFAULT,x_)),-1)),x_Symbol),
    Condition(Negate(Simp(Times(PolyLog(C2,Plus(C1,Times(CN1,c,x))),Power(e,-1)),x)),And(FreeQ(List(c,d,e),x),EqQ(Plus(e,Times(c,d)),C0)))),
IIntegrate(2316,Int(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,x_)),b_DEFAULT)),Power(Plus(d_,Times(e_DEFAULT,x_)),-1)),x_Symbol),
...
IIntegrate(2317,Int(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(Plus(d_,Times(e_DEFAULT,x_)),-1)),x_Symbol),
...
IIntegrate(2318,Int(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(Plus(d_,Times(e_DEFAULT,x_)),-2)),x_Symbol),
...
IIntegrate(2324,Int(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
IIntegrate(2333,Int(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(Plus(d_,Times(e_DEFAULT,Power(x_,-1))),q_DEFAULT),Power(x_,m_DEFAULT)),x_Symbol),
...
IIntegrate(2337,Int(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(Times(f_DEFAULT,x_),m_DEFAULT),Power(Plus(d_,Times(e_DEFAULT,Power(x_,r_))),-1)),x_Symbol),
...
IIntegrate(2343,Int(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_))),b_DEFAULT)),Power(x_,-1),Power(Plus(d_,Times(e_DEFAULT,Power(x_,r_DEFAULT))),-1)),x_Symbol),
...
IIntegrate(2344,Int(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,-1),Power(Plus(d_,Times(e_DEFAULT,x_)),-1)),x_Symbol),
...
IIntegrate(2345,Int(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,-1),Power(Plus(d_,Times(e_DEFAULT,Power(x_,r_DEFAULT))),-1)),x_Symbol),
...
IIntegrate(2346,Int(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,-1),Power(Plus(d_,Times(e_DEFAULT,x_)),q_DEFAULT)),x_Symbol),
...
IIntegrate(2347,Int(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,-1),Power(Plus(d_,Times(e_DEFAULT,x_)),q_)),x_Symbol),
...
IIntegrate(2348,Int(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),Power(x_,-1),Power(Plus(d_,Times(e_DEFAULT,Power(x_,r_DEFAULT))),q_DEFAULT)),x_Symbol),
...
IIntegrate(2349,Int(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,-1),Power(Plus(d_,Times(e_DEFAULT,Power(x_,r_DEFAULT))),q_)),x_Symbol),
