...
public class InterpolatingFunctionExpr<T> extends DataExpr<T> {
	...
	private static class HermiteFunctionExpr extends InterpolatingFunctionExpr<FieldHermiteInterpolator> {
		...
		public HermiteFunctionExpr(final FieldHermiteInterpolator interpolator, double min, double max) {
			super(interpolator, min, max);
	...
	public static InterpolatingFunctionExpr newInstance(final FieldHermiteInterpolator<IExpr> interpolator, double min,
                                                        double max) {
		return new HermiteFunctionExpr(interpolator, min, max);
	}

	public static InterpolatingFunctionExpr newInstance(final IAST interpolator, double min, double max) {
	 ...
	 * @return
	 */
	public static InterpolatingFunctionExpr newInstance(final UpdatingMultipleLinearRegression value, double min,
                                                        double max) {
