...
public final class Combinatoric {
  ...
  private static final class IntegerPartitions extends AbstractFunctionEvaluator {
    ...
    private static IExpr frobeniusPartition(final IAST ast, EvalEngine engine) {
      if (ast.arg3().isNonEmptyList() && ast.arg1().isInteger()) {
        try {
          int[] listInt = Validate
              .checkListOfInts(ast, ast.arg3(), Integer.MIN_VALUE, Integer.MAX_VALUE,
                  engine);
          if (listInt != null) {
            ...
            while ((solution = solver.take()) != null) {
              if (iterationLimit > 0 && iterations > iterationLimit) {
                IOFunctions
                    .printMessage(ast.topHead(), "itlimpartial", F.List(F.ZZ(iterationLimit)),
                        engine);
                return result;
              }
  ...
  private static final class KOrderlessPartitions extends AbstractFunctionEvaluator {
    ...
    public IExpr evaluate(final IAST ast, EvalEngine engine) {
      ...
      if (ast.arg1().isAST() && ast.arg1().size() > 1 && k > 0) {
        ...
        final Permutations.KPermutationsIterable permutationIterator = new Permutations.KPermutationsIterable(
            listArg0, n, 1);
        final KPartitions.KPartitionsIterable partitionIterator = new KPartitions.KPartitionsIterable(
            n, k);
        IAST partition;
    ...
    private IAST createSinglePartition(final IAST listArg0, final ISymbol sym,
  ...
  public static final class Subsets extends AbstractFunctionEvaluator {
    ...
    public static final class KSubsetsList implements Iterator<IAST>, Iterable<IAST> {
      ...
      public KSubsetsList(final Iterator<int[]> iterable, final IAST list, final int k,
          IAST resultList) {
    ...
    public static KSubsetsList createKSubsets(final IAST list, final int k, IAST resultList,
        final int offset) {
      return new KSubsetsList(new KSubsets.KSubsetsIterable(list.size() - offset, k), list, k,
          resultList,
          offset);
    }
  }
  ...
  private static final class Tuples extends AbstractFunctionEvaluator {
     ...
     * @param engine
     */
    private void tuplesOfLists(final IAST originalList, final int k, IASTAppendable result,
        IAST subResult,
        IAST ast, EvalEngine engine) {
