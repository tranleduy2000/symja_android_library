...
public class IntRules36 {
    public static IAST RULES = List(
            ...
            IIntegrate(1803, Int(Times($p("§pq"), Power(x_, m_), Power(Plus(a_, Times(b_DEFAULT, Sqr(x_))), p_)), x_Symbol),
                    Condition(With(List(Set(ASymbol, Coeff($s("§pq"), x, C0)), Set(QSymbol, PolynomialQuotient(Plus($s("§pq"), Negate(Coeff($s("§pq"), x, C0))), Sqr(x), x))), Plus(Simp(Times(ASymbol, Power(x, Plus(m, C1)), Power(Plus(a, Times(b, Sqr(x))), Plus(p, C1)), Power(Times(a, Plus(m, C1)), -1)), x), Dist(Power(Times(a, Plus(m, C1)), -1), Int(Times(Power(x, Plus(m, C2)), Power(Plus(a, Times(b, Sqr(x))), p), Plus(Times(a, Plus(m, C1), QSymbol), Times(CN1, ASymbol, b, Plus(m, Times(C2, Plus(p, C1)), C1)))), x), x))), And(FreeQ(List(a, b), x), PolyQ($s("§pq"), Sqr(x)), IntegerQ(Times(C1D2, m)), ILtQ(Plus(Times(C1D2, Plus(m, C1)), p), C0), LtQ(Plus(m, Expon($s("§pq"), x), Times(C2, p), C1), C0)))),
            IIntegrate(1804, Int(Times($p("§pq"), Power(Times(c_DEFAULT, x_), m_DEFAULT), Power(Plus(a_, Times(b_DEFAULT, Sqr(x_))), p_)), x_Symbol),
                    Condition(With(List(Set(QSymbol, PolynomialQuotient($s("§pq"), Plus(a, Times(b, Sqr(x))), x)), Set(f, Coeff(PolynomialRemainder($s("§pq"), Plus(a, Times(b, Sqr(x))), x), x, C0)), Set(g, Coeff(PolynomialRemainder($s("§pq"), Plus(a, Times(b, Sqr(x))), x), x, C1))), Plus(Simp(Times(Power(Times(c, x), m), Power(Plus(a, Times(b, Sqr(x))), Plus(p, C1)), Plus(Times(a, g), Times(CN1, b, f, x)), Power(Times(C2, a, b, Plus(p, C1)), -1)), x), Dist(Times(c, Power(Times(C2, a, b, Plus(p, C1)), -1)), Int(Times(Power(Times(c, x), Plus(m, Negate(C1))), Power(Plus(a, Times(b, Sqr(x))), Plus(p, C1)), ExpandToSum(Plus(Times(C2, a, b, Plus(p, C1), x, QSymbol), Times(CN1, a, g, m), Times(b, f, Plus(m, Times(C2, p), C3), x)), x)), x), x))), And(FreeQ(List(a, b, c), x), PolyQ($s("§pq"), x), LtQ(p, CN1), GtQ(m, C0)))),
            IIntegrate(1805, Int(Times($p("§pq"), Power(Times(c_DEFAULT, x_), m_DEFAULT), Power(Plus(a_, Times(b_DEFAULT, Sqr(x_))), p_)), x_Symbol),
                    Condition(With(List(Set(QSymbol, PolynomialQuotient(Times(Power(Times(c, x), m), $s("§pq")), Plus(a, Times(b, Sqr(x))), x)), Set(f, Coeff(PolynomialRemainder(Times(Power(Times(c, x), m), $s("§pq")), Plus(a, Times(b, Sqr(x))), x), x, C0)), Set(g, Coeff(PolynomialRemainder(Times(Power(Times(c, x), m), $s("§pq")), Plus(a, Times(b, Sqr(x))), x), x, C1))), Plus(Simp(Times(Plus(Times(a, g), Times(CN1, b, f, x)), Power(Plus(a, Times(b, Sqr(x))), Plus(p, C1)), Power(Times(C2, a, b, Plus(p, C1)), -1)), x), Dist(Power(Times(C2, a, Plus(p, C1)), -1), Int(Times(Power(Times(c, x), m), Power(Plus(a, Times(b, Sqr(x))), Plus(p, C1)), ExpandToSum(Plus(Times(C2, a, Plus(p, C1), QSymbol, Power(Power(Times(c, x), m), -1)), Times(f, Plus(Times(C2, p), C3), Power(Power(Times(c, x), m), -1))), x)), x), x))), And(FreeQ(List(a, b, c), x), PolyQ($s("§pq"), x), LtQ(p, CN1), ILtQ(m, C0)))),
            IIntegrate(1806, Int(Times($p("§pq"), Power(Times(c_DEFAULT, x_), m_DEFAULT), Power(Plus(a_, Times(b_DEFAULT, Sqr(x_))), p_)), x_Symbol),
                    Condition(With(List(Set(QSymbol, PolynomialQuotient($s("§pq"), Plus(a, Times(b, Sqr(x))), x)), Set(f, Coeff(PolynomialRemainder($s("§pq"), Plus(a, Times(b, Sqr(x))), x), x, C0)), Set(g, Coeff(PolynomialRemainder($s("§pq"), Plus(a, Times(b, Sqr(x))), x), x, C1))), Plus(Negate(Simp(Times(Power(Times(c, x), Plus(m, C1)), Plus(f, Times(g, x)), Power(Plus(a, Times(b, Sqr(x))), Plus(p, C1)), Power(Times(C2, a, c, Plus(p, C1)), -1)), x)), Dist(Power(Times(C2, a, Plus(p, C1)), -1), Int(Times(Power(Times(c, x), m), Power(Plus(a, Times(b, Sqr(x))), Plus(p, C1)), ExpandToSum(Plus(Times(C2, a, Plus(p, C1), QSymbol), Times(f, Plus(m, Times(C2, p), C3)), Times(g, Plus(m, Times(C2, p), C4), x)), x)), x), x))), And(FreeQ(List(a, b, c, m), x), PolyQ($s("§pq"), x), LtQ(p, CN1), Not(GtQ(m, C0))))),
            IIntegrate(1807, Int(Times($p("§pq"), Power(Times(c_DEFAULT, x_), m_), Power(Plus(a_, Times(b_DEFAULT, Sqr(x_))), p_)), x_Symbol),
                    Condition(With(List(Set(QSymbol, PolynomialQuotient($s("§pq"), Times(c, x), x)), Set($s("R"), PolynomialRemainder($s("§pq"), Times(c, x), x))), Plus(Simp(Times($s("R"), Power(Times(c, x), Plus(m, C1)), Power(Plus(a, Times(b, Sqr(x))), Plus(p, C1)), Power(Times(a, c, Plus(m, C1)), -1)), x), Dist(Power(Times(a, c, Plus(m, C1)), -1), Int(Times(Power(Times(c, x), Plus(m, C1)), Power(Plus(a, Times(b, Sqr(x))), p), ExpandToSum(Plus(Times(a, c, Plus(m, C1), QSymbol), Times(CN1, b, $s("R"), Plus(m, Times(C2, p), C3), x)), x)), x), x))), And(FreeQ(List(a, b, c, p), x), PolyQ($s("§pq"), x), LtQ(m, CN1), Or(IntegerQ(Times(C2, p)), NeQ(Expon($s("§pq"), x), C1))))),
            ...
            IIntegrate(1813, Int(Times($p("§pq"), Power(Plus(a_, Times(b_DEFAULT, Sqr(x_))), p_)), x_Symbol),
                    Condition(With(List(Set(ASymbol, Coeff($s("§pq"), x, C0)), Set(QSymbol, PolynomialQuotient(Plus($s("§pq"), Negate(Coeff($s("§pq"), x, C0))), Sqr(x), x))), Plus(Simp(Times(ASymbol, x, Power(Plus(a, Times(b, Sqr(x))), Plus(p, C1)), Power(a, -1)), x), Dist(Power(a, -1), Int(Times(Sqr(x), Power(Plus(a, Times(b, Sqr(x))), p), Plus(Times(a, QSymbol), Times(CN1, ASymbol, b, Plus(Times(C2, p), C3)))), x), x))), And(FreeQ(List(a, b), x), PolyQ($s("§pq"), Sqr(x)), ILtQ(Plus(p, C1D2), C0), LtQ(Plus(Expon($s("§pq"), x), Times(C2, p), C1), C0)))),
            IIntegrate(1814, Int(Times($p("§pq"), Power(Plus(a_, Times(b_DEFAULT, Sqr(x_))), p_)), x_Symbol),
                    Condition(With(List(Set(QSymbol, PolynomialQuotient($s("§pq"), Plus(a, Times(b, Sqr(x))), x)), Set(f, Coeff(PolynomialRemainder($s("§pq"), Plus(a, Times(b, Sqr(x))), x), x, C0)), Set(g, Coeff(PolynomialRemainder($s("§pq"), Plus(a, Times(b, Sqr(x))), x), x, C1))), Plus(Simp(Times(Plus(Times(a, g), Times(CN1, b, f, x)), Power(Plus(a, Times(b, Sqr(x))), Plus(p, C1)), Power(Times(C2, a, b, Plus(p, C1)), -1)), x), Dist(Power(Times(C2, a, Plus(p, C1)), -1), Int(Times(Power(Plus(a, Times(b, Sqr(x))), Plus(p, C1)), ExpandToSum(Plus(Times(C2, a, Plus(p, C1), QSymbol), Times(f, Plus(Times(C2, p), C3))), x)), x), x))), And(FreeQ(List(a, b), x), PolyQ($s("§pq"), x), LtQ(p, CN1)))),
            ...
            IIntegrate(1827, Int(Times($p("§p4"), Sqr(x_), Power(Plus(a_, Times(b_DEFAULT, Power(x_, 4))), QQ(-3L, 2L))), x_Symbol),
            ...
            IIntegrate(1831, Int(Times($p("§pq"), Power(Times(c_DEFAULT, x_), m_DEFAULT), Power(Plus(a_, Times(b_DEFAULT, Power(x_, n_))), -1)), x_Symbol),
            ...
            IIntegrate(1832, Int(Times($p("§pq"), Power(x_, -1), Power(Plus(a_, Times(b_DEFAULT, Power(x_, n_))), CN1D2)), x_Symbol),
            ...
            IIntegrate(1834, Int(Times($p("§pq"), Power(Times(c_DEFAULT, x_), m_DEFAULT), Power(Plus(a_, Times(b_DEFAULT, Power(x_, n_))), -1)), x_Symbol),
