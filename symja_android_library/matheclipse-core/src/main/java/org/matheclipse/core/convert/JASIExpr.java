...
public class JASIExpr {
  ...
  public JASIExpr(IExpr variable, RingFactory<IExpr> ringFactory, boolean numericFunction) {
    ...
    this.fPolyFactory = new GenPolynomialRing<IExpr>(fRingFactory, fVariables.size(), fTermOrder,
        vars);
  ...
  public GenPolynomial<IExpr> expr2IExprJAS(final ExprPolynomial exprPoly) {
    ...
    SortedMap<org.matheclipse.core.polynomials.longexponent.ExpVectorLong, IExpr> monoms = exprPoly
        .getMap();
   ...
   *
   * @param defaultTermOrder the term order which should be used as default if no MonomialOrder option is set.
   * @return
   */
