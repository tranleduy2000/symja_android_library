    ...
    private static class Initializer {
        ...
        private static void init() {
            ...
            IIntegrate(5521, Int(Power(Sinh(Times(Plus(a_DEFAULT, Times(Log(x_), b_DEFAULT)), d_DEFAULT)), p_DEFAULT), x_Symbol),
                    Condition(Dist(Power(Times(Power(C2, p), Power(b, p), Power(d, p), Power(p, p)), CN1), Int(ExpandIntegrand(Power(Plus(Negate(Power(Times(Exp(Times(a, b, Sqr(d), p)), Power(x, Power(p, CN1))), CN1)), Times(Exp(Times(a, b, Sqr(d), p)), Power(x, Power(p, CN1)))), p), x), x), x), And(FreeQ(List(a, b, d), x), IGtQ(p, C0), EqQ(Subtract(Times(Sqr(b), Sqr(d), Sqr(p)), C1), C0))));
            IIntegrate(5522, Int(Power(Cosh(Times(Plus(a_DEFAULT, Times(Log(x_), b_DEFAULT)), d_DEFAULT)), p_DEFAULT), x_Symbol),
                    Condition(Dist(Power(Power(C2, p), CN1), Int(ExpandIntegrand(Power(Plus(Power(Times(Exp(Times(a, b, Sqr(d), p)), Power(x, Power(p, CN1))), CN1), Times(Exp(Times(a, b, Sqr(d), p)), Power(x, Power(p, CN1)))), p), x), x), x), And(FreeQ(List(a, b, d), x), IGtQ(p, C0), EqQ(Subtract(Times(Sqr(b), Sqr(d), Sqr(p)), C1), C0))));
            IIntegrate(5523, Int(Power(Sinh(Times(Plus(a_DEFAULT, Times(Log(x_), b_DEFAULT)), d_DEFAULT)), p_), x_Symbol),
                    Condition(Dist(Times(Power(Sinh(Times(d, Plus(a, Times(b, Log(x))))), p), Power(Times(Power(x, Times(b, d, p)), Power(Subtract(C1, Power(Times(Exp(Times(C2, a, d)), Power(x, Times(C2, b, d))), CN1)), p)), CN1)), Int(Times(Power(x, Times(b, d, p)), Power(Subtract(C1, Power(Times(Exp(Times(C2, a, d)), Power(x, Times(C2, b, d))), CN1)), p)), x), x), And(FreeQ(List(a, b, d, p), x), Not(IntegerQ(p)))));
            IIntegrate(5524, Int(Power(Cosh(Times(Plus(a_DEFAULT, Times(Log(x_), b_DEFAULT)), d_DEFAULT)), p_), x_Symbol),
                    Condition(Dist(Times(Power(Cosh(Times(d, Plus(a, Times(b, Log(x))))), p), Power(Times(Power(x, Times(b, d, p)), Power(Plus(C1, Power(Times(Exp(Times(C2, a, d)), Power(x, Times(C2, b, d))), CN1)), p)), CN1)), Int(Times(Power(x, Times(b, d, p)), Power(Plus(C1, Power(Times(Exp(Times(C2, a, d)), Power(x, Times(C2, b, d))), CN1)), p)), x), x), And(FreeQ(List(a, b, d, p), x), Not(IntegerQ(p)))));
            IIntegrate(5525, Int(Power(Sinh(Times(Plus(a_DEFAULT, Times(Log(Times(c_DEFAULT, Power(x_, n_DEFAULT))), b_DEFAULT)), d_DEFAULT)), p_DEFAULT), x_Symbol),
                    Condition(Dist(Times(x, Power(Times(n, Power(Times(c, Power(x, n)), Power(n, CN1))), CN1)), Subst(Int(Times(Power(x, Subtract(Power(n, CN1), C1)), Power(Sinh(Times(d, Plus(a, Times(b, Log(x))))), p)), x), x, Times(c, Power(x, n))), x), And(FreeQ(List(a, b, c, d, n, p), x), Or(NeQ(c, C1), NeQ(n, C1)))));
        }
    }
}
