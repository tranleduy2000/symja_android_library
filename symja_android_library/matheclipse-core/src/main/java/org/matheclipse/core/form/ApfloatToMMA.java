...
public class ApfloatToMMA {
	 ...
	 *            TODO
	 */
	public static void apfloatToMMA(Appendable buf, Apfloat value, int exponent, long significantFigures,
	 ...
	 *            a string builder where the output should be appended
	 * @param value
	 *            the Apfloat value which should be formatted
	 * @param exponent
	 *            use scientific notation for all numbers with exponents outside the range <code>-exponent</code> to
	 *            <code>exponent</code>.
	 * @param significantFigures
	 ...
	 */
	public static void apfloatToMMA(StringBuilder buf, Apfloat value, int exponent, long significantFigures) {
		try {
	...
	public static void apfloatToTeX(StringBuilder buf, Apfloat value, int exponent, long significantFigures) {
		try {
	...
	public static void apfloatToMathML(StringBuilder buf, Apfloat value, int exponent, long significantFigures) {
		try {
