...
public class F {
     ...
     * Constant double &quot;1.0&quot;
     */
    public final static INum CND1 = new Num(-1.0);
    /**
     * Constant double &quot;0.0&quot;
     */
    public final static INum CD0 = new Num(0.0);
    /**
     * Constant double &quot;1.0&quot;
     */
    public final static INum CD1 = new Num(1.0);
    /**
     * Constant integer &quot;-1&quot;
     */
     ...
     * @param symbol
     * @param check  additional condition which should be checked in pattern-matching
     * @param def    if <code>true</code>, the pattern can match to a default value associated with the AST's head the
     *               pattern is used in.
     * @return IPattern
     */
     ...
     *
     * @param expr
     * @param map  if the maps <code>get()</code> method returns <code>null</code> the expression isn't substituted.
     * @return the input <code>expr</code> if no substitution of a (sub-)expression was possible or the substituted
     * expression.
     */
