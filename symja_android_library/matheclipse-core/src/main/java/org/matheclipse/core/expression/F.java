...
public class F {
   ...
   */
  public static Cache<IAST, IExpr> REMEMBER_INTEGER_CACHE = CacheBuilder.newBuilder()
  ...
  /***/
  public static final IBuiltInSymbol $Assumptions = initFinalSymbol("$Assumptions",
      ID.$Assumptions);
  ...
  /***/
  public static final IBuiltInSymbol $ContextPath = initFinalSymbol("$ContextPath",
      ID.$ContextPath);
  /***/
  public static final IBuiltInSymbol $CreationDate = initFinalSymbol("$CreationDate",
      ID.$CreationDate);
  /***/
  public static final IBuiltInSymbol $DisplayFunction = initFinalSymbol("$DisplayFunction",
      ID.$DisplayFunction);
  /***/
  public static final IBuiltInSymbol $Failed = initFinalSymbol("$Failed", ID.$Failed);
  /***/
  public static final IBuiltInSymbol $HistoryLength = initFinalSymbol("$HistoryLength",
      ID.$HistoryLength);
  /***/
  public static final IBuiltInSymbol $HomeDirectory = initFinalSymbol("$HomeDirectory",
      ID.$HomeDirectory);
  /***/
  public static final IBuiltInSymbol $IterationLimit = initFinalSymbol("$IterationLimit",
      ID.$IterationLimit);
  /***/
  public static final IBuiltInSymbol $Line = initFinalSymbol("$Line", ID.$Line);
  /***/
  public static final IBuiltInSymbol $MachineEpsilon = initFinalSymbol("$MachineEpsilon",
      ID.$MachineEpsilon);
  /***/
  public static final IBuiltInSymbol $MachinePrecision = initFinalSymbol("$MachinePrecision",
      ID.$MachinePrecision);
  /***/
  public static final IBuiltInSymbol $MaxMachineNumber = initFinalSymbol("$MaxMachineNumber",
      ID.$MaxMachineNumber);
  /***/
  public static final IBuiltInSymbol $MessageList = initFinalSymbol("$MessageList",
      ID.$MessageList);
  /***/
  public static final IBuiltInSymbol $MinMachineNumber = initFinalSymbol("$MinMachineNumber",
      ID.$MinMachineNumber);
  /***/
  public static final IBuiltInSymbol $OutputSizeLimit = initFinalSymbol("$OutputSizeLimit",
      ID.$OutputSizeLimit);
  /***/
  public static final IBuiltInSymbol $Path = initFinalSymbol("$Path", ID.$Path);

  /***/
  public static final IBuiltInSymbol $PathnameSeparator = initFinalSymbol("$PathnameSeparator",
  ...
  /***/
  public static final IBuiltInSymbol AbsoluteCorrelation = initFinalSymbol("AbsoluteCorrelation",
      ID.AbsoluteCorrelation);
  /***/
  public static final IBuiltInSymbol AbsoluteTime = initFinalSymbol("AbsoluteTime",
      ID.AbsoluteTime);
  /***/
  public static final IBuiltInSymbol AbsoluteTiming = initFinalSymbol("AbsoluteTiming",
      ID.AbsoluteTiming);
  ...
  /***/
  public static final IBuiltInSymbol AlgebraicNumber = initFinalSymbol("AlgebraicNumber",
      ID.AlgebraicNumber);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol AntiSymmetric = initFinalSymbol("AntiSymmetric",
      ID.AntiSymmetric);
  /** AntihermitianMatrixQ(m) - returns `True` if `m` is a anti hermitian matrix. */
  public static final IBuiltInSymbol AntihermitianMatrixQ = initFinalSymbol("AntihermitianMatrixQ",
      ID.AntihermitianMatrixQ);

  /** AntisymmetricMatrixQ(m) - returns `True` if `m` is a anti symmetric matrix. */
  public static final IBuiltInSymbol AntisymmetricMatrixQ = initFinalSymbol("AntisymmetricMatrixQ",
   ...
   * c,...}`.
   */
  public static final IBuiltInSymbol ArithmeticGeometricMean = initFinalSymbol(
   ...
   */
  public static final IBuiltInSymbol ArrayReshape = initFinalSymbol("ArrayReshape",
      ID.ArrayReshape);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol AssociationMap = initFinalSymbol("AssociationMap",
      ID.AssociationMap);
  /** AssociationQ(expr) - returns `True` if `expr` is an association, and `False` otherwise. */
  public static final IBuiltInSymbol AssociationQ = initFinalSymbol("AssociationQ",
      ID.AssociationQ);
  /***/
  public static final IBuiltInSymbol AssociationThread = initFinalSymbol("AssociationThread",
      ID.AssociationThread);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol BSplineFunction = initFinalSymbol("BSplineFunction",
      ID.BSplineFunction);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol BartlettWindow = initFinalSymbol("BartlettWindow",
      ID.BartlettWindow);
  ...
  public static final IBuiltInSymbol BeginPackage = initFinalSymbol("BeginPackage",
      ID.BeginPackage);
  /***/
  public static final IBuiltInSymbol BeginTestSection = initFinalSymbol("BeginTestSection",
      ID.BeginTestSection);
  /**
  ...
  /***/
  public static final IBuiltInSymbol BetaDistribution = initFinalSymbol("BetaDistribution",
      ID.BetaDistribution);
  /***/
  public static final IBuiltInSymbol BetaRegularized = initFinalSymbol("BetaRegularized",
      ID.BetaRegularized);
  /**
   ...
   * expression.
   */
  public static final IBuiltInSymbol BinaryDeserialize = initFinalSymbol("BinaryDeserialize",
      ID.BinaryDeserialize);
  /**
   * BinaryDistance(u, v) - returns the binary distance between `u` and `v`. `0` if `u` and `v` are
   * unequal. `1` if `u` and `v` are equal.
   */
  public static final IBuiltInSymbol BinaryDistance = initFinalSymbol("BinaryDistance",
      ID.BinaryDistance);

  /** BinarySerialize(expr) - serialize the Symja `expr` into a byte array expression in WXF format. */
  public static final IBuiltInSymbol BinarySerialize = initFinalSymbol("BinarySerialize",
      ID.BinarySerialize);
  ...
  public static final IBuiltInSymbol BinomialDistribution = initFinalSymbol("BinomialDistribution",
  ...
  /***/
  public static final IBuiltInSymbol BlackmanHarrisWindow = initFinalSymbol("BlackmanHarrisWindow",
      ID.BlackmanHarrisWindow);

  /***/
  public static final IBuiltInSymbol BlackmanNuttallWindow = initFinalSymbol(
      "BlackmanNuttallWindow",
      ID.BlackmanNuttallWindow);
  /***/
  public static final IBuiltInSymbol BlackmanWindow = initFinalSymbol("BlackmanWindow",
      ID.BlackmanWindow);
  /***/
  public static final IBuiltInSymbol Blank = initFinalSymbol("Blank", ID.Blank);
  /***/
  public static final IBuiltInSymbol BlankNullSequence = initFinalSymbol("BlankNullSequence",
      ID.BlankNullSequence);
  /***/
  public static final IBuiltInSymbol BlankSequence = initFinalSymbol("BlankSequence",
      ID.BlankSequence);
   ...
   */
  public static final IBuiltInSymbol BooleanConvert = initFinalSymbol("BooleanConvert",
      ID.BooleanConvert);
  /**
   ...
   */
  public static final IBuiltInSymbol BooleanMinimize = initFinalSymbol("BooleanMinimize",
      ID.BooleanMinimize);
  ...
  /**
   * BooleanTable(logical-expr, variables) - generate [truth values](https://en.wikipedia.org/wiki/Truth_table)
   * from the `logical-expr`
   */
  public static final IBuiltInSymbol BooleanTable = initFinalSymbol("BooleanTable",
      ID.BooleanTable);
  /**
   * BooleanVariables(logical-expr) - gives a list of the boolean variables that appear in the
   * `logical-expr`.
   */
  public static final IBuiltInSymbol BooleanVariables = initFinalSymbol("BooleanVariables",
      ID.BooleanVariables);
  ...
  public static final IBuiltInSymbol BoxWhiskerChart = initFinalSymbol("BoxWhiskerChart",
      ID.BoxWhiskerChart);
  /** BrayCurtisDistance(u, v) - returns the Bray Curtis distance between `u` and `v`. */
  public static final IBuiltInSymbol BrayCurtisDistance = initFinalSymbol("BrayCurtisDistance",
   ...
   */
  public static final IBuiltInSymbol CanberraDistance = initFinalSymbol("CanberraDistance",
      ID.CanberraDistance);
  ...
  public static final IBuiltInSymbol CatalanNumber = initFinalSymbol("CatalanNumber",
      ID.CatalanNumber);
  /***/
   ...
   * mean) of `list`.
   */
  public static final IBuiltInSymbol CentralMoment = initFinalSymbol("CentralMoment",
      ID.CentralMoment);
  /***/
  public static final IBuiltInSymbol CharacterEncoding = initFinalSymbol("CharacterEncoding",
      ID.CharacterEncoding);
  /***/
  public static final IBuiltInSymbol CharacterRange = initFinalSymbol("CharacterRange",
      ID.CharacterRange);
  /**
   * CharacteristicPolynomial(matrix, var) - computes the characteristic polynomial of a `matrix`
   * for the variable `var`.
   */
  public static final IBuiltInSymbol CharacteristicPolynomial = initFinalSymbol(
   ...
   */
  public static final IBuiltInSymbol ChessboardDistance = initFinalSymbol("ChessboardDistance",
      ID.ChessboardDistance);
  /***/
  public static final IBuiltInSymbol ChiSquareDistribution = initFinalSymbol(
      "ChiSquareDistribution",
      ID.ChiSquareDistribution);
  /** ChineseRemainder({a1, a2, a3,...}, {n1, n2, n3,...}) - the chinese remainder function. */
  public static final IBuiltInSymbol ChineseRemainder = initFinalSymbol("ChineseRemainder",
      ID.ChineseRemainder);
  /**
   * CholeskyDecomposition(matrix) - calculate the Cholesky decomposition of a hermitian, positive
   * definite square `matrix`.
   */
  public static final IBuiltInSymbol CholeskyDecomposition = initFinalSymbol(
  ...
  public static final IBuiltInSymbol ClearAttributes = initFinalSymbol("ClearAttributes",
      ID.ClearAttributes);
  /**
  ...
  public static final IBuiltInSymbol CoefficientList = initFinalSymbol("CoefficientList",
      ID.CoefficientList);
  /**
   * CoefficientRules(polynomial, list-of-variables) - get the list of coefficient rules of a
   * `polynomial`.
   */
  public static final IBuiltInSymbol CoefficientRules = initFinalSymbol("CoefficientRules",
      ID.CoefficientRules);
  /**
   * Collect(expr, variable) - collect subexpressions in `expr` which belong to the same
   * `variable`.
   */
  ...
  /***/
  public static final IBuiltInSymbol ColorFunction = initFinalSymbol("ColorFunction",
      ID.ColorFunction);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol CompatibleUnitQ = initFinalSymbol("CompatibleUnitQ",
      ID.CompatibleUnitQ);
  /***/
  public static final IBuiltInSymbol Compile = initFinalSymbol("Compile", ID.Compile);
  /***/
  public static final IBuiltInSymbol CompiledFunction = initFinalSymbol("CompiledFunction",
      ID.CompiledFunction);
   ...
   * non complex numbers.
   */
  public static final IBuiltInSymbol ComplexExpand = initFinalSymbol("ComplexExpand",
      ID.ComplexExpand);
  /** ComplexInfinity - represents an infinite complex quantity of undetermined direction. */
  public static final IBuiltInSymbol ComplexInfinity = initFinalSymbol("ComplexInfinity",
      ID.ComplexInfinity);
  /**
   ...
   */
  public static final IBuiltInSymbol ComplexPlot3D = initFinalSymbol("ComplexPlot3D",
      ID.ComplexPlot3D);
  ...
  /***/
  public static final IBuiltInSymbol ComplexityFunction = initFinalSymbol("ComplexityFunction",
  ...
  public static final IBuiltInSymbol ComposeSeries = initFinalSymbol("ComposeSeries",
      ID.ComposeSeries);
  /**
   ...
   * result.
   */
  public static final IBuiltInSymbol CompoundExpression = initFinalSymbol("CompoundExpression",
   ...
   */
  public static final IBuiltInSymbol ConditionalExpression = initFinalSymbol(
  ...
  public static final IBuiltInSymbol ConjugateTranspose = initFinalSymbol("ConjugateTranspose",
      ID.ConjugateTranspose);

  /***/
  public static final IBuiltInSymbol ConnectedGraphQ = initFinalSymbol("ConnectedGraphQ",
      ID.ConnectedGraphQ);
  ...
  public static final IBuiltInSymbol ConstantArray = initFinalSymbol("ConstantArray",
      ID.ConstantArray);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol ContainsExactly = initFinalSymbol("ContainsExactly",
      ID.ContainsExactly);

  /***/
  public static final IBuiltInSymbol ContainsNone = initFinalSymbol("ContainsNone",
      ID.ContainsNone);
   ...
   * `list2`.
   */
  public static final IBuiltInSymbol ContainsOnly = initFinalSymbol("ContainsOnly",
      ID.ContainsOnly);
  ...
  public static final IBuiltInSymbol ContinuedFraction = initFinalSymbol("ContinuedFraction",
  ...
  /***/
  public static final IBuiltInSymbol CoshIntegral = initFinalSymbol("CoshIntegral",
      ID.CoshIntegral);
  /** CosineDistance(u, v) - returns the cosine distance between `u` and `v`. */
  public static final IBuiltInSymbol CosineDistance = initFinalSymbol("CosineDistance",
      ID.CosineDistance);
  ...
  /***/
  public static final IBuiltInSymbol CountDistinct = initFinalSymbol("CountDistinct",
      ID.CountDistinct);
  ...
  /***/
  public static final IBuiltInSymbol CreateDirectory = initFinalSymbol("CreateDirectory",
      ID.CreateDirectory);
  ...
  /***/
  public static final IBuiltInSymbol DefaultButton = initFinalSymbol("DefaultButton",
      ID.DefaultButton);
  ...
  /***/
  public static final IBuiltInSymbol DegreeLexicographic = initFinalSymbol("DegreeLexicographic",
      ID.DegreeLexicographic);

  /***/
  public static final IBuiltInSymbol DegreeReverseLexicographic = initFinalSymbol(
      "DegreeReverseLexicographic", ID.DegreeReverseLexicographic);
  ...
  public static final IBuiltInSymbol DeleteDuplicates = initFinalSymbol("DeleteDuplicates",
      ID.DeleteDuplicates);
  /**
   * DeleteDuplicatesBy(list, predicate) - deletes duplicates from `list`, for which the `predicate`
   * returns `True`.
   */
  public static final IBuiltInSymbol DeleteDuplicatesBy = initFinalSymbol("DeleteDuplicatesBy",
  ...
  public static final IBuiltInSymbol DensityHistogram = initFinalSymbol("DensityHistogram",
      ID.DensityHistogram);
   ...
   * elsewhere.
   */
  public static final IBuiltInSymbol DiagonalMatrix = initFinalSymbol("DiagonalMatrix",
      ID.DiagonalMatrix);
  ...
  /***/
  public static final IBuiltInSymbol DialogNotebook = initFinalSymbol("DialogNotebook",
      ID.DialogNotebook);

  /***/
  public static final IBuiltInSymbol DialogReturn = initFinalSymbol("DialogReturn",
      ID.DialogReturn);
  /**
  ...
  /***/
  public static final IBuiltInSymbol DigitCharacter = F
  ...
  /***/
  public static final IBuiltInSymbol DirectedEdge = initFinalSymbol("DirectedEdge",
      ID.DirectedEdge);

  /** DirectedInfinity(z) - represents an infinite multiple of the complex number `z`. */
  public static final IBuiltInSymbol DirectedInfinity = initFinalSymbol("DirectedInfinity",
      ID.DirectedInfinity);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol DirichletEta = initFinalSymbol("DirichletEta",
      ID.DirichletEta);
  /***/
  public static final IBuiltInSymbol DirichletWindow = initFinalSymbol("DirichletWindow",
      ID.DirichletWindow);
  /**
   * DiscreteDelta(n1, n2, n3, ...) - `DiscreteDelta` function returns `1` if all the `ni` are `0`.
   * Returns `0` otherwise.
   */
  public static final IBuiltInSymbol DiscreteDelta = initFinalSymbol("DiscreteDelta",
      ID.DiscreteDelta);
  /** DiscreteUniformDistribution({min, max}) - returns a discrete uniform distribution. */
  public static final IBuiltInSymbol DiscreteUniformDistribution = initFinalSymbol(
   ...
   * the variable `var`.
   */
  public static final IBuiltInSymbol Discriminant = initFinalSymbol("Discriminant",
      ID.Discriminant);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol DistanceFunction = initFinalSymbol("DistanceFunction",
      ID.DistanceFunction);
  ...
  public static final IBuiltInSymbol DivisorSigma = initFinalSymbol("DivisorSigma",
      ID.DivisorSigma);
  /**
  ...
  /***/
  public static final IBuiltInSymbol DuplicateFreeQ = initFinalSymbol("DuplicateFreeQ",
      ID.DuplicateFreeQ);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol EasterSunday = initFinalSymbol("EasterSunday",
      ID.EasterSunday);
   ...
   */
  public static final IBuiltInSymbol EchoFunction = initFinalSymbol("EchoFunction",
      ID.EchoFunction);
  /***/
  ...
  public static final IBuiltInSymbol EffectiveInterest = initFinalSymbol("EffectiveInterest",
      ID.EffectiveInterest);
  ...
  public static final IBuiltInSymbol Eigenvectors = initFinalSymbol("Eigenvectors",
      ID.Eigenvectors);
  ...
  /***/
  public static final IBuiltInSymbol EliminationOrder = initFinalSymbol("EliminationOrder",
      ID.EliminationOrder);
  ...
  /***/
  public static final IBuiltInSymbol EllipticTheta = initFinalSymbol("EllipticTheta",
      ID.EllipticTheta);
  ...
  /***/
  public static final IBuiltInSymbol EndTestSection = initFinalSymbol("EndTestSection",
      ID.EndTestSection);
  /***/
  ...
  public static final IBuiltInSymbol ErlangDistribution = initFinalSymbol("ErlangDistribution",
      ID.ErlangDistribution);

  /** EuclideanDistance(u, v) - returns the euclidean distance between `u` and `v`. */
  public static final IBuiltInSymbol EuclideanDistance = initFinalSymbol("EuclideanDistance",
  ...
  public static final IBuiltInSymbol EulerianGraphQ = initFinalSymbol("EulerianGraphQ",
      ID.EulerianGraphQ);
  /**
  ...
  public static final IBuiltInSymbol ExactNumberQ = initFinalSymbol("ExactNumberQ",
      ID.ExactNumberQ);
  ...
  public static final IBuiltInSymbol ExpIntegralE = initFinalSymbol("ExpIntegralE",
      ID.ExpIntegralE);
  /** ExpIntegralEi(expr) - returns the exponential integral `Ei(expr)` of `expr`. */
  public static final IBuiltInSymbol ExpIntegralEi = initFinalSymbol("ExpIntegralEi",
      ID.ExpIntegralEi);
  /***/
  ...
  public static final IBuiltInSymbol ExponentialDistribution = initFinalSymbol(
  ...
  /***/
  public static final IBuiltInSymbol ExportString = initFinalSymbol("ExportString",
      ID.ExportString);
  /***/
  public static final IBuiltInSymbol Expression = initFinalSymbol("Expression", ID.Expression);
  /**
   * ExtendedGCD(n1, n2, ...) - computes the extended greatest common divisor of the given
   * integers.
   */
  ...
  /***/
  public static final IBuiltInSymbol FRatioDistribution = initFinalSymbol("FRatioDistribution",
  ...
  public static final IBuiltInSymbol FactorInteger = initFinalSymbol("FactorInteger",
      ID.FactorInteger);
  /** FactorSquareFree(polynomial) - factor the polynomial expression `polynomial` square free. */
  public static final IBuiltInSymbol FactorSquareFree = initFinalSymbol("FactorSquareFree",
      ID.FactorSquareFree);
  /**
   * FactorSquareFreeList(polynomial) - get the square free factors of the polynomial expression
   * `polynomial`.
   */
  public static final IBuiltInSymbol FactorSquareFreeList = initFinalSymbol("FactorSquareFreeList",
  ...
  /***/
  public static final IBuiltInSymbol FactorialPower = initFinalSymbol("FactorialPower",
      ID.FactorialPower);
   ...
   */
  public static final IBuiltInSymbol FindClusters = initFinalSymbol("FindClusters",
      ID.FindClusters);
  /***/
  public static final IBuiltInSymbol FindEdgeCover = initFinalSymbol("FindEdgeCover",
      ID.FindEdgeCover);

  /** FindEulerianCycle(graph) - find an eulerian cycle in the `graph`. */
  public static final IBuiltInSymbol FindEulerianCycle = initFinalSymbol("FindEulerianCycle",
      ID.FindEulerianCycle);
  ...
  /***/
  public static final IBuiltInSymbol FindGraphCommunities = initFinalSymbol("FindGraphCommunities",
      ID.FindGraphCommunities);
  /** FindHamiltonianCycle(graph) - find an hamiltonian cycle in the `graph`. */
  public static final IBuiltInSymbol FindHamiltonianCycle = initFinalSymbol("FindHamiltonianCycle",
      ID.FindHamiltonianCycle);

  /***/
  public static final IBuiltInSymbol FindIndependentEdgeSet = initFinalSymbol(
      "FindIndependentEdgeSet",
      ID.FindIndependentEdgeSet);

  /***/
  public static final IBuiltInSymbol FindIndependentVertexSet = initFinalSymbol(
   ...
   * the variables `vars`.
   */
  public static final IBuiltInSymbol FindInstance = initFinalSymbol("FindInstance",
      ID.FindInstance);
  /**
   ...
   */
  public static final IBuiltInSymbol FindShortestPath = initFinalSymbol("FindShortestPath",
      ID.FindShortestPath);
   ...
   */
  public static final IBuiltInSymbol FindShortestTour = initFinalSymbol("FindShortestTour",
      ID.FindShortestTour);

  /** FindSpanningTree(graph) - find the minimum spanning tree in the `graph`. */
  public static final IBuiltInSymbol FindSpanningTree = initFinalSymbol("FindSpanningTree",
      ID.FindSpanningTree);
  /**
   ...
   */
  public static final IBuiltInSymbol FindVertexCover = initFinalSymbol("FindVertexCover",
      ID.FindVertexCover);
   ...
   */
  public static final IBuiltInSymbol FixedPointList = initFinalSymbol("FixedPointList",
      ID.FixedPointList);
  /**
  ...
  /***/
  public static final IBuiltInSymbol FlatTopWindow = initFinalSymbol("FlatTopWindow",
      ID.FlatTopWindow);
  ...
  public static final IBuiltInSymbol FourierMatrix = initFinalSymbol("FourierMatrix",
      ID.FourierMatrix);
  /** FractionalPart(number) - get the fractional part of a `number`. */
  public static final IBuiltInSymbol FractionalPart = initFinalSymbol("FractionalPart",
      ID.FractionalPart);
  /** FrechetDistribution(a,b) - returns a Frechet distribution. */
  public static final IBuiltInSymbol FrechetDistribution = initFinalSymbol("FrechetDistribution",
   ...
   * ... ,aN}`
   */
  public static final IBuiltInSymbol FrobeniusNumber = initFinalSymbol("FrobeniusNumber",
      ID.FrobeniusNumber);
  /**
   ...
   */
  public static final IBuiltInSymbol FrobeniusSolve = initFinalSymbol("FrobeniusSolve",
      ID.FrobeniusSolve);
  /**
   * FromCharacterCode({ch1, ch2, ...}) - converts the `ch1, ch2,...` character codes into a string
   * of corresponding characters.
   */
  public static final IBuiltInSymbol FromCharacterCode = initFinalSymbol("FromCharacterCode",
      ID.FromCharacterCode);
  /**
   * FromContinuedFraction({n1, n2, ...}) - return the number which represents the continued
   * fraction list `{n1, n2, ...}`.
   */
  public static final IBuiltInSymbol FromContinuedFraction = initFinalSymbol(
      "FromContinuedFraction", ID.FromContinuedFraction);
   ...
   * t}`.
   */
  public static final IBuiltInSymbol FromPolarCoordinates = initFinalSymbol("FromPolarCoordinates",
   ...
   */
  public static final IBuiltInSymbol FullSimplify = initFinalSymbol("FullSimplify",
      ID.FullSimplify);
  /***/
   ...
   */
  public static final IBuiltInSymbol FunctionExpand = initFinalSymbol("FunctionExpand",
      ID.FunctionExpand);
  /***/
  public static final IBuiltInSymbol FunctionRange = initFinalSymbol("FunctionRange",
      ID.FunctionRange);
  /**
  ...
  public static final IBuiltInSymbol GammaDistribution = initFinalSymbol("GammaDistribution",
      ID.GammaDistribution);
  /***/
  public static final IBuiltInSymbol GammaRegularized = initFinalSymbol("GammaRegularized",
      ID.GammaRegularized);
  /**
  ...
  /***/
  public static final IBuiltInSymbol GaussianIntegers = initFinalSymbol("GaussianIntegers",
      ID.GaussianIntegers);
  /***/
  public static final IBuiltInSymbol GaussianMatrix = initFinalSymbol("GaussianMatrix",
      ID.GaussianMatrix);
  /***/
  public static final IBuiltInSymbol GaussianWindow = initFinalSymbol("GaussianWindow",
      ID.GaussianWindow);
  ...
  public static final IBuiltInSymbol GeometricDistribution = initFinalSymbol(
      "GeometricDistribution",
      ID.GeometricDistribution);

  /** GeometricMean({a, b, c,...}) - returns the geometric mean of `{a, b, c,...}`. */
  public static final IBuiltInSymbol GeometricMean = initFinalSymbol("GeometricMean",
      ID.GeometricMean);
  ...
  /***/
  public static final IBuiltInSymbol GompertzMakehamDistribution = initFinalSymbol(
  ...
  public static final IBuiltInSymbol GraphDiameter = initFinalSymbol("GraphDiameter",
      ID.GraphDiameter);
   ...
   */
  public static final IBuiltInSymbol GraphPeriphery = initFinalSymbol("GraphPeriphery",
      ID.GraphPeriphery);
  ...
  public static final IBuiltInSymbol GreaterEqual = initFinalSymbol("GreaterEqual",
      ID.GreaterEqual);
  /***/
   ...
   */
  public static final IBuiltInSymbol GroebnerBasis = initFinalSymbol("GroebnerBasis",
      ID.GroebnerBasis);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol HoldAllComplete = initFinalSymbol("HoldAllComplete",
      ID.HoldAllComplete);
  /***/
  public static final IBuiltInSymbol HoldComplete = initFinalSymbol("HoldComplete",
      ID.HoldComplete);
  /**
  ...
  public static final IBuiltInSymbol Hypergeometric0F1 = initFinalSymbol("Hypergeometric0F1",
      ID.Hypergeometric0F1);
  /** Hypergeometric1F1(a, b, z) - return the `Hypergeometric1F1` function */
  public static final IBuiltInSymbol Hypergeometric1F1 = initFinalSymbol("Hypergeometric1F1",
      ID.Hypergeometric1F1);
  /***/
  public static final IBuiltInSymbol Hypergeometric1F1Regularized = initFinalSymbol(
      "Hypergeometric1F1Regularized",
      ID.Hypergeometric1F1Regularized);
  /** Hypergeometric2F1(a, b, c, z) - return the `Hypergeometric2F1` function */
  public static final IBuiltInSymbol Hypergeometric2F1 = initFinalSymbol("Hypergeometric2F1",
      ID.Hypergeometric2F1);
  /** HypergeometricDistribution(n, s, t) - returns a hypergeometric distribution. */
  public static final IBuiltInSymbol HypergeometricDistribution = initFinalSymbol(
      "HypergeometricDistribution",
      ID.HypergeometricDistribution);
  /** HypergeometricPFQ({a,...}, {b,...}, c) - return the `HypergeometricPFQ` function */
  public static final IBuiltInSymbol HypergeometricPFQ = initFinalSymbol("HypergeometricPFQ",
      ID.HypergeometricPFQ);
  /***/
  public static final IBuiltInSymbol HypergeometricPFQRegularized = initFinalSymbol(
      "HypergeometricPFQRegularized",
      ID.HypergeometricPFQRegularized);
  /***/
  public static final IBuiltInSymbol HypergeometricU = initFinalSymbol("HypergeometricU",
      ID.HypergeometricU);
  /**
  ...
  public static final IBuiltInSymbol IdentityMatrix = initFinalSymbol("IdentityMatrix",
      ID.IdentityMatrix);
  /**
  ...
  public static final IBuiltInSymbol Indeterminate = initFinalSymbol("Indeterminate",
      ID.Indeterminate);
  /***/
  ...
  public static final IBuiltInSymbol InexactNumberQ = initFinalSymbol("InexactNumberQ",
      ID.InexactNumberQ);
  ...
  public static final IBuiltInSymbol IntegerDigits = initFinalSymbol("IntegerDigits",
      ID.IntegerDigits);
  /** IntegerExponent(n, b) - gives the highest exponent of `b` that divides `n`. */
  public static final IBuiltInSymbol IntegerExponent = initFinalSymbol("IntegerExponent",
      ID.IntegerExponent);
  /** IntegerLength(x) - gives the number of digits in the base-10 representation of `x`. */
  public static final IBuiltInSymbol IntegerLength = initFinalSymbol("IntegerLength",
      ID.IntegerLength);
  ...
  public static final IBuiltInSymbol IntegerPartitions = initFinalSymbol("IntegerPartitions",
      ID.IntegerPartitions);
   ...
   */
  public static final IBuiltInSymbol InterpolatingFunction = initFinalSymbol(
   ...
   * `data-list`.
   */
  public static final IBuiltInSymbol InterpolatingPolynomial = initFinalSymbol(
      "InterpolatingPolynomial",
      ID.InterpolatingPolynomial);
  /***/
  public static final IBuiltInSymbol Interpolation = initFinalSymbol("Interpolation",
      ID.Interpolation);
  ...
  /***/
  public static final IBuiltInSymbol IntersectingQ = initFinalSymbol("IntersectingQ",
      ID.IntersectingQ);
  /** Intersection(set1, set2, ...) - get the intersection set from `set1` and `set2` .... */
  public static final IBuiltInSymbol Intersection = initFinalSymbol("Intersection",
      ID.Intersection);
   ...
   */
  public static final IBuiltInSymbol IntervalIntersection = initFinalSymbol("IntervalIntersection",
   ...
   */
  public static final IBuiltInSymbol IntervalMemberQ = initFinalSymbol("IntervalMemberQ",
      ID.IntervalMemberQ);
   ...
   * interval_2, ...`
   */
  public static final IBuiltInSymbol IntervalUnion = initFinalSymbol("IntervalUnion",
      ID.IntervalUnion);
  ...
  /***/
  public static final IBuiltInSymbol InverseBetaRegularized = initFinalSymbol(
      "InverseBetaRegularized", ID.InverseBetaRegularized);
  ...
  public static final IBuiltInSymbol JacobiAmplitude = initFinalSymbol("JacobiAmplitude",
      ID.JacobiAmplitude);
  ...
  /***/
  public static final IBuiltInSymbol ListContourPlot = initFinalSymbol("ListContourPlot",
      ID.ListContourPlot);
  /**
   * ListConvolve(kernel-list, tensor-list) - create the convolution of the `kernel-list` with
   * `tensor-list`.
   */
  public static final IBuiltInSymbol ListConvolve = initFinalSymbol("ListConvolve",
      ID.ListConvolve);
   ...
   * `tensor-list`.
   */
  public static final IBuiltInSymbol ListCorrelate = initFinalSymbol("ListCorrelate",
      ID.ListCorrelate);
   ...
   * `list-of-points`.
   */
  public static final IBuiltInSymbol ListLinePlot = initFinalSymbol("ListLinePlot",
      ID.ListLinePlot);
  /**
  ...
  public static final IBuiltInSymbol LogNormalDistribution = initFinalSymbol(
      "LogNormalDistribution",
      ID.LogNormalDistribution);
  /***/
  public static final IBuiltInSymbol LogicalExpand = initFinalSymbol("LogicalExpand",
      ID.LogicalExpand);
  /** LogisticSigmoid(z) - returns the logistic sigmoid of `z`. */
  public static final IBuiltInSymbol LogisticSigmoid = initFinalSymbol("LogisticSigmoid",
      ID.LogisticSigmoid);
  /***/
  ...
  public static final IBuiltInSymbol LowerTriangularize = initFinalSymbol("LowerTriangularize",
  ...
  public static final IBuiltInSymbol MachineNumberQ = initFinalSymbol("MachineNumberQ",
      ID.MachineNumberQ);
  /***/
  ...
  public static final IBuiltInSymbol MangoldtLambda = initFinalSymbol("MangoldtLambda",
      ID.MangoldtLambda);
  /**
   ...
   * to `v`.
   */
  public static final IBuiltInSymbol ManhattanDistance = initFinalSymbol("ManhattanDistance",
      ID.ManhattanDistance);
  /**
  ...
  /***/
  public static final IBuiltInSymbol MantissaExponent = initFinalSymbol("MantissaExponent",
      ID.MantissaExponent);
   ...
   * an implementation of [George Dantzig's simplex algorithm](http://en.wikipedia.org/wiki/Simplex_algorithm)
  ...
  public static final IBuiltInSymbol NakagamiDistribution = initFinalSymbol("NakagamiDistribution",
  ...
  /***/
  public static final IBuiltInSymbol NonCommutativeMultiply = initFinalSymbol(
  ...
  public static final IBuiltInSymbol NormalDistribution = initFinalSymbol("NormalDistribution",
  ...
  /***/
  public static final IBuiltInSymbol NotApplicable = initFinalSymbol("NotApplicable",
      ID.NotApplicable);
  /***/
  public static final IBuiltInSymbol NotAvailable = initFinalSymbol("NotAvailable",
      ID.NotAvailable);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol NumberFieldRootsOfUnity = initFinalSymbol(
      "NumberFieldRootsOfUnity", ID.NumberFieldRootsOfUnity);
  ...
  /***/
  public static final IBuiltInSymbol NumberString = initFinalSymbol("NumberString",
      ID.NumberString);
  /**
  ...
  /***/
  public static final IBuiltInSymbol NuttallWindow = initFinalSymbol("NuttallWindow",
      ID.NuttallWindow);
  /***/
   ...
   */
  public static final IBuiltInSymbol OptimizeExpression = initFinalSymbol("OptimizeExpression",
  ...
  /***/
  public static final IBuiltInSymbol OptionsPattern = initFinalSymbol("OptionsPattern",
      ID.OptionsPattern);
  /**
   ...
   * otherwise.
   */
  public static final IBuiltInSymbol OrthogonalMatrixQ = initFinalSymbol("OrthogonalMatrixQ",
      ID.OrthogonalMatrixQ);
  /**
   * Orthogonalize(matrix) - returns a basis for the orthogonalized set of vectors defined by
   * `matrix`.
   */
  public static final IBuiltInSymbol Orthogonalize = initFinalSymbol("Orthogonalize",
      ID.Orthogonalize);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol OutputStream = initFinalSymbol("OutputStream",
      ID.OutputStream);
  /***/
   ...
   */
  public static final IBuiltInSymbol ParametricPlot = initFinalSymbol("ParametricPlot",
      ID.ParametricPlot);
  ...
  /***/
  public static final IBuiltInSymbol ParzenWindow = initFinalSymbol("ParzenWindow",
      ID.ParzenWindow);
  /***/
  public static final IBuiltInSymbol Pattern = initFinalSymbol("Pattern", ID.Pattern);
  /***/
  public static final IBuiltInSymbol PatternOrder = initFinalSymbol("PatternOrder",
      ID.PatternOrder);
  /**
  ...
  /***/
  public static final IBuiltInSymbol PearsonChiSquareTest = initFinalSymbol("PearsonChiSquareTest",
   ...
   */
  public static final IBuiltInSymbol PerfectNumber = initFinalSymbol("PerfectNumber",
      ID.PerfectNumber);
  /**
   ...
   */
  public static final IBuiltInSymbol PerfectNumberQ = initFinalSymbol("PerfectNumberQ",
      ID.PerfectNumberQ);
  /** Permutations(list) - gives all possible orderings of the items in `list`. */
  public static final IBuiltInSymbol Permutations = initFinalSymbol("Permutations",
      ID.Permutations);
   ...
   */
  public static final IBuiltInSymbol PiecewiseExpand = initFinalSymbol("PiecewiseExpand",
      ID.PiecewiseExpand);
  ...
  public static final IBuiltInSymbol PoissonDistribution = initFinalSymbol("PoissonDistribution",
   ...
   */
  public static final IBuiltInSymbol PolynomialExtendedGCD = initFinalSymbol(
   ...
   * `q`.
   */
  public static final IBuiltInSymbol PolynomialGCD = initFinalSymbol("PolynomialGCD",
      ID.PolynomialGCD);
  /**
   * PolynomialLCM(p, q) - returns the LCM ('least common multiple') of the polynomials `p` and
   * `q`.
   */
  public static final IBuiltInSymbol PolynomialLCM = initFinalSymbol("PolynomialLCM",
      ID.PolynomialLCM);
  /**
   ...
   * for the variable `x`.
   */
  public static final IBuiltInSymbol PolynomialQuotient = initFinalSymbol("PolynomialQuotient",
   ...
   */
  public static final IBuiltInSymbol PolynomialQuotientRemainder = initFinalSymbol(
   ...
   * for the variable `x`.
   */
  public static final IBuiltInSymbol PolynomialRemainder = initFinalSymbol("PolynomialRemainder",
  ...
  public static final IBuiltInSymbol PossibleZeroQ = initFinalSymbol("PossibleZeroQ",
      ID.PossibleZeroQ);
  /***/
  ...
  public static final IBuiltInSymbol PreDecrement = initFinalSymbol("PreDecrement",
      ID.PreDecrement);
  /** PreIncrement(x) - increments `x` by `1`, returning the new value of `x`. */
  public static final IBuiltInSymbol PreIncrement = initFinalSymbol("PreIncrement",
      ID.PreIncrement);
  /***/
  public static final IBuiltInSymbol Precision = initFinalSymbol("Precision", ID.Precision);
  /***/
  public static final IBuiltInSymbol PrecisionGoal = initFinalSymbol("PrecisionGoal",
      ID.PrecisionGoal);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol PrimitiveRoot = initFinalSymbol("PrimitiveRoot",
      ID.PrimitiveRoot);
  /** PrimitiveRootList(n) - returns the list of the primitive roots of `n`. */
  public static final IBuiltInSymbol PrimitiveRootList = initFinalSymbol("PrimitiveRootList",
      ID.PrimitiveRootList);
  ...
  /***/
  public static final IBuiltInSymbol PrintableASCIIQ = initFinalSymbol("PrintableASCIIQ",
      ID.PrintableASCIIQ);
  /**
   ...
   */
  public static final IBuiltInSymbol PseudoInverse = initFinalSymbol("PseudoInverse",
      ID.PseudoInverse);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol QuantityDistribution = initFinalSymbol("QuantityDistribution",
      ID.QuantityDistribution);
  /** QuantityMagnitude(quantity) - returns the value of the `quantity` */
  public static final IBuiltInSymbol QuantityMagnitude = initFinalSymbol("QuantityMagnitude",
      ID.QuantityMagnitude);
  /***/
   ...
   * and `n`.
   */
  public static final IBuiltInSymbol QuotientRemainder = initFinalSymbol("QuotientRemainder",
      ID.QuotientRemainder);
  /***/
  ...
  public static final IBuiltInSymbol RandomChoice = initFinalSymbol("RandomChoice",
      ID.RandomChoice);
  /***/
  public static final IBuiltInSymbol RandomComplex = initFinalSymbol("RandomComplex",
      ID.RandomComplex);
  /** RandomInteger(n) - create a random integer number between `0` and `n`. */
  public static final IBuiltInSymbol RandomInteger = initFinalSymbol("RandomInteger",
      ID.RandomInteger);
  ...
  public static final IBuiltInSymbol RandomSample = initFinalSymbol("RandomSample",
      ID.RandomSample);
  /***/
  public static final IBuiltInSymbol RandomVariate = initFinalSymbol("RandomVariate",
      ID.RandomVariate);
  ...
  /***/
  public static final IBuiltInSymbol ReadProtected = initFinalSymbol("ReadProtected",
      ID.ReadProtected);
  /***/
  ...
  /**
   * RealNumberQ(expr) - returns `True` if `expr` is an explicit number with no imaginary
   * component.
   */
  ...
  /***/
  public static final IBuiltInSymbol RegularExpression = initFinalSymbol("RegularExpression",
  ...
  /***/
  public static final IBuiltInSymbol RemoveDiacritics = initFinalSymbol("RemoveDiacritics",
      ID.RemoveDiacritics);
  /***/
  public static final IBuiltInSymbol Repeated = initFinalSymbol("Repeated", ID.Repeated);
  /***/
  public static final IBuiltInSymbol RepeatedNull = initFinalSymbol("RepeatedNull",
      ID.RepeatedNull);
  /**
   ...
   */
  public static final IBuiltInSymbol ReplaceRepeated = initFinalSymbol("ReplaceRepeated",
      ID.ReplaceRepeated);
   ...
   */
  public static final IBuiltInSymbol RiccatiSolve = initFinalSymbol("RiccatiSolve",
      ID.RiccatiSolve);
   ...
   * c_ft)`.
   */
  public static final IBuiltInSymbol RogersTanimotoDissimilarity = initFinalSymbol(
   ...
   * string.
   */
  public static final IBuiltInSymbol RomanNumeral = initFinalSymbol("RomanNumeral",
      ID.RomanNumeral);

  /***/
  public static final IBuiltInSymbol Root = initFinalSymbol("Root", ID.Root);
  /***/
  public static final IBuiltInSymbol RootIntervals = initFinalSymbol("RootIntervals",
      ID.RootIntervals);
  /***/
  ...
  public static final IBuiltInSymbol RotationMatrix = initFinalSymbol("RotationMatrix",
      ID.RotationMatrix);
   ...
   */
  public static final IBuiltInSymbol RussellRaoDissimilarity = initFinalSymbol(
   ...
   */
  public static final IBuiltInSymbol SatisfiabilityCount = initFinalSymbol("SatisfiabilityCount",
   ...
   */
  public static final IBuiltInSymbol SatisfiabilityInstances = initFinalSymbol(
   ...
   */
  public static final IBuiltInSymbol SatisfiableQ = initFinalSymbol("SatisfiableQ",
      ID.SatisfiableQ);
  /***/
  ...
  /**
   * Select({e1, e2, ...}, f) - returns a list of the elements `ei` for which `f(ei)` returns
   * `True`.
   */
   ...
   */
  public static final IBuiltInSymbol SemanticImport = initFinalSymbol("SemanticImport",
      ID.SemanticImport);
   ...
   */
  public static final IBuiltInSymbol SemanticImportString = initFinalSymbol("SemanticImportString",
      ID.SemanticImportString);
  /***/
  public static final IBuiltInSymbol Sequence = initFinalSymbol("Sequence", ID.Sequence);
  /***/
  public static final IBuiltInSymbol SequenceHold = initFinalSymbol("SequenceHold",
      ID.SequenceHold);
  /**
  ...
  public static final IBuiltInSymbol SeriesCoefficient = initFinalSymbol("SeriesCoefficient",
      ID.SeriesCoefficient);
  /**
   * SeriesData(x, x0, {coeff0, coeff1, coeff2,...}, nMin, nMax, denominator}) - internal structure
   * of a power series at the point `x = x0` the `coeff`-i are coefficients of the power series.
   */
  ...
  public static final IBuiltInSymbol SetAttributes = initFinalSymbol("SetAttributes",
      ID.SetAttributes);
   ...
   * `matrix`.
   */
  public static final IBuiltInSymbol SingularValueDecomposition = initFinalSymbol(
  ...
  public static final IBuiltInSymbol SinhIntegral = initFinalSymbol("SinhIntegral",
      ID.SinhIntegral);
  /**
  ...
  public static final IBuiltInSymbol SlotSequence = initFinalSymbol("SlotSequence",
      ID.SlotSequence);
  /**
   ...
   */
  public static final IBuiltInSymbol SokalSneathDissimilarity = initFinalSymbol(
  ...
  public static final IBuiltInSymbol SphericalBesselY = initFinalSymbol("SphericalBesselY",
      ID.SphericalBesselY);

  /***/
  public static final IBuiltInSymbol SphericalHankelH1 = initFinalSymbol("SphericalHankelH1",
      ID.SphericalHankelH1);
  ...
  public static final IBuiltInSymbol SquareMatrixQ = initFinalSymbol("SquareMatrixQ",
      ID.SquareMatrixQ);
  /** SquaredEuclideanDistance(u, v) - returns squared the euclidean distance between `u$` and `v`. */
  public static final IBuiltInSymbol SquaredEuclideanDistance = initFinalSymbol(
   ...
   */
  public static final IBuiltInSymbol StandardDeviation = initFinalSymbol("StandardDeviation",
      ID.StandardDeviation);
  /***/
  public static final IBuiltInSymbol StandardForm = initFinalSymbol("StandardForm",
      ID.StandardForm);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol StartOfString = initFinalSymbol("StartOfString",
      ID.StartOfString);

  /** StieltjesGamma(a) - returns Stieltjes constant. */
  public static final IBuiltInSymbol StieltjesGamma = initFinalSymbol("StieltjesGamma",
      ID.StieltjesGamma);
   ...
   * the string `str`.
   */
  public static final IBuiltInSymbol StringContainsQ = initFinalSymbol("StringContainsQ",
      ID.StringContainsQ);
  ...
  /***/
  public static final IBuiltInSymbol StringExpression = initFinalSymbol("StringExpression",
      ID.StringExpression);
   ...
   */
  public static final IBuiltInSymbol StringInsert = initFinalSymbol("StringInsert",
      ID.StringInsert);
  ...
  public static final IBuiltInSymbol StringLength = initFinalSymbol("StringLength",
      ID.StringLength);
  /**
   * StringMatchQ(string, regex-pattern) - check if the regular expression `regex-pattern` matches
   * the `string`.
   */
  public static final IBuiltInSymbol StringMatchQ = initFinalSymbol("StringMatchQ",
      ID.StringMatchQ);

  /**
   * StringPart(str, pos) - return the character at position `pos` from the `str` string
   * expression.
   */
   ...
   * `string`.
   */
  public static final IBuiltInSymbol StringReplace = initFinalSymbol("StringReplace",
      ID.StringReplace);
  /***/
  public static final IBuiltInSymbol StringRiffle = initFinalSymbol("StringRiffle",
      ID.StringRiffle);
  ...
  public static final IBuiltInSymbol StudentTDistribution = initFinalSymbol("StudentTDistribution",
  ...
  public static final IBuiltInSymbol Subfactorial = initFinalSymbol("Subfactorial",
      ID.Subfactorial);
  /***/
  ...
  /***/
  public static final IBuiltInSymbol Subsuperscript = initFinalSymbol("Subsuperscript",
      ID.Subsuperscript);
  ...
  public static final IBuiltInSymbol SubtractFrom = initFinalSymbol("SubtractFrom",
      ID.SubtractFrom);
  /**
  ...
  /**
   * Surd(expr, n) - returns the `n`-th root of `expr`. If the result is defined, it's a real
   * value.
   */
  public static final IBuiltInSymbol Surd = initFinalSymbol("Surd", ID.Surd);
  /***/
  public static final IBuiltInSymbol SurfaceGraphics = initFinalSymbol("SurfaceGraphics",
      ID.SurfaceGraphics);
  /**
   * SurvivalFunction(dist, x) - returns the survival function for the distribution `dist` evaluated
   * at `x`.
   */
  public static final IBuiltInSymbol SurvivalFunction = initFinalSymbol("SurvivalFunction",
      ID.SurvivalFunction);
  /**
  ...
  public static final IBuiltInSymbol SymmetricMatrixQ = initFinalSymbol("SymmetricMatrixQ",
      ID.SymmetricMatrixQ);
  /***/
  public static final IBuiltInSymbol SyntaxLength = initFinalSymbol("SyntaxLength",
      ID.SyntaxLength);
  ...
  public static final IBuiltInSymbol SystemDialogInput = initFinalSymbol("SystemDialogInput",
  ...
  /***/
  public static final IBuiltInSymbol TableHeadings = initFinalSymbol("TableHeadings",
      ID.TableHeadings);
  /***/
  public static final IBuiltInSymbol TagSet = initFinalSymbol("TagSet", ID.TagSet);
  /***/
  public static final IBuiltInSymbol TagSetDelayed = initFinalSymbol("TagSetDelayed",
      ID.TagSetDelayed);
  ...
  /***/
  public static final IBuiltInSymbol TakeLargestBy = initFinalSymbol("TakeLargestBy",
      ID.TakeLargestBy);
  /***/
   ...
   * codes.
   */
  public static final IBuiltInSymbol ToCharacterCode = initFinalSymbol("ToCharacterCode",
      ID.ToCharacterCode);
  /** ToExpression("string", form) - converts the `string` given in `form` into an expression. */
  public static final IBuiltInSymbol ToExpression = initFinalSymbol("ToExpression",
      ID.ToExpression);
  /**
   * ToPolarCoordinates({x, y}) - return the polar coordinates for the cartesian coordinates `{x,
   * y}`.
   */
  public static final IBuiltInSymbol ToPolarCoordinates = initFinalSymbol("ToPolarCoordinates",
  ...
  public static final IBuiltInSymbol ToeplitzMatrix = initFinalSymbol("ToeplitzMatrix",
      ID.ToeplitzMatrix);
  ...
  /***/
  public static final IBuiltInSymbol TraditionalForm = initFinalSymbol("TraditionalForm",
      ID.TraditionalForm);
  /***/
  public static final IBuiltInSymbol Transliterate = initFinalSymbol("Transliterate",
      ID.Transliterate);
  ...
  /***/
  public static final IBuiltInSymbol Underoverscript = initFinalSymbol("Underoverscript",
      ID.Underoverscript);
  /***/
  public static final IBuiltInSymbol UndirectedEdge = initFinalSymbol("UndirectedEdge",
      ID.UndirectedEdge);
  ...
  public static final IBuiltInSymbol UniformDistribution = initFinalSymbol("UniformDistribution",
  ...
  /***/
  public static final IBuiltInSymbol UnitaryMatrixQ = initFinalSymbol("UnitaryMatrixQ",
      ID.UnitaryMatrixQ);
  ...
  /***/
  public static final IBuiltInSymbol UpSetDelayed = initFinalSymbol("UpSetDelayed",
      ID.UpSetDelayed);
  /***/
  ...
  public static final IBuiltInSymbol UpperTriangularize = initFinalSymbol("UpperTriangularize",
  ...
  public static final IBuiltInSymbol VandermondeMatrix = initFinalSymbol("VandermondeMatrix",
   ...
   * number of occurrences of `u(k)=i` and `v(k)=j` for `k<n`, and `R = 2 * c_tf * c_ft`.
   */
  public static final IBuiltInSymbol YuleDissimilarity = initFinalSymbol("YuleDissimilarity",
      ID.YuleDissimilarity);
  /***/
   ...
   * </p>
   * <p>
   * Almost every modifying method in this class throws an <tt>UnsupportedOperationException</tt>,
   * almost every predicate returns <code>false</code>. The main method to check if the object is
   * valid is the
  ...
  public static final ISymbol $RealVector = initFinalHiddenSymbol(
      FEConfig.PARSER_USE_LOWERCASE_SYMBOLS ? "$realvector" : "$RealVector");
  public static final ISymbol $RealMatrix = initFinalHiddenSymbol(
      FEConfig.PARSER_USE_LOWERCASE_SYMBOLS ? "$realmatrix" : "$RealMatrix");

  // public static final ISymbol usage = initFinalHiddenSymbol("usage");
  ...
  public static final ISymbol CSymbol = initFinalHiddenSymbol(
      "C"); // don't use constant BuiltinSymbol 'C' here
  ...
  public static java.util.Set<IExpr> CEmptySet;

  public static Function<IExpr, String> CNullFunction = new Function<IExpr, java.lang.String>() {
    @Override
    public java.lang.String apply(IExpr x) {
      return null;
    }
  };
  ...
  static {
    try {
      ...
      CEmptySequence = headAST0(F.Sequence);
      ...
      COMMON_IDS = new IExpr[]{CN1, CN2, CN3, CN4, CN5, CN6, CN7, CN8, CN9, CN10, C0, C1, C2, C3,
          C4, C5, C6,
          C7, C8, C9, C10, CI, CNI, C1D2, CN1D2, C1D3, CN1D3, C1D4, CN1D4, CD0, CD1, CInfinity,
          CNInfinity,
          CComplexInfinity, CSqrt2, CSqrt3, CSqrt5, CSqrt6, CSqrt7, CSqrt10, C1DSqrt2, C1DSqrt3,
          C1DSqrt5,
          ...
          w_, x_, y_,
          z_, A_, B_, C_, F_, G_, a_Symbol, b_Symbol, c_Symbol, d_Symbol, e_Symbol, f_Symbol,
          g_Symbol,
          h_Symbol, i_Symbol, j_Symbol, k_Symbol, l_Symbol, m_Symbol, n_Symbol, o_Symbol, p_Symbol,
          q_Symbol,
          r_Symbol, s_Symbol, t_Symbol, u_Symbol, v_Symbol, w_Symbol, x_Symbol, y_Symbol, z_Symbol,
          a_DEFAULT,
          b_DEFAULT, c_DEFAULT, d_DEFAULT, e_DEFAULT, f_DEFAULT, g_DEFAULT, h_DEFAULT, i_DEFAULT,
          j_DEFAULT,
          k_DEFAULT, l_DEFAULT, m_DEFAULT, n_DEFAULT, o_DEFAULT, p_DEFAULT, q_DEFAULT, r_DEFAULT,
          s_DEFAULT,
...
//			UnitTestingFunctions.initialize();
   ...
   *               the AST's head the pattern is used in.
   * @return IPattern
   */
  ...
  /**
   * See <a href= "https://github.com/axkr/symja_android_library/blob/master/symja_android_library/doc/functions/SymmetricMatrixQ.md">SymmetricMatrixQ</a>
   */
    ...
    if (Config.SERVER_MODE) {
      if (FEConfig.PARSER_USE_LOWERCASE_SYMBOLS) {
        if (SYMBOL_OBSERVER.createPredefinedSymbol(name)) {
          ...
          // fSymbolMap
          ISymbol secondTry = org.matheclipse.core.expression.Context.PREDEFINED_SYMBOLS_MAP
              .get(name);
          if (secondTry != null) {
            return secondTry;
          }
   ...
   * <blockquote>
   * <p>
   * returns <code>True</code> if <code>expr</code> is either <code>True</code> or
   * <code>False</code>.
   * </p>
   * </blockquote>
   * <h3>Examples</h3>
   ...
   * @return
   */
  public static IComplex CC(final long real_numerator, final long real_denominator,
  ...
  public static IComplexNum complexNum(final IInteger value) {
    ...
    if (engine.isArbitraryMode()) {
      return ApcomplexNum
          .valueOf(value.toBigNumerator(), BigInteger.ONE, BigInteger.ZERO, BigInteger.ONE,
              engine.getNumericPrecision());
    }
    return complexNum(value.doubleValue(), 0.0d);
  }
   ...
   * <blockquote>
   * <p>
   * returns <code>True</code> if <code>expr</code> is not an exact number, and <code>False</code>
   * otherwise.
   * </p>
   * </blockquote>
   * <h3>Examples</h3>
  ...
  public static INum num(final IFraction value) {
    ...
    if (engine.isArbitraryMode()) {
      return ApfloatNum
          .valueOf(value.toBigNumerator(), value.toBigDenominator(), engine.getNumericPrecision());
    }
  ...
  public static ISymbol symbol(final String symbolName, IAST assumptionAST, EvalEngine engine) {
    ISymbol symbol = engine.getContextPath()
        .symbol(symbolName, engine.getContext(), engine.isRelaxedSyntax());
  ...
  public static IBuiltInSymbol localBiPredicate(final String symbolName,
      final BiPredicate<IExpr, IExpr> function) {
    return localFunction(symbolName, new AbstractCoreFunctionEvaluator() {
      @Override
      public IExpr evaluate(IAST ast, EvalEngine engine) {
  ...
  public static IBuiltInSymbol localPredicate(final String symbolName,
  ...
  /**
   * See <a href= "https://github.com/axkr/symja_android_library/blob/master/symja_android_library/doc/functions/Table.md">Table</a>
   */
  ...
  public static final IASTMutable ternary(final IExpr head, final IExpr a0, final IExpr a1,
      final IExpr a2) {
  ...
  private static IASTMutable binaryASTOrderless(Predicate<IExpr> t, ISymbol symbol, final IExpr a1,
      final IExpr a2) {
   ...
   * @return
   */
  public static IAST matrix(BiFunction<Integer, Integer, ? extends IExpr> biFunction, int n,
      int m) {
