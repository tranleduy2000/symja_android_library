...
public class ApcomplexNum extends IComplexNumImpl implements IComplexNum {
  ...
  public static ApcomplexNum valueOf(final BigInteger realNumerator,
    ...
    Apfloat real = new Apfloat(realNumerator, precision)
        .divide(new Apfloat(realDenominator, precision));
    Apfloat imag = new Apfloat(imagNumerator, precision)
        .divide(new Apfloat(imagDenominator, precision));
    return new ApcomplexNum(real, imag);
  }
