 ...
 */
public abstract class HMArrayList extends IASTAppendableImpl
  ...
  public final void append(int location, IExpr object) {
    ...
    if (0 < location && location < size) {
      ...
      throw new IndexOutOfBoundsException(
          "Index: " + Integer.valueOf(location) + ", Size: " + Integer
              .valueOf(lastIndex - firstIndex));
    }
  ...
  /** {@inheritDoc} */
  @Override
  public final IASTAppendable mapThreadEvaled(final EvalEngine engine, IASTAppendable appendAST,
