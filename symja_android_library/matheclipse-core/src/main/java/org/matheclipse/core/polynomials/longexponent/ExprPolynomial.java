 ...
 */
public class ExprPolynomial extends RingElemImpl<ExprPolynomial> implements
    RingElem<ExprPolynomial>, Iterable<ExprMonomial> {
  ...
  public Map<ExpVectorLong, ExprPolynomial> contract(ExprPolynomialRing pfac) {
    ...
    Map<ExpVectorLong, ExprPolynomial> B = new TreeMap<ExpVectorLong, ExprPolynomial>(
