...
public class ComplexSym extends IComplexImpl implements IComplex {
  ...
  public IComplex add(final IComplex parm1) {
    return ComplexSym
        .valueOf(fReal.add(parm1.getRealPart()), fImaginary.add(parm1.getImaginaryPart()));
  }
  ...
  public boolean equals(final Object obj) {
    if (obj instanceof ComplexSym) {
      ...
      return fReal.equals(((ComplexSym) obj).fReal) && fImaginary
          .equals(((ComplexSym) obj).fImaginary);
    }
    return false;
  }
