    ...
    private static class Initializer {
        ...
        private static void init() {
            ...
            IIntegrate(321, Int(Times(Power(Times(c_DEFAULT, x_), m_), Power(Plus(a_, Times(b_DEFAULT, Power(x_, n_))), p_)), x_Symbol),
                    Condition(Subtract(Simp(Times(Power(c, Subtract(n, C1)), Power(Times(c, x), Plus(m, Negate(n), C1)), Power(Plus(a, Times(b, Power(x, n))), Plus(p, C1)), Power(Times(b, Plus(m, Times(n, p), C1)), CN1)), x), Dist(Times(a, Power(c, n), Plus(m, Negate(n), C1), Power(Times(b, Plus(m, Times(n, p), C1)), CN1)), Int(Times(Power(Times(c, x), Subtract(m, n)), Power(Plus(a, Times(b, Power(x, n))), p)), x), x)), And(FreeQ(List(a, b, c, p), x), IGtQ(n, C0), GtQ(m, Subtract(n, C1)), NeQ(Plus(m, Times(n, p), C1), C0), IntBinomialQ(a, b, c, n, m, p, x))));
            IIntegrate(322, Int(Times(Power(Times(c_DEFAULT, x_), m_), Power(Plus(a_, Times(b_DEFAULT, Power(x_, n_))), p_)), x_Symbol),
                    Condition(Subtract(Simp(Times(Power(c, Subtract(n, C1)), Power(Times(c, x), Plus(m, Negate(n), C1)), Power(Plus(a, Times(b, Power(x, n))), Plus(p, C1)), Power(Times(b, Plus(m, Times(n, p), C1)), CN1)), x), Dist(Times(a, Power(c, n), Plus(m, Negate(n), C1), Power(Times(b, Plus(m, Times(n, p), C1)), CN1)), Int(Times(Power(Times(c, x), Subtract(m, n)), Power(Plus(a, Times(b, Power(x, n))), p)), x), x)), And(FreeQ(List(a, b, c, m, p), x), IGtQ(n, C0), SumSimplerQ(m, Negate(n)), NeQ(Plus(m, Times(n, p), C1), C0), ILtQ(Simplify(Plus(Times(Plus(m, C1), Power(n, CN1)), p)), C0))));
            IIntegrate(323, Int(Times(Power(Times(c_DEFAULT, x_), m_), Power(Plus($p("a1"), Times($p("b1", true), Power(x_, n_))), p_), Power(Plus($p("a2"), Times($p("b2", true), Power(x_, n_))), p_)), x_Symbol),
                    Condition(Subtract(Simp(Times(Power(c, Subtract(Times(C2, n), C1)), Power(Times(c, x), Plus(m, Times(CN1, C2, n), C1)), Power(Plus($s("a1"), Times($s("b1"), Power(x, n))), Plus(p, C1)), Power(Plus($s("a2"), Times($s("b2"), Power(x, n))), Plus(p, C1)), Power(Times($s("b1"), $s("b2"), Plus(m, Times(C2, n, p), C1)), CN1)), x), Dist(Times($s("a1"), $s("a2"), Power(c, Times(C2, n)), Plus(m, Times(CN1, C2, n), C1), Power(Times($s("b1"), $s("b2"), Plus(m, Times(C2, n, p), C1)), CN1)), Int(Times(Power(Times(c, x), Subtract(m, Times(C2, n))), Power(Plus($s("a1"), Times($s("b1"), Power(x, n))), p), Power(Plus($s("a2"), Times($s("b2"), Power(x, n))), p)), x), x)), And(FreeQ(List($s("a1"), $s("b1"), $s("a2"), $s("b2"), c, p), x), EqQ(Plus(Times($s("a2"), $s("b1")), Times($s("a1"), $s("b2"))), C0), IGtQ(Times(C2, n), C0), GtQ(m, Subtract(Times(C2, n), C1)), NeQ(Plus(m, Times(C2, n, p), C1), C0), IntBinomialQ(Times($s("a1"), $s("a2")), Times($s("b1"), $s("b2")), c, Times(C2, n), m, p, x))));
            IIntegrate(324, Int(Times(Power(Times(c_DEFAULT, x_), m_), Power(Plus($p("a1"), Times($p("b1", true), Power(x_, n_))), p_), Power(Plus($p("a2"), Times($p("b2", true), Power(x_, n_))), p_)), x_Symbol),
                    Condition(Subtract(Simp(Times(Power(c, Subtract(Times(C2, n), C1)), Power(Times(c, x), Plus(m, Times(CN1, C2, n), C1)), Power(Plus($s("a1"), Times($s("b1"), Power(x, n))), Plus(p, C1)), Power(Plus($s("a2"), Times($s("b2"), Power(x, n))), Plus(p, C1)), Power(Times($s("b1"), $s("b2"), Plus(m, Times(C2, n, p), C1)), CN1)), x), Dist(Times($s("a1"), $s("a2"), Power(c, Times(C2, n)), Plus(m, Times(CN1, C2, n), C1), Power(Times($s("b1"), $s("b2"), Plus(m, Times(C2, n, p), C1)), CN1)), Int(Times(Power(Times(c, x), Subtract(m, Times(C2, n))), Power(Plus($s("a1"), Times($s("b1"), Power(x, n))), p), Power(Plus($s("a2"), Times($s("b2"), Power(x, n))), p)), x), x)), And(FreeQ(List($s("a1"), $s("b1"), $s("a2"), $s("b2"), c, m, p), x), EqQ(Plus(Times($s("a2"), $s("b1")), Times($s("a1"), $s("b2"))), C0), IGtQ(Times(C2, n), C0), SumSimplerQ(m, Times(CN2, n)), NeQ(Plus(m, Times(C2, n, p), C1), C0), ILtQ(Simplify(Plus(Times(Plus(m, C1), Power(Times(C2, n), CN1)), p)), C0))));
            IIntegrate(325, Int(Times(Power(Times(c_DEFAULT, x_), m_), Power(Plus(a_, Times(b_DEFAULT, Power(x_, n_))), p_)), x_Symbol),
                    Condition(Subtract(Simp(Times(Power(Times(c, x), Plus(m, C1)), Power(Plus(a, Times(b, Power(x, n))), Plus(p, C1)), Power(Times(a, c, Plus(m, C1)), CN1)), x), Dist(Times(b, Plus(m, Times(n, Plus(p, C1)), C1), Power(Times(a, Power(c, n), Plus(m, C1)), CN1)), Int(Times(Power(Times(c, x), Plus(m, n)), Power(Plus(a, Times(b, Power(x, n))), p)), x), x)), And(FreeQ(List(a, b, c, p), x), IGtQ(n, C0), LtQ(m, CN1), IntBinomialQ(a, b, c, n, m, p, x))));
        }
    }
}
