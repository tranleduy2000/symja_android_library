...
public class TeXFormFactory {
  ...
  protected String convertDoubleToFormattedString(double dValue) {
    if (fSignificantFigures > 0) {
      try {
        StringBuilder buf = new StringBuilder();
        DoubleToMMA
            .doubleToMMA((Appendable) buf, dValue, fExponentFigures, fSignificantFigures, true);
        return buf.toString();
  ...
  public void init() {
    ...
    operTab
        .put(F.CompoundExpression, new AbstractOperator(this, Precedence.COMPOUNDEXPRESSION, ";"));
    ...
    operTab.put(F.UndirectedEdge,
        new AbstractOperator(this, Precedence.UNDIRECTEDEDGE, "\\leftrightarrow "));
    operTab
        .put(F.TwoWayRule, new AbstractOperator(this, Precedence.TWOWAYRULE, "\\leftrightarrow "));
