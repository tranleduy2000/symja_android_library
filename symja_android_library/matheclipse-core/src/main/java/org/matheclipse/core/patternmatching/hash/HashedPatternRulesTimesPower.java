...
public class HashedPatternRulesTimesPower extends HashedPatternRulesTimes {
  ...
  /**
   * If <code>lhsPattern1.isPower()</code> or <code>lhsPattern2.isPower()</code> take the hashcode
   * from the head of <code>base()</code>, otherwise take the hashcode form the head of expression.
   *
   * @param lhsPattern1
   * @param lhsPattern2
   * @param rhsResult
  ...
  /**
   * If <code>lhsPattern1.isPower()</code> or <code>lhsPattern2.isPower()</code> get the hashcode
   * from the head of <code>base().head()</code>, otherwise get the hashcode form the <code>head()
   * </code> of expression.
   *
   * @param lhsPattern1
   * @param lhsPattern2
