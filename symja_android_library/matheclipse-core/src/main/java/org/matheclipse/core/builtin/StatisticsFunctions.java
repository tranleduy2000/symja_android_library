...
//		}
  ...
  private final static class BernoulliDistribution extends IDistributionFunctionImpl
    ...
    public IExpr skewness(IAST dist) {
      if (dist.isAST1()) {
        ...
        // (1 - 2*s)/Sqrt((1 - s)*s)
        return F
            .Divide(F.Subtract(F.C1, F.Times(F.C2, s)), F.Sqrt(F.Times(F.Subtract(F.C1, s), s)));
      }
      return F.NIL;
    }
    ...
    public IExpr randomVariate(Random random, IAST dist, int size) {
      if (dist.isAST2()) {
        ...
        if (a != null && b != null) {
          RandomDataGenerator rdg = new RandomDataGenerator();
          double[] vector = rdg
              .nextDeviates(new org.hipparchus.distribution.continuous.BetaDistribution(
  ...
  private static final class BinCounts extends AbstractFunctionEvaluator {
    ...
    private static IAST dropNonReals(final EvalEngine engine, IAST vector) {
      IAST[] filter = vector.filterNIL(new Function<IExpr, IExpr>() {
        @Override
  ...
  private final static class BinomialDistribution extends IDiscreteDistributionFunctionImpl
    ...
    public IExpr skewness(IAST dist) {
      if (dist.isAST2()) {
        ...
        // (1 - 2*m)/Sqrt((1 - m)*m*n)
        return F
            .Divide(F.Subtract(F.C1, F.Times(F.C2, m)), F.Sqrt(F.Times(F.Subtract(F.C1, m), m, n)));
      }
      return F.NIL;
    }
        ...
        if (ast.isAST1()) {
          ...
          if (ast.arg1() instanceof ASTRealMatrix) {
            PearsonsCorrelation pc = new PearsonsCorrelation(
                ((ASTRealMatrix) ast.arg1()).getRealMatrix());
    ...
    public IExpr cdf(IAST dist, IExpr k, EvalEngine engine) {
      if (dist.isAST2()) {
        ...
        if (!engine.isArbitraryMode() && //
          ...
          try {
            return F.num(
                new org.hipparchus.distribution.continuous.FDistribution(n.evalDouble(),
                    m.evalDouble()) //
                    .cumulativeProbability(k.evalDouble()));
          } catch (RuntimeException rex) {
            //
        ...
        return
            ...
            F.Piecewise(F.List(F.List(
                F.Times(F.C2, F.CSqrt2, F.Sqrt(F.Plus(F.CN4, m)),
                    ...
                    F.Power(F.Times(F.Plus(F.CN6, m), F.Sqrt(n), F.Sqrt(F.Plus(F.CN2, m, n))),
                        F.CN1)),
      ...
      if (dist.isAST2()) {
        ...
        IExpr function =
            ...
            F.Function(F.Piecewise(F
                    .List(F.List(
                        F.Exp(F.Negate(F.Power(F.Times(F.Power(m, F.CN1), F.Slot1), F.Negate(n)))),
                        F.Greater(F.Slot1, F.C0))),
                F.C0)); // $$;
        return callFunction(function, k);
      }
    ...
    public IExpr mean(IAST dist) {
      ...
      if (dist.size() == 5) {
        ...
        return // [$ d + (b*Gamma(a + 1/g))/Gamma(a) $]
            F.Plus(d, F.Times(b, F.Power(F.Gamma(a), F.CN1),
                F.Gamma(F.Plus(a, F.Power(g, F.CN1))))); // $$;
      }
      return F.NIL;
    }
      ...
      if (dist.isAST2()) {
        ...
        return
            ...
            F.Times(F.Power(m, F.CN1),
                F.Log(F.Plus(F.C1, F.Times(F.Power(n, F.CN1), F.Log(F.C2))))); // $$;
      }
      return F.NIL;
    }
  ...
  private final static class GumbelDistribution extends IDistributionFunctionImpl
    ...
    public IExpr randomVariate(Random random, IAST dist, int size) {
      if (dist.isAST2()) {
        ...
        RandomDataGenerator rdg = new RandomDataGenerator();
        double[] vector = rdg
            .nextDeviates(new org.hipparchus.distribution.continuous.GumbelDistribution(n, m),
                size);
        return new ASTRealVector(vector, false);
    ...
    public IExpr randomVariate(Random random, IAST dist, int size) {
      if (dist.isAST3()) {
        ...
        if (param != null) {
          RandomDataGenerator rdg = new RandomDataGenerator();
          int[] vector = rdg
              .nextDeviates(new org.hipparchus.distribution.discrete.HypergeometricDistribution(
  ...
  private final static class DiscreteUniformDistribution extends IDiscreteDistributionFunctionImpl
    ...
    public IExpr median(IAST dist) {
      ...
      if (minMax != null) {
        ...
        return F
            .Plus(F.CN1, l, F.Max(F.C1, F.Ceiling(F.Times(F.C1D2, F.Plus(F.C1, F.Negate(l), r)))));
      }
      return F.NIL;
    }
    ...
    public IExpr pdf(IAST dist, IExpr k, EvalEngine engine) {
      ...
      if (minMax != null) {
        ...
        IExpr function =
            ...
            F.Function(F.Piecewise(F
                    .List(F.List(F.Power(F.Plus(F.C1, F.Negate(a), b), F.CN1),
  ...
  private final static class LogNormalDistribution extends IDistributionFunctionImpl
    ...
    public IExpr cdf(IAST dist, IExpr k, EvalEngine engine) {
      if (dist.isAST2()) {
        ...
        if (!engine.isArbitraryMode() && //
          ...
          try {
            return F.num(
                new org.hipparchus.distribution.continuous.LogNormalDistribution(n.evalDouble(),
                    m.evalDouble()) //
                    .cumulativeProbability(k.evalDouble()));
          } catch (RuntimeException rex) {
            //
                ...
                F.Piecewise(
                    F.List(F.List(F.Power(F.Times(
                        F.Exp(F.Times(F.Power(F.Times(F.C2, F.Sqr(m)), F.CN1),
                            F.Sqr(F.Plus(F.Negate(n), F.Log(F.Slot1))))), F.Slot1, m,
                        F.Sqrt(F.C2Pi)),
    ...
    public IExpr variance(IAST dist) {
      if (dist.isAST2()) {
        ...
        IExpr s = dist.arg2();
        // E^(2*m+s^2)*(-1+E^(s^2))
        return F.Times(F.Plus(F.CN1, F.Power(F.E, F.Sqr(s))),
    ...
    private static IExpr median(final IAST weightedData, EvalEngine engine) {
      ...
      if (size > 1 && size == weights.size()) {
        ...
        for (int i = 1; i < size; i++) {
          ...
          IExpr boole = engine
              .evaluate(F.Boole(F.Inequality(lhs, F.Less, F.C1D2, F.LessEqual, rhs)));
          if (boole.isOne()) {
    ...
    public IExpr cdf(IAST dist, IExpr k, EvalEngine engine) {
      if (dist.isAST2()) {
        ...
        IExpr function =
            ...
            F.Function(F.Piecewise(F
                    .List(F.List(
                        F.GammaRegularized(n, F.C0, F.Times(F.Power(m, F.CN1), n, F.Sqr(F.Slot1))),
                        F.Greater(F.Slot1, F.C0))),
                F.C0)); // $$;
        return callFunction(function, k);
      }
  ...
  private final static class NormalDistribution extends IDistributionFunctionImpl
    ...
    public IExpr pdf(IAST dist, IExpr k, EvalEngine engine) {
      if (dist.isAST0()) {
        IExpr function =
            // [$ ( 1/(E^(#^2/2)*Sqrt(2*Pi)) & ) $]
            F.Function(F.Power(F.Times(F.Exp(F.Times(F.C1D2, F.Sqr(F.Slot1))), F.Sqrt(F.C2Pi)),
                F.CN1)); // $$;
        return callFunction(function, k);
      } else if (dist.isAST2()) {
        //
        ...
        IExpr function =
            ...
            F.Function(F.Power(F.Times(F.Exp(
                F.Times(F.Power(F.Times(F.C2, F.Sqr(m)), F.CN1),
  ...
  private final static class PoissonDistribution extends IDiscreteDistributionFunctionImpl
    ...
    public IExpr randomVariate(Random random, IAST dist, int size) {
      if (dist.isAST1()) {
        ...
        RandomDataGenerator rdg = new RandomDataGenerator();
        int[] vector = rdg
            .nextDeviates(new org.hipparchus.distribution.discrete.PoissonDistribution(mean),
                size);
        return F.List(vector);
      }
      return F.NIL;
  ...
  private final static class RandomVariate extends AbstractEvaluator {
              ...
              if (evaluator instanceof IRandomVariate) {
                ...
                if (ast.size() == 3) {
                  ...
                  if (arg2.isList()) {
                    ...
                    // create a tensor
                    final int sampleSize = indx[indx.length - 1];
                    ...
                    return createArray(indx, 1, list,
                        new Supplier<IExpr>() {
                          @Override
                          public IExpr get() {
                            return variate.randomVariate(random, dist, sampleSize);
                          }
                        });
                  } else {
    ...
    private static IAST createArray(int[] indx, int offset, IASTAppendable list,
        Supplier<IExpr> s) {
   ...
   * </pre>
   */
  private final static class StandardDeviation extends AbstractFunctionEvaluator implements
  ...
  private final static class Standardize extends AbstractEvaluator {
    ...
    public IExpr evaluate(final IAST ast, EvalEngine engine) {
      ...
      if (dim != null) {
        IExpr temp = arg1.mapMatrixColumns(dim, new Function<IExpr, IExpr>() {
          @Override
          public IExpr apply(IExpr v) {
            return F.Standardize(v);
          }
        });
        return temp.ifPresent(new Function<IExpr, IExpr>() {
          @Override
          public IExpr apply(IExpr x) {
  ...
  private final static class StudentTDistribution extends IDistributionFunctionImpl
    ...
    public IExpr mean(IAST dist) {
      ...
      if (dist.isAST3()) {
        ...
        return F
            .Piecewise(F.List(F.List(dist.arg1(), F.Greater(dist.arg3(), F.C1))), F.Indeterminate);
      }
      return F.NIL;
    }
    ...
    public IExpr cdf(IAST dist, IExpr k, EvalEngine engine) {
      ...
      if (minMax != null) {
        ...
        if (!engine.isArbitraryMode() && //
          ...
          try {
            return F.num(
                new org.hipparchus.distribution.continuous.UniformRealDistribution(a.evalDouble(),
                    b.evalDouble()) //
                    .cumulativeProbability(k.evalDouble()));
          } catch (RuntimeException rex) {
            //
