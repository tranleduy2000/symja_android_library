...
public class ID {
  ...
  public static final int CoprimeQ = 272;
  public static final int Correlation = 273;
  public static final int Cos = 274;
  public static final int CosIntegral = 275;
  public static final int Cosh = 276;
  public static final int CoshIntegral = 277;
  public static final int CosineDistance = 278;
  public static final int Cot = 279;
  public static final int Coth = 280;
  public static final int Count = 281;
  public static final int CountDistinct = 282;
  public static final int Counts = 283;
  public static final int Covariance = 284;
  public static final int CreateDirectory = 285;
  public static final int CreateFile = 286;
  public static final int Cross = 287;
  public static final int Csc = 288;
  public static final int Csch = 289;
  public static final int CubeRoot = 290;
  public static final int Cuboid = 291;
  public static final int Curl = 292;
  public static final int Cyan = 293;
  public static final int Cycles = 294;
  public static final int Cyclotomic = 295;
  public static final int Cylinder = 296;
  public static final int D = 297;
  public static final int DSolve = 298;
  public static final int Dataset = 299;
  public static final int DateObject = 300;
  public static final int DateValue = 301;
  public static final int Decrement = 302;
  public static final int Default = 303;
  public static final int DefaultButton = 304;
  public static final int DefaultValue = 305;
  public static final int Defer = 306;
  public static final int Definition = 307;
  public static final int Degree = 308;
  public static final int DegreeLexicographic = 309;
  public static final int DegreeReverseLexicographic = 310;
  public static final int Delete = 311;
  public static final int DeleteCases = 312;
  public static final int DeleteDuplicates = 313;
  public static final int DeleteDuplicatesBy = 314;
  public static final int Denominator = 315;
  public static final int DensityHistogram = 316;
  public static final int DensityPlot = 317;
  public static final int Depth = 318;
  public static final int Derivative = 319;
  public static final int DesignMatrix = 320;
  public static final int Det = 321;
  public static final int Diagonal = 322;
  public static final int DiagonalMatrix = 323;
  public static final int DialogInput = 324;
  public static final int DialogNotebook = 325;
  public static final int DialogReturn = 326;
  public static final int DiceDissimilarity = 327;
  public static final int DifferenceDelta = 328;
  public static final int Differences = 329;
  public static final int DigitCharacter = 330;
  public static final int DigitCount = 331;
  public static final int DigitQ = 332;
  public static final int Dimensions = 333;
  public static final int DiracDelta = 334;
  public static final int DirectedEdge = 335;
  public static final int DirectedInfinity = 336;
  public static final int Direction = 337;
  public static final int Directive = 338;
  public static final int DirichletEta = 339;
  public static final int DirichletWindow = 340;
  public static final int DiscreteDelta = 341;
  public static final int DiscreteUniformDistribution = 342;
  public static final int Discriminant = 343;
  public static final int DisjointQ = 344;
  public static final int Disk = 345;
  public static final int Dispatch = 346;
  public static final int Disputed = 347;
  public static final int DisrectedEdges = 348;
  public static final int DistanceFunction = 349;
  public static final int Distribute = 350;
  public static final int Distributed = 351;
  public static final int Div = 352;
  public static final int Divide = 353;
  public static final int DivideBy = 354;
  public static final int Divisible = 355;
  public static final int DivisorSigma = 356;
  public static final int DivisorSum = 357;
  public static final int Divisors = 358;
  public static final int Do = 359;
  public static final int Dodecahedron = 360;
  public static final int Dot = 361;
  public static final int DownValues = 362;
  public static final int Drop = 363;
  public static final int DuplicateFreeQ = 364;
  public static final int Dynamic = 365;
  public static final int E = 366;
  public static final int EasterSunday = 367;
  public static final int Echo = 368;
  public static final int EchoFunction = 369;
  public static final int EdgeCount = 370;
  public static final int EdgeForm = 371;
  public static final int EdgeLabels = 372;
  public static final int EdgeList = 373;
  public static final int EdgeQ = 374;
  public static final int EdgeShapeFunction = 375;
  public static final int EdgeStyle = 376;
  public static final int EdgeWeight = 377;
  public static final int EditDistance = 378;
  public static final int EffectiveInterest = 379;
  public static final int Eigenvalues = 380;
  public static final int Eigenvectors = 381;
  public static final int Element = 382;
  public static final int ElementData = 383;
  public static final int Eliminate = 384;
  public static final int EliminationOrder = 385;
  public static final int Ellipsoid = 386;
  public static final int EllipticE = 387;
  public static final int EllipticF = 388;
  public static final int EllipticK = 389;
  public static final int EllipticPi = 390;
  public static final int EllipticTheta = 391;
  public static final int End = 392;
  public static final int EndOfFile = 393;
  public static final int EndOfLine = 394;
  public static final int EndOfString = 395;
  public static final int EndPackage = 396;
  public static final int EndTestSection = 397;
  public static final int Entity = 398;
  public static final int Entropy = 399;
  public static final int Equal = 400;
  public static final int Equivalent = 401;
  public static final int Erf = 402;
  public static final int Erfc = 403;
  public static final int Erfi = 404;
  public static final int ErlangDistribution = 405;
  public static final int EuclideanDistance = 406;
  public static final int EulerE = 407;
  public static final int EulerGamma = 408;
  public static final int EulerPhi = 409;
  public static final int EulerianGraphQ = 410;
  public static final int Evaluate = 411;
  public static final int EvenQ = 412;
  public static final int ExactNumberQ = 413;
  public static final int Except = 414;
  public static final int Exists = 415;
  public static final int Exit = 416;
  public static final int Exp = 417;
  public static final int ExpIntegralE = 418;
  public static final int ExpIntegralEi = 419;
  public static final int ExpToTrig = 420;
  public static final int Expand = 421;
  public static final int ExpandAll = 422;
  public static final int Expectation = 423;
  public static final int Exponent = 424;
  public static final int ExponentialDistribution = 425;
  public static final int Export = 426;
  public static final int ExportString = 427;
  public static final int Expression = 428;
  public static final int ExtendedGCD = 429;
  public static final int Extension = 430;
  public static final int Extract = 431;
  public static final int FRatioDistribution = 432;
  public static final int Factor = 433;
  public static final int FactorInteger = 434;
  public static final int FactorSquareFree = 435;
  public static final int FactorSquareFreeList = 436;
  public static final int FactorTerms = 437;
  public static final int Factorial = 438;
  public static final int Factorial2 = 439;
  public static final int FactorialPower = 440;
  public static final int False = 441;
  public static final int Fibonacci = 442;
  public static final int File = 443;
  public static final int FileNameJoin = 444;
  public static final int FileNameTake = 445;
  public static final int FileNames = 446;
  public static final int FilePrint = 447;
  public static final int FilterRules = 448;
  public static final int FindClusters = 449;
  public static final int FindEdgeCover = 450;
  public static final int FindEulerianCycle = 451;
  public static final int FindFit = 452;
  public static final int FindGraphCommunities = 453;
  public static final int FindHamiltonianCycle = 454;
  public static final int FindIndependentEdgeSet = 455;
  public static final int FindIndependentVertexSet = 456;
  public static final int FindInstance = 457;
  public static final int FindPermutation = 458;
  public static final int FindRoot = 459;
  public static final int FindShortestPath = 460;
  public static final int FindShortestTour = 461;
  public static final int FindSpanningTree = 462;
  public static final int FindVertexCover = 463;
  public static final int First = 464;
  public static final int FirstCase = 465;
  public static final int FirstPosition = 466;
  public static final int Fit = 467;
  public static final int FittedModel = 468;
  public static final int FiveNum = 469;
  public static final int FixedPoint = 470;
  public static final int FixedPointList = 471;
  public static final int Flat = 472;
  public static final int FlatTopWindow = 473;
  public static final int Flatten = 474;
  public static final int FlattenAt = 475;
  public static final int Float = 476;
  public static final int Floor = 477;
  public static final int Fold = 478;
  public static final int FoldList = 479;
  public static final int For = 480;
  public static final int ForAll = 481;
  public static final int Fourier = 482;
  public static final int FourierMatrix = 483;
  public static final int FractionalPart = 484;
  public static final int FrechetDistribution = 485;
  public static final int FreeQ = 486;
  public static final int FresnelC = 487;
  public static final int FresnelS = 488;
  public static final int FrobeniusNumber = 489;
  public static final int FrobeniusSolve = 490;
  public static final int FromCharacterCode = 491;
  public static final int FromContinuedFraction = 492;
  public static final int FromDigits = 493;
  public static final int FromLetterNumber = 494;
  public static final int FromPolarCoordinates = 495;
  public static final int Full = 496;
  public static final int FullForm = 497;
  public static final int FullSimplify = 498;
  public static final int Function = 499;
  public static final int FunctionExpand = 500;
  public static final int FunctionRange = 501;
  public static final int FunctionURL = 502;
  public static final int GCD = 503;
  public static final int Gamma = 504;
  public static final int GammaDistribution = 505;
  public static final int GammaRegularized = 506;
  public static final int Gather = 507;
  public static final int GatherBy = 508;
  public static final int GaussianIntegers = 509;
  public static final int GaussianMatrix = 510;
  public static final int GaussianWindow = 511;
  public static final int GegenbauerC = 512;
  public static final int General = 513;
  public static final int GeoDistance = 514;
  public static final int GeoPosition = 515;
  public static final int GeodesyData = 516;
  public static final int GeometricDistribution = 517;
  public static final int GeometricMean = 518;
  public static final int GeometricTransformation = 519;
  public static final int Get = 520;
  public static final int Glaisher = 521;
  public static final int GoldenAngle = 522;
  public static final int GoldenRatio = 523;
  public static final int GompertzMakehamDistribution = 524;
  public static final int Grad = 525;
  public static final int Graph = 526;
  public static final int GraphCenter = 527;
  public static final int GraphData = 528;
  public static final int GraphDiameter = 529;
  public static final int GraphPeriphery = 530;
  public static final int GraphQ = 531;
  public static final int GraphRadius = 532;
  public static final int GraphUnion = 533;
  public static final int Graphics = 534;
  public static final int Graphics3D = 535;
  public static final int GraphicsComplex = 536;
  public static final int GraphicsGroup = 537;
  public static final int Gray = 538;
  public static final int GrayLevel = 539;
  public static final int Greater = 540;
  public static final int GreaterEqual = 541;
  public static final int Green = 542;
  public static final int GroebnerBasis = 543;
  public static final int GroupBy = 544;
  public static final int Gudermannian = 545;
  public static final int GumbelDistribution = 546;
  public static final int HamiltonianGraphQ = 547;
  public static final int HammingDistance = 548;
  public static final int HammingWindow = 549;
  public static final int HankelH1 = 550;
  public static final int HankelH2 = 551;
  public static final int HannWindow = 552;
  public static final int HarmonicMean = 553;
  public static final int HarmonicNumber = 554;
  public static final int Haversine = 555;
  public static final int Head = 556;
  public static final int Heads = 557;
  public static final int HeavisideTheta = 558;
  public static final int HermiteH = 559;
  public static final int HermitianMatrixQ = 560;
  public static final int HexidecimalCharacter = 561;
  public static final int HilbertMatrix = 562;
  public static final int Histogram = 563;
  public static final int Hold = 564;
  public static final int HoldAll = 565;
  public static final int HoldAllComplete = 566;
  public static final int HoldComplete = 567;
  public static final int HoldFirst = 568;
  public static final int HoldForm = 569;
  public static final int HoldPattern = 570;
  public static final int HoldRest = 571;
  public static final int Horner = 572;
  public static final int HornerForm = 573;
  public static final int Hue = 574;
  public static final int HurwitzZeta = 575;
  public static final int Hypergeometric0F1 = 576;
  public static final int Hypergeometric1F1 = 577;
  public static final int Hypergeometric1F1Regularized = 578;
  public static final int Hypergeometric2F1 = 579;
  public static final int HypergeometricDistribution = 580;
  public static final int HypergeometricPFQ = 581;
  public static final int HypergeometricPFQRegularized = 582;
  public static final int HypergeometricU = 583;
  public static final int I = 584;
  public static final int Icosahedron = 585;
  public static final int Identity = 586;
  public static final int IdentityMatrix = 587;
  public static final int If = 588;
  public static final int IgnoreCase = 589;
  public static final int Im = 590;
  public static final int Implies = 591;
  public static final int Import = 592;
  public static final int ImportString = 593;
  public static final int In = 594;
  public static final int Increment = 595;
  public static final int Indeterminate = 596;
  public static final int Inequality = 597;
  public static final int InexactNumberQ = 598;
  public static final int Infinity = 599;
  public static final int Infix = 600;
  public static final int Information = 601;
  public static final int Inherited = 602;
  public static final int Inner = 603;
  public static final int Input = 604;
  public static final int InputField = 605;
  public static final int InputForm = 606;
  public static final int InputStream = 607;
  public static final int InputString = 608;
  public static final int Insert = 609;
  public static final int InsertionFunction = 610;
  public static final int InstallJava = 611;
  public static final int InstanceOf = 612;
  public static final int Integer = 613;
  public static final int IntegerDigits = 614;
  public static final int IntegerExponent = 615;
  public static final int IntegerLength = 616;
  public static final int IntegerName = 617;
  public static final int IntegerPart = 618;
  public static final int IntegerPartitions = 619;
  public static final int IntegerQ = 620;
  public static final int Integers = 621;
  public static final int Integrate = 622;
  public static final int InterpolatingFunction = 623;
  public static final int InterpolatingPolynomial = 624;
  public static final int Interpolation = 625;
  public static final int Interrupt = 626;
  public static final int IntersectingQ = 627;
  public static final int Intersection = 628;
  public static final int Interval = 629;
  public static final int IntervalIntersection = 630;
  public static final int IntervalMemberQ = 631;
  public static final int IntervalUnion = 632;
  public static final int Inverse = 633;
  public static final int InverseBetaRegularized = 634;
  public static final int InverseCDF = 635;
  public static final int InverseErf = 636;
  public static final int InverseErfc = 637;
  public static final int InverseFourier = 638;
  public static final int InverseFunction = 639;
  public static final int InverseGammaRegularized = 640;
  public static final int InverseGudermannian = 641;
  public static final int InverseHaversine = 642;
  public static final int InverseLaplaceTransform = 643;
  public static final int InverseSeries = 644;
  public static final int InverseWeierstrassP = 645;
  public static final int JSForm = 646;
  public static final int JSFormData = 647;
  public static final int JaccardDissimilarity = 648;
  public static final int JacobiAmplitude = 649;
  public static final int JacobiCD = 650;
  public static final int JacobiCN = 651;
  public static final int JacobiDC = 652;
  public static final int JacobiDN = 653;
  public static final int JacobiEpsilon = 654;
  public static final int JacobiMatrix = 655;
  public static final int JacobiNC = 656;
  public static final int JacobiND = 657;
  public static final int JacobiSC = 658;
  public static final int JacobiSD = 659;
  public static final int JacobiSN = 660;
  public static final int JacobiSymbol = 661;
  public static final int JacobiZeta = 662;
  public static final int JavaClass = 663;
  public static final int JavaForm = 664;
  public static final int JavaNew = 665;
  public static final int JavaObject = 666;
  public static final int JavaObjectQ = 667;
  public static final int JavaShow = 668;
  public static final int Join = 669;
  public static final int KOrderlessPartitions = 670;
  public static final int KPartitions = 671;
  public static final int KelvinBei = 672;
  public static final int KelvinBer = 673;
  public static final int Key = 674;
  public static final int KeyAbsent = 675;
  public static final int KeyExistsQ = 676;
  public static final int KeySelect = 677;
  public static final int KeySort = 678;
  public static final int KeyTake = 679;
  public static final int Keys = 680;
  public static final int Khinchin = 681;
  public static final int KleinInvariantJ = 682;
  public static final int KnownUnitQ = 683;
  public static final int KolmogorovSmirnovTest = 684;
  public static final int KroneckerDelta = 685;
  public static final int KroneckerProduct = 686;
  public static final int Kurtosis = 687;
  public static final int LCM = 688;
  public static final int LUDecomposition = 689;
  public static final int Labeled = 690;
  public static final int LaguerreL = 691;
  public static final int LambertW = 692;
  public static final int LaplaceTransform = 693;
  public static final int Last = 694;
  public static final int LeafCount = 695;
  public static final int LeastSquares = 696;
  public static final int Left = 697;
  public static final int LegendreP = 698;
  public static final int LegendreQ = 699;
  public static final int Length = 700;
  public static final int Less = 701;
  public static final int LessEqual = 702;
  public static final int LetterCharacter = 703;
  public static final int LetterCounts = 704;
  public static final int LetterNumber = 705;
  public static final int LetterQ = 706;
  public static final int Level = 707;
  public static final int LevelQ = 708;
  public static final int Lexicographic = 709;
  public static final int LightBlue = 710;
  public static final int LightBrown = 711;
  public static final int LightCyan = 712;
  public static final int LightGray = 713;
  public static final int LightGreen = 714;
  public static final int LightMagenta = 715;
  public static final int LightOrange = 716;
  public static final int LightPink = 717;
  public static final int LightPurple = 718;
  public static final int LightRed = 719;
  public static final int LightYellow = 720;
  public static final int Limit = 721;
  public static final int Line = 722;
  public static final int LineGraph = 723;
  public static final int LinearModelFit = 724;
  ...
  public static final int[] LINE_NUMBER_OF_JAVA_CLASS =
      new int[] { //
        ...
        0, 1921, 0, 2529, 1581, 2052, 2504, 2404, 2472, 2570, 2113, //
        2387, 2182, 0, 2575, 0, 503, 549, 36, 553, 672, 314, //
