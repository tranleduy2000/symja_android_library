...
public final class RulesData implements Serializable {
  ...
  public final IPatternMatcher putDownRule(final int setSymbol, final boolean equalRule,
    ...
    if (equalRule || leftHandSide.isSymbol()) {
      ...
      PatternMatcherEquals pmEquals = new PatternMatcherEquals(setSymbol, leftHandSide,
          rightHandSide);
    ...
    if (leftHandSide.isAST(F.Integrate)) {
      ...
      pmEvaluator = new PatternMatcherAndEvaluator(setSymbol, leftHandSide, rightHandSide, true,
          patternHash);
