...
public class BigFractionSym extends AbstractFractionSym {
  ...
  public IFraction add(IFraction other) {
    ...
    BigInteger newnum = toBigNumerator().multiply(odenomgcd)
        .add(other.toBigNumerator().multiply(tdenomgcd));
  ...
  public String internalJavaString(
    ...
    return prefix + "QQ(" + fFraction.getNumerator().toString() + "L," + fFraction.getDenominator()
        .toString()
        + "L)";
  }
