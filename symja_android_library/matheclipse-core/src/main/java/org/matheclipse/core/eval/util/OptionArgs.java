...
public class OptionArgs {
   ...
   * @param currentOptionsList the AST where the option could be defined starting at position <code>startIndex</code>
   * @param startIndex the index from which to look for options defined in <code>currentOptionsList</code>
   ...
   * @param currentOptionsList the AST where the option could be defined starting at position <code>startIndex</code>
   * @param startIndex the index from which to look for options defined in <code>currentOptionsList</code>
   * @param endIndex the index from which to look for options defined in <code>currentOptionsList</code>
   */
  public OptionArgs(final ISymbol symbol, final IAST currentOptionsList, final int startIndex,
      final int endIndex,
      final EvalEngine engine) {
