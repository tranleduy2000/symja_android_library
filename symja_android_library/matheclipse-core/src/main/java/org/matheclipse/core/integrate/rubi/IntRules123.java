...
public class IntRules123 {
    ...
    private static class Initializer {
        ...
        private static void init() {
            IIntegrate(3076, Int(Power(Plus(Times($($s("§cos"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))), a_DEFAULT), Times(b_DEFAULT, $($s("§sin"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))))), n_), x_Symbol),
                    Condition(Plus(Simp(Times(Subtract(Times(b, Cos(Plus(c, Times(d, x)))), Times(a, Sin(Plus(c, Times(d, x))))), Power(Plus(Times(a, Cos(Plus(c, Times(d, x)))), Times(b, Sin(Plus(c, Times(d, x))))), Plus(n, C1)), Power(Times(d, Plus(n, C1), Plus(Sqr(a), Sqr(b))), CN1)), x), Dist(Times(Plus(n, C2), Power(Times(Plus(n, C1), Plus(Sqr(a), Sqr(b))), CN1)), Int(Power(Plus(Times(a, Cos(Plus(c, Times(d, x)))), Times(b, Sin(Plus(c, Times(d, x))))), Plus(n, C2)), x), x)), And(FreeQ(List(a, b, c, d), x), NeQ(Plus(Sqr(a), Sqr(b)), C0), LtQ(n, CN1), NeQ(n, CN2))));
            IIntegrate(3077, Int(Power(Plus(Times($($s("§cos"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))), a_DEFAULT), Times(b_DEFAULT, $($s("§sin"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))))), n_), x_Symbol),
                    Condition(Dist(Power(Plus(Sqr(a), Sqr(b)), Times(C1D2, n)), Int(Power(Cos(Subtract(Plus(c, Times(d, x)), ArcTan(a, b))), n), x), x), And(FreeQ(List(a, b, c, d, n), x), Not(Or(GeQ(n, C1), LeQ(n, CN1))), GtQ(Plus(Sqr(a), Sqr(b)), C0))));
            IIntegrate(3078, Int(Power(Plus(Times($($s("§cos"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))), a_DEFAULT), Times(b_DEFAULT, $($s("§sin"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))))), n_), x_Symbol),
                    Condition(Dist(Times(Power(Plus(Times(a, Cos(Plus(c, Times(d, x)))), Times(b, Sin(Plus(c, Times(d, x))))), n), Power(Power(Times(Plus(Times(a, Cos(Plus(c, Times(d, x)))), Times(b, Sin(Plus(c, Times(d, x))))), Power(Plus(Sqr(a), Sqr(b)), CN1D2)), n), CN1)), Int(Power(Cos(Subtract(Plus(c, Times(d, x)), ArcTan(a, b))), n), x), x), And(FreeQ(List(a, b, c, d, n), x), Not(Or(GeQ(n, C1), LeQ(n, CN1))), Not(Or(GtQ(Plus(Sqr(a), Sqr(b)), C0), EqQ(Plus(Sqr(a), Sqr(b)), C0))))));
            IIntegrate(3079, Int(Times(Power($($s("§sin"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))), m_), Power(Plus(Times($($s("§cos"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))), a_DEFAULT), Times(b_DEFAULT, $($s("§sin"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))))), n_)), x_Symbol),
                    Condition(Plus(Negate(Simp(Times(a, Power(Plus(Times(a, Cos(Plus(c, Times(d, x)))), Times(b, Sin(Plus(c, Times(d, x))))), Subtract(n, C1)), Power(Times(d, Subtract(n, C1), Power(Sin(Plus(c, Times(d, x))), Subtract(n, C1))), CN1)), x)), Dist(Times(C2, b), Int(Times(Power(Plus(Times(a, Cos(Plus(c, Times(d, x)))), Times(b, Sin(Plus(c, Times(d, x))))), Subtract(n, C1)), Power(Power(Sin(Plus(c, Times(d, x))), Subtract(n, C1)), CN1)), x), x)), And(FreeQ(List(a, b, c, d), x), EqQ(Plus(m, n), C0), EqQ(Plus(Sqr(a), Sqr(b)), C0), GtQ(n, C1))));
            IIntegrate(3080, Int(Times(Power($($s("§cos"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))), m_), Power(Plus(Times($($s("§cos"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))), a_DEFAULT), Times(b_DEFAULT, $($s("§sin"), Plus(c_DEFAULT, Times(d_DEFAULT, x_))))), n_)), x_Symbol),
                    Condition(Plus(Simp(Times(b, Power(Plus(Times(a, Cos(Plus(c, Times(d, x)))), Times(b, Sin(Plus(c, Times(d, x))))), Subtract(n, C1)), Power(Times(d, Subtract(n, C1), Power(Cos(Plus(c, Times(d, x))), Subtract(n, C1))), CN1)), x), Dist(Times(C2, a), Int(Times(Power(Plus(Times(a, Cos(Plus(c, Times(d, x)))), Times(b, Sin(Plus(c, Times(d, x))))), Subtract(n, C1)), Power(Power(Cos(Plus(c, Times(d, x))), Subtract(n, C1)), CN1)), x), x)), And(FreeQ(List(a, b, c, d), x), EqQ(Plus(m, n), C0), EqQ(Plus(Sqr(a), Sqr(b)), C0), GtQ(n, C1))));
