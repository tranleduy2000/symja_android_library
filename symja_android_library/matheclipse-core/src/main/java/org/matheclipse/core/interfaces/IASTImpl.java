...
public abstract class IASTImpl extends IExprImpl implements IAST {
   ...
   * <code>AST</code> and return if one of the arguments satisfy the predicate.
   *
  ...
  /**
   * Check all elements by applying the <code>predicate</code> to each argument in this
   * <code>AST</code> and return if all of the arguments satisfy the predicate.
   *
   * @param predicate the predicate which filters each argument in this <code>AST</code>
  ...
  /**
   * Consume all elements generated by the given function from index <code>start</code> inclusive to
   * <code>end</code> exclusive.
   *
