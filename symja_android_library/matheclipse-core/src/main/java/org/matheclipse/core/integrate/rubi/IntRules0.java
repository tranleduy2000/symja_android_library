...
IIntegrate(6,Int(Times(u_DEFAULT,Power(Plus(Times(a_DEFAULT,v_),Times(b_DEFAULT,v_),w_DEFAULT),p_DEFAULT)),x_Symbol),
    Condition(Int(Times(u,Power(Plus(Times(Plus(a,b),v),w),p)),x),And(FreeQ(List(a,b),x),Not(FreeQ(v,x))))),
IIntegrate(7,Int(Times(Power($p("§px"),p_),u_DEFAULT),x_Symbol),
...
IIntegrate(11,Int(Times(u_,Complex(C0,a_)),x_Symbol),
...
IIntegrate(24,Int(Times(u_DEFAULT,Plus(A_DEFAULT,Times(B_DEFAULT,v_),Times(C_DEFAULT,Sqr(v_))),Power(Plus(a_,Times(b_DEFAULT,v_)),m_)),x_Symbol),
...
IIntegrate(26,Int(Times(u_DEFAULT,Power(Plus(c_,Times(d_DEFAULT,Power(x_,j_))),p_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_DEFAULT))),m_DEFAULT)),x_Symbol),
...
IIntegrate(28,Int(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_)),Times(c_DEFAULT,Power(x_,$p("n2",true)))),p_DEFAULT)),x_Symbol),
...
IIntegrate(34,Int(Times(Plus(c_,Times(d_DEFAULT,x_)),Power(Plus(a_,Times(b_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
