    ...
    if (ast.arg3().isList()) {
      ...
      try {
        ...
        if (listOfVariables.isList()) {
          AbstractIntegrator abstractIntegrator = new DormandPrince853Integrator(1.0e-8, 100.0,
              1.0e-10,
              1.0e-10);
          ...
          OrdinaryDifferentialEquation ode = new FirstODE(engine, dotEquations, listOfVariables,
              timeVar);
