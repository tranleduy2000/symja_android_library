...
public abstract class AbstractFractionSym extends IFractionImpl implements IFraction {
  ...
  public Apcomplex apcomplexValue(long precision) {
    Apfloat real = new Apfloat(toBigNumerator(), precision)
        .divide(new Apfloat(toBigDenominator(), precision));
  ...
  public boolean equalsInt(int i) {
    return toBigNumerator().equals(BigInteger.valueOf(i)) && toBigDenominator()
  ...
  public boolean isGT(ISignedNumber obj) {
    ...
    if (obj instanceof IInteger) {
      return
          compareTo(AbstractFractionSym.valueOf(((IInteger) obj).toBigNumerator(), BigInteger.ONE))
              > 0;
    }
  ...
  public IFraction mul(IFraction other) {
    ...
    OperationSystem
        .checkMultiplicationOperation(bigNumerator.bitLength(), otherBigNumerator.bitLength());
    ...
    OperationSystem
        .checkMultiplicationOperation(bigDenominator.bitLength(), otherBigDenominator.bitLength());
