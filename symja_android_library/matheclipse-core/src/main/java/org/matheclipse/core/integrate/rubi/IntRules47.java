...
public class IntRules47 {
    public static IAST RULES = List(
            ...
            IIntegrate(2387, Int(Times(Plus(a_DEFAULT, Times(Log(Times(c_DEFAULT, Power(x_, n_DEFAULT))), b_DEFAULT)), $p("§px", true), Power($(F_, Times(d_DEFAULT, Plus(e_DEFAULT, Times(f_DEFAULT, x_)))), m_DEFAULT)), x_Symbol),
                    Condition(With(List(Set(u, IntHide(Times($s("§px"), Power(F(Times(d, Plus(e, Times(f, x)))), m)), x))), Plus(Dist(Plus(a, Times(b, Log(Times(c, Power(x, n))))), u, x), Negate(Dist(Times(b, n), Int(Dist(Power(x, -1), u, x), x), x)))), And(FreeQ(List(a, b, c, d, e, f, n), x), PolynomialQ($s("§px"), x), IGtQ(m, C0), MemberQ(List(ArcSin, ArcCos, ArcSinh, ArcCosh), FSymbol)))),
            IIntegrate(2388, Int(Times(Plus(a_DEFAULT, Times(Log(Times(c_DEFAULT, Power(x_, n_DEFAULT))), b_DEFAULT)), $p("§px", true), $(F_, Times(d_DEFAULT, Plus(e_DEFAULT, Times(f_DEFAULT, x_))))), x_Symbol),
                    Condition(With(List(Set(u, IntHide(Times($s("§px"), F(Times(d, Plus(e, Times(f, x))))), x))), Plus(Dist(Plus(a, Times(b, Log(Times(c, Power(x, n))))), u, x), Negate(Dist(Times(b, n), Int(Dist(Power(x, -1), u, x), x), x)))), And(FreeQ(List(a, b, c, d, e, f, n), x), PolynomialQ($s("§px"), x), MemberQ(List(ArcTan, ArcCot, ArcTanh, ArcCoth), FSymbol)))),
