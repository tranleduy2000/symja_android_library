...
public class Object2Expr {
   ...
   */
  public static IExpr convert(Object obj, final boolean parseString, final boolean javaObject) {
    if (obj == null) {
      return S.Null;
    }
    ...
    if (obj instanceof Object[]) {
      ...
      return list.appendArgs(0, length, new IntFunction<IExpr>() {
        ...
        public IExpr apply(int i) {
          return convert(array[i], parseString, javaObject);
        }
      });
    }
    if (obj instanceof boolean[]) {
    ...
    // objc changed: remove java8 apis, reflection api
