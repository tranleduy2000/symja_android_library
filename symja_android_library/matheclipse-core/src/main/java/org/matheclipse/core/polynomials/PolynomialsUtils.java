...
public class PolynomialsUtils {
	...
	public static IAST createChebyshevPolynomial(final int degree, final IExpr x) {
		return buildPolynomial(degree, x, CHEBYSHEV_COEFFICIENTS, new RecurrenceCoefficientsGenerator() {
	...
	public interface RecurrenceCoefficientsGenerator {
		 ...
		 * @return an array of three coefficients such that P<sub>k+1</sub>(X) = (a[0] + a[1] X) P<sub>k</sub>(X) - a[2]
		 *         P<sub>k-1</sub>(X)
		 */
