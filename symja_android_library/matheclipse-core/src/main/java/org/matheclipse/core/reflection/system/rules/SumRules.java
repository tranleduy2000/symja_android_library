...
public interface SumRules {
  final public static IAST RULES1 = List(
      ...
      ISetDelayed(Sum(Times(a_DEFAULT,Power(b_,i_)),List(i_Symbol,C1,n_Symbol)),
      ...
      ISetDelayed(Sum(Times(Power(z_,i_),Power(i_,Negate(n_))),List(i_Symbol,C1,oo)),
      ...
      ISetDelayed(Sum(Times(Power(CN1,Negate(i_)),Power(Plus(Times(C2,i_),C1),CN1)),List(i_Symbol,C1,oo)),
