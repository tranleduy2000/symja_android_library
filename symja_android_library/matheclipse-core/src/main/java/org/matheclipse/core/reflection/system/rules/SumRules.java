...
public interface SumRules {
  ...
  public static final IAST RULES1 =
      ...
      ISetDelayed(Sum(Ceiling(Log(i_)), List(i_Symbol, C1, n_Symbol)),
          Condition(Plus(Times(Plus(Times(Floor(Log(n)), Exp(Plus(Floor(Log(n)), C1))),
      ...
      ISetDelayed(Sum(Ceiling(Times(Power(Log(a_), CN1), Log(i_))), List(i_Symbol, C1, n_Symbol)),
          Condition(Plus(Times(Plus(Times(Floor(Log(a, n)), Power(a, Plus(Floor(Log(a, n)), C1))),
      ...
      ISetDelayed(Sum(Times(Power(Factorial(Plus(Times(C2, i_), C1)), CN1),
      ...
      ISetDelayed(Sum(Times(Power(CN1, i_), Power(Factorial(Plus(Times(C2, i_), C1)), CN1),
          Power(x_, Plus(Times(C2, i_), C1))), List(i_Symbol, C0, oo)),
          Condition(Sin(x), FreeQ(x, i))),
      // Sum(x_^(2*i_)/(2*i_)!,{i_Symbol,0,Infinity}):=Cosh(x)/;FreeQ(x,i)
      ISetDelayed(Sum(Times(Power(Factorial(Times(C2, i_)), CN1), Power(x_, Times(C2, i_))),
          List(i_Symbol, C0, oo)),
      ...
      ISetDelayed(Sum(Times(Power(CN1, i_), Power(Plus(Times(C2, i_), C1), CN1),
          Power(x_, Plus(Times(C2, i_), C1))), List(i_Symbol, C0, oo)),
      ...
      ISetDelayed(Sum(Times(Power(i_, CN1), Power(Binomial(Times(C2, i_), i_), CN1)),
          List(i_Symbol, C1, oo)),
          Times(QQ(1L, 9L), CSqrt3, Pi)),
      // Sum(1/(i_^2*Binomial(2*i_,i_)),{i_Symbol,1,Infinity}):=Zeta(2)/3
      ISetDelayed(Sum(Times(Power(i_, CN2), Power(Binomial(Times(C2, i_), i_), CN1)),
          List(i_Symbol, C1, oo)),
          Times(C1D3, Zeta(C2))),
      // Sum(1/((-1)^(1-i_)*i_),{i_Symbol,1,Infinity}):=Log(2)
          ISetDelayed(
              Sum(Times(Power(CN1, Plus(CN1, i_)), Power(i_, CN1)), List(i_Symbol, C1, oo)),
              Log(C2)));
  public static final IAST RULES2 =
      ...
      ISetDelayed(Sum(Power(c_, i_), List(i_Symbol, C0, n_Symbol)),
          Condition(Times(Power(Plus(CN1, c), CN1), Plus(CN1, Power(c, Plus(C1, n)))),
              FreeQ(List(c, n), i))),
      ...
      ISetDelayed(Sum(Times(i_, Power(c_, i_)), List(i_Symbol, C0, n_Symbol)),
          Condition(Times(Power(Subtract(C1, c), CN2),
      ...
      ISetDelayed(Sum(Factorial(i_), List(i_Symbol, C0, n_Symbol)),
          Condition(Plus(Negate(Subfactorial(CN1)),
