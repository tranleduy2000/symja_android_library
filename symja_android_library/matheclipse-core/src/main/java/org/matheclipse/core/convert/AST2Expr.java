...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"ConjugateTranspose", "ConstantArray", "Context", "Continue", "ContinuedFraction", "Convergents",
			...
			"Fibonacci", "FindFit", "FindInstance", "FindRoot", "First", "Fit", "FiveNum", "FixedPoint",
			"FixedPointList", "Floor", "Fold", "FoldList", "For", "ForAll", "FourierMatrix", "FRatioDistribution",
			...
			"HypergeometricDistribution", "HypergeometricPFQ", "Hypergeometric0F1", "Hypergeometric1F1",
			...
			"InterpolatingPolynomial", "Intersection", "Inverse", "InverseBetaRegularized", "InverseCDF", "InverseErf",
