...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"MapThread", "MatchingDissimilarity", "MatchQ", "MathMLForm", "MatrixForm", "MatrixMinimalPolynomial",
			"MatrixPower", "MatrixQ", "MatrixRank", "Max", "Mean", "MeanDeviation", "Median", "MeijerG", "MemberQ",
			...
			"PadRight", "ParametricPlot", "Part", "Partition", "PartitionsP", "PartitionsQ", "ParzenWindow",
