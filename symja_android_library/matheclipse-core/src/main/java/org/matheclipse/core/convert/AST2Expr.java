...
public class AST2Expr {
	...
	public final static String[] SYMBOL_STRINGS = { "All", "Algebraics", "Automatic", "Axes", "AxesOrigin", "AxesStyle",
			...
			"Infinity", "Integer", "Integers", "Khinchin", "Listable", "LongForm", "MaxIterations", "MaxPoints",
			"Method", "Modulus", "NHoldAll", "NHoldFirst", "NHoldRest", "None", "Nonexistent", "NotApplicable",
			"NotAvailable", "Null", "NumericFunction", "OneIdentity", "Orderless", "Pi", "PrecisionGoal", "Primes",
			"Protected", "Rationals", "ReadProtected", "Real", "Reals", "Second", "Slot", "SlotSequence", "String",
			"Symbol", "TooLarge", "Trig", "True", "Variable", "White", "Unknown" };
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"BesselY", "Beta", "BetaRegularized", "BinarySerialize", "BinaryDeserialize", "BinCounts", "Binomial",
			"BinomialDistribution", "BitLength", "Blank", "BlankSequence", "BlankNullSequence", "Block", "Boole",
			...
			"Catch", "Catenate", "CDF", "Ceiling", "CentralMoment", "CForm", "CharacteristicPolynomial", "ChebyshevT",
			...
			"CoefficientRules", "Colon", "Collect", "Commonest", "CompatibleUnitQ", "Complement", "Compile", "Complex",
			"ComplexExpand", "ComposeList", "ComposeSeries", "Composition", "CompoundExpression", "Condition",
			"ConditionalExpression", "Conjugate", "ConjugateTranspose", "ConstantArray", "Context", "Continue",
			...
			"DiscreteDelta", "DiscreteUniformDistribution", "DirectedInfinity", "Direction", "Discriminant",
			"Distribute", "Distributed", "Div", "Divide", "DivideBy", "Divisible", "Divisors", "DivisorSigma", "Do",
			"Dot", "Drop", "DSolve", "EasterSunday", "EffectiveInterest", "Eigenvalues", "Eigenvectors", "Element",
			...
			"ExportString", "ExpToTrig", "ExtendedGCD", "Extract", "Factor", "Factorial", "Factorial2", "FactorInteger",
			...
			"FoldList", "For", "ForAll", "FourierMatrix", "FRatioDistribution", "FractionalPart", "FrechetDistribution",
			...
			"FunctionExpand", "Gamma", "GammaDistribution", "GammaRegularized", "Gather", "GCD", "GegenbauerC",
			"GeometricDistribution", "GeometricMean", "Get", "Grad", "Graphics", "Graphics3D", "Greater",
			...
			"Hypergeometric0F1", "Hypergeometric1F1", "Hypergeometric2F1", "HypergeometricPFQRegularized", "Identity",
			"IdentityMatrix", "If", "Im", "Implies", "Import", "Increment", "Inequality", "InexactNumberQ", "Inner",
			"InputForm", "Insert", "Information", "Interval", "IntegerDigits", "IntegerExponent", "IntegerLength",
			...
			"ListCorrelate", "ListQ", "Literal", "Log", "Log2", "Log10", "LogGamma", "LogNormalDistribution",
			...
			"MapAt", "MapAll", "MapIndexed", "MapThread", "MatchingDissimilarity", "MatchQ", "MathMLForm", "MatrixForm",
			"MatrixMinimalPolynomial", "MatrixPower", "MatrixQ", "MatrixRank", "Max", "Mean", "MeanDeviation", "Median",
			"MeijerG", "MemberQ", "MeshRange", "MessageName", "Message", "Messages", "MersennePrimeExponent",
			...
			"OddQ", "Operate", "OptimizeExpression", "Optional", "Options", "Or", "Order", "Ordering", "OrderedQ",
			...
			"Prime", "PrimeOmega", "PrimePi", "PrimePowerQ", "PrimeQ", "PrimitiveRoot", "PrimitiveRootList", "Print",
			"Probability", "Product", "ProductLog", "Projection", "PseudoInverse", "Put", "QRDecomposition", "Quantile",
			"Quantity", "QuantityDistribution", "QuantityMagnitude", "QuantityQ", "Quiet", "Quit", "Quotient",
			"QuotientRemainder", "RandomChoice", "RandomInteger", "RandomReal", "RandomSample", "RandomVariate",
			"Range", "Rational", "Rationalize", "Re", "RealNumberQ", "Reap", "Rectangle", "Reduce", "Refine",
			...
			"Unevaluated", "Unprotect", "UniformDistribution", "Union", "Unique", "UnitaryMatrixQ", "UnitConvert",
			"Unitize", "UnitStep", "UnitVector", "UnsameQ", "Unset", "UpperCaseQ", "UpperTriangularize", "UpSet",
