...
public class AST2Expr {
	...
	public final static String[] DOLLAR_STRINGS = { "$Aborted", "$Assumptions", "$Context", "$CreationDate",
			"$ContextPath", "$DisplayFunction", "$HistoryLength", "$IterationLimit", "$Line", "$MachineEpsilon",
			"$MachinePrecision", "$MaxMachineNumber", "$MessageList", "$MinMachineNumber", "$PrePrint",
			"$RecursionLimit", "$Version" };
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"Conjugate", "ConjugateTranspose", "ConstantArray", "ContainsAll", "ContainsAny", "ContainsNone",
			"ContainsExactly", "ContainsOnly", "Context", "Continue", "ContinuedFraction", "Convergents",
			...
			"DiscreteUniformDistribution", "DirectedInfinity", "Direction", "DirichletWindow", "Discriminant",
			"DisjointQ", "Distribute", "Distributed", "Div", "Divide", "DivideBy", "Divisible", "Divisors",
			...
			"StringLength", "StringTake", "StringQ", "StringReplace", "StruveH", "StruveL", "StudentTDistribution",
			...
			"Times", "TimesBy", "TimeValue", "Timing", "ToCharacterCode", "ToExpression", "ToeplitzMatrix", "Together",
