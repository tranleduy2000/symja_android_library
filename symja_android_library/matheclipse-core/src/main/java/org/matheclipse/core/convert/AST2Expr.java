...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"Direction", "DirichletWindow", "Discriminant", "Distribute", "Distributed", "Div", "Divide", "DivideBy",
			"Divisible", "Divisors", "DivisorSigma", "Do", "Dot", "Drop", "DSolve", "EasterSunday", "EffectiveInterest",
			...
			"Intersection", "Inverse", "InverseBetaRegularized", "InverseCDF", "InverseErf", "InverseErfc",
			...
			"TeXForm", "Thread", "Through", "Throw", "TimeConstrained", "Times", "TimesBy", "TimeValue", "Timing",
			...
			"TrigToExp", "TrueQ", "TukeyWindow", "Tuples", "Undefined", "Underoverscript", "Unequal", "Unevaluated",
