...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"ConjugateTranspose", "ConstantArray", "Continue", "ContinuedFraction", "ConvexHullMesh", "CoprimeQ",
			...
			"Diagonal", "DiagonalMatrix", "DiceDissimilarity", "DigitQ", "Dimensions", "DiracDelta", "DiscreteDelta",
			...
			"FresnelS", "FrobeniusSolve", "FromCharacterCode", "FromContinuedFraction", "FromPolarCoordinates",
			...
			"Information", "Interval", "IntegerExponent", "IntegerLength", "IntegerPart", "IntegerPartitions",
			"IntegerQ", "Integrate", "Interpolation", "InterpolatingFunction", "InterpolatingPolynomial",
			"Intersection", "Inverse", "InverseErf", "InverseErfc", "InverseFunction", "InverseGammaRegularized",
			...
			"ManhattanDistance", "MangoldtLambda", "MantissaExponent", "Map", "MapAt", "MapAll", "MapThread",
			...
			"NumberFieldRootsOfUnity", "NumberQ", "Numerator", "NumericQ", "OddQ", "Operate", "Optional", "Options",
			"Or", "Order", "Ordering", "OrderedQ", "Orthogonalize", "OrthogonalMatrixQ", "Out", "Outer", "Package",
			"PadLeft", "PadRight", "ParametricPlot", "Part", "Partition", "PartitionsP", "PartitionsQ", "PerfectNumber",
			...
			"StandardDeviation", "Standardize", "StieltjesGamma", "StirlingS1", "StirlingS2", "StringDrop",
			"StringJoin", "StringLength", "StringTake", "StruveH", "StruveL", "StudentTDistribution", "Subfactorial",
			"Subscript", "Subsuperscript", "Subsets", "Subtract", "SubtractFrom", "Sum", "Superscript",
			"SurfaceGraphics", "Switch", "SyntaxLength", "SymbolName", "SymbolQ", "SymmetricMatrixQ", "SyntaxQ",
			"Table", "Take", "Tally", "Tan", "Tanh", "TautologyQ", "Taylor", "TensorDimensions", "TensorProduct",
			...
			"Undefined", "Unequal", "Unevaluated", "Union", "Unique", "UnitaryMatrixQ", "Unitize", "UnitStep",
