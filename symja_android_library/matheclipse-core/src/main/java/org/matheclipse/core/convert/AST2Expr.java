...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"RootOf", "Roots", "RotateLeft", "RotateRight", "RotationMatrix", "Round", "RowReduce", "Rule",
			...
			"StirlingS1", "StirlingS2", "StringDrop", "StringJoin", "StringLength", "StringTake", "StringQ",
			"StringReplace", "StruveH", "StruveL", "StudentTDistribution", "Subdivide", "Subfactorial", "Subscript",
			"Subsuperscript", "Subsets", "Subtract", "SubtractFrom", "Sum", "Superscript", "SurfaceGraphics",
