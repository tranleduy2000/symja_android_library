...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"DivisorSigma", "Do", "Dot", "Drop", "DSolve", "EasterSunday", "EffectiveInterest", "Eigenvalues",
			...
			"GammaDistribution", "GammaRegularized", "Gather", "GaussianWindow", "GCD", "GegenbauerC",
			...
			"Inequality", "InexactNumberQ", "Inner", "InputForm", "Insert", "Information", "Interval", "IntegerDigits",
			...
			"InverseBetaRegularized", "InverseErf", "InverseErfc", "InverseFunction", "InverseGammaRegularized",
			"InverseHaversine", "InverseLaplaceTransform", "InverseSeries", "JaccardDissimilarity", "JacobiMatrix",
			"JacobiSymbol", "JacobiZeta", "JavaForm", "Join", "KnownUnitQ", "KolmogorovSmirnovTest",
			...
			"LinearSolve", "LiouvilleLambda", "List", "ListConvolve", "ListCorrelate", "ListQ", "Literal", "Log",
			"Log2", "Log10", "LogGamma", "LogNormalDistribution", "LogicalExpand", "LogisticSigmoid", "LogIntegral",
			"LowerCaseQ", "LowerTriangularize", "LucasL", "LUDecomposition", "MachineNumberQ", "ManhattanDistance",
			"MangoldtLambda", "MantissaExponent", "Map", "MapAt", "MapAll", "MapIndexed", "MapThread",
			"MatchingDissimilarity", "MatchQ", "MathMLForm", "MatrixForm", "MatrixMinimalPolynomial", "MatrixPower",
			"MatrixQ", "MatrixRank", "Max", "Mean", "MeanDeviation", "Median", "MeijerG", "MemberQ", "MeshRange",
			"MessageName", "Message", "Messages", "MersennePrimeExponent", "MersennePrimeExponentQ", "Min",
			...
			"PadRight", "ParametricPlot", "Part", "Partition", "PartitionsP", "PartitionsQ", "ParzenWindow", "PerfectNumber",
			...
			"Transpose", "TrigExpand", "TrigReduce", "TrigToExp", "TrueQ", "TukeyWindow", "Tuples", "Undefined", "Unequal",
