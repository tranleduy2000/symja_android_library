...
public class AST2Expr {
	...
	public final static String[] SYMBOL_STRINGS = { "All", "Algebraics", "Automatic", "Axes", "AxesOrigin", "AxesStyle",
			...
			"EliminationOrder", "EulerGamma", "Extension", "False", "Flat", "GaussianIntegers", "General", "Glaisher",
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"ConstantArray", "ContainsAll", "ContainsAny", "ContainsNone", "ContainsExactly", "ContainsOnly", "Context",
			"Continue", "ContinuedFraction", "Convergents", "ConvexHullMesh", "CoprimeQ", "Correlation", "Cos", "Cosh",
			"CosineDistance", "CosIntegral", "CoshIntegral", "Cot", "Coth", "Count", "Covariance", "CreateDirectory",
			"Cross", "Csc", "Csch", "CubeRoot", "Curl", "Cyclotomic", "Decrement", "Default", "Defer", "Definition",
			"Delete", "DeleteCases", "DeleteDuplicates", "Denominator", "Depth", "Derivative", "DesignMatrix", "Det",
			"Diagonal", "DiagonalMatrix", "DiceDissimilarity", "Differences", "DigitQ", "Dimensions", "DiracDelta",
			"DiscreteDelta", "DiscreteUniformDistribution", "DirectedInfinity", "Direction", "DirichletWindow",
			"Discriminant", "DisjointQ", "Distribute", "Distributed", "Div", "Divide", "DivideBy", "Divisible",
			"Divisors", "DivisorSigma", "Do", "Dot", "Drop", "DSolve", "EasterSunday", "EffectiveInterest",
			...
			"Exponent", "Export", "ExportString", "ExpToTrig", "ExtendedGCD", "Extract", "Factor", "Factorial",
			"Factorial2", "FactorInteger", "FactorSquareFree", "FactorSquareFreeList", "FactorTerms", "Flatten",
			"FlattenAt", "FlatTopWindow", "Fibonacci", "FindFit", "FindInstance", "FindRoot", "First", "Fit", "FiveNum",
			...
			"GegenbauerC", "GeometricDistribution", "GeometricMean", "Get", "Grad", "Graphics", "Graphics3D", "Greater",
			"GreaterEqual", "GroebnerBasis", "GumbelDistribution", "HammingWindow", "HannWindow", "Haversine",
			"HarmonicMean", "HarmonicNumber", "Head", "HeavisideTheta", "HermiteH", "HermitianMatrixQ", "HilbertMatrix",
			...
			"JaccardDissimilarity", "JacobiMatrix", "JacobiSymbol", "JacobiZeta", "JavaForm", "Join", "KnownUnitQ",
			...
			"ListLinePlot", "ListPlot", "ListQ", "Literal", "Log", "Log2", "Log10", "LogGamma", "LogNormalDistribution",
			"LogicalExpand", "LogisticSigmoid", "LogIntegral", "LowerCaseQ", "LowerTriangularize", "LucasL",
			"LUDecomposition", "MachineNumberQ", "ManhattanDistance", "MangoldtLambda", "MantissaExponent", "Map",
			"MapAt", "MapAll", "MapIndexed", "MapThread", "MatchingDissimilarity", "MatchQ", "MathMLForm", "MatrixExp",
			...
			"PreDecrement", "Prefix", "PreIncrement", "PrePlus", "Prepend", "PrependTo", "Prime", "PrimeOmega",
			"PrimePi", "PrimePowerQ", "PrimeQ", "PrimitiveRoot", "PrimitiveRootList", "Print", "Probability", "Product",
			...
			"SinhIntegral", "Skewness", "SokalSneathDissimilarity", "Solve", "Sort", "SortBy", "Sow", "Span", "Split",
			"SplitBy", "Sqrt", "SquaredEuclideanDistance", "SquareFreeQ", "SquareMatrixQ", "StandardDeviation",
			"StandardForm", "Standardize", "StieltjesGamma", "StirlingS1", "StirlingS2", "StringDrop", "StringJoin",
			...
			"TagSet", "TagSetDelayed", "Take", "Tally", "Tan", "Tanh", "TautologyQ", "Taylor", "TensorDimensions",
			...
			"Tuples", "Undefined", "Underoverscript", "Unequal", "Unevaluated", "Unprotect", "UniformDistribution",
