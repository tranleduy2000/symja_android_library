...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo",
			...
			"CentralMoment", "CForm", "CharacteristicPolynomial", "ChebyshevT", "ChebyshevU", "Check",
			"ChessboardDistance", "ChineseRemainder", "ChiSquareDistribution", "CholeskyDecomposition", "Chop",
			"CirclePoints", "Clear", "ClearAll", "ClearAttributes", "Clip", "Coefficient", "CoefficientList",
			"CoefficientRules", "Colon", "Column", "Collect", "Commonest", "CompatibleUnitQ", "Complement", "Compile",
			...
			"Default", "DefaultButton", "Defer", "Definition", "Delete", "DeleteCases", "DeleteDuplicates",
			...
			"TrigToExp", "TrueQ", "TukeyWindow", "Tuples", "TwoWayRule", "Undefined", "Underoverscript",
