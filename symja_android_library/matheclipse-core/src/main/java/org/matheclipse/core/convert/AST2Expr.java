...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"ArcSinh", "ArcTan", "ArcTanh", "Arg", "Array", "ArrayDepth", "ArrayPad", "ArrayReshape", "Arrays",
			"ArrayQ", "Assumptions", "AtomQ", "Attributes", "Begin", "BeginPackage", "BellB", "BellY", "BernoulliB",
			"BernoulliDistribution", "BesselI", "BesselJ", "BesselK", "BesselY", "Beta", "BetaRegularized", "BinCounts",
			"Binomial", "BinomialDistribution", "BitLength", "Blank", "Block", "Boole", "BooleanQ", "BooleanConvert",
			...
			"Ceiling", "CentralMoment", "CForm", "CharacteristicPolynomial", "ChebyshevT", "ChebyshevU",
			...
			"Cot", "Coth", "Count", "Covariance", "Cross", "Csc", "Csch", "CubeRoot", "Curl", "Cyclotomic", "Decrement",
			...
			"Direction", "Discriminant", "Distribute", "Distributed", "Div", "Divide", "DivideBy", "Divisible",
			...
			"EulerE", "EulerPhi", "Evaluate", "EvenQ", "ExactNumberQ", "Except", "Exists", "Exp", "Expand", "ExpandAll",
