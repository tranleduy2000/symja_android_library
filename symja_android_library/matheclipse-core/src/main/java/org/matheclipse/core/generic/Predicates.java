...
public class Predicates {
	...
	public static class IsBinaryFalse implements BiPredicate<IExpr, IExpr>, Comparator<IExpr> {
		...
		/**
		 * Check if the evaluation of a binary AST object gives <code>True</code> by settings it's first argument to
	 ...
	 * of the given <code>ast</code>. It does not defensively copy the collection passed in, so future changes to it
	 * will alter the behavior of the predicate.
	 * 
	 * @param ast
	...
	/**
	 * Returns a predicate that evaluates to {@code true} if the <code>input</code> is an AST list, which equals one of
	...
	/**
	 * Check if the evaluation of the <code>expr</code> object gives <code>False</code>. A <code>IsBinaryFalse</code>
	...
	/**
	 * Check if the evaluation of the <code>expr</code> object gives <code>True</code>. A <code>IsBinaryTrue</code>
	 * predicate will be returned.
	 * 
	 * @param expr
	 * @return a <code>com.duy.lambda.BiPredicate</code> predicate of two arguments.
