...
ISetDelayed(4131,GtQ(u_,v_,w_),
    And(GtQ(u,v),GtQ(v,w))),
ISetDelayed(4132,LtQ(u_,v_),
...
ISetDelayed(4133,LtQ(u_,v_,w_),
    And(LtQ(u,v),LtQ(v,w))),
ISetDelayed(4134,GeQ(u_,v_),
...
ISetDelayed(4135,GeQ(u_,v_,w_),
    And(GeQ(u,v),GeQ(v,w))),
ISetDelayed(4136,LeQ(u_,v_),
...
ISetDelayed(4137,LeQ(u_,v_,w_),
    And(LeQ(u,v),LeQ(v,w))),
ISetDelayed(4138,PolyQ(u_,x_Symbol,n_),
...
ISetDelayed(4139,PolyQ(u_,Power(x_Symbol,v_),n_),
    And(PolyQ(u,Power(x,v)),EqQ(Expon(u,Power(x,v)),n),NeQ(Coeff(u,Power(x,v),n),C0))),
ISetDelayed(4140,PolyQ(u_,x_Symbol),
    Or(PolynomialQ(u,x),PolynomialQ(Together(u),x))),
ISetDelayed(4141,PolyQ(u_,Power(x_Symbol,$p(n, Integer))),
...
ISetDelayed(4142,PolyQ(u_,Power(x_Symbol,v_)),
...
ISetDelayed(4147,TrinomialQ(u_,x_Symbol),
...
ISetDelayed(4148,GeneralizedBinomialQ(u_,x_Symbol),
...
ISetDelayed(4149,GeneralizedTrinomialQ(u_,x_Symbol),
...
ISetDelayed(4150,PosQ(u_),
    PosAux(TogetherSimplify(u))),
ISetDelayed(4151,PosAux(u_),
...
ISetDelayed(4152,NegQ(u_),
    And(Not(PosQ(u)),NeQ(u,C0))),
ISetDelayed(4153,NiceSqrtQ(u_),
    And(Not(LtQ(u,C0)),NiceSqrtAuxQ(u))),
ISetDelayed(4154,NiceSqrtAuxQ(u_),
...
ISetDelayed(4155,PerfectSquareQ(u_),
...
ISetDelayed(4156,SimplerQ(u_,v_),
...
ISetDelayed(4157,SimplerSqrtQ(u_,v_),
...
ISetDelayed(4162,SimplerIntegrandQ(u_,v_,x_Symbol),
...
ISetDelayed(4163,CancelCommonFactors(u_,v_),
...
ISetDelayed(4164,BinomialDegree(u_,x_Symbol),
    Part(BinomialParts(u,x),C3)),
ISetDelayed(4165,BinomialParts(u_,x_Symbol),
...
ISetDelayed(4166,TrinomialDegree(u_,x_Symbol),
    Part(TrinomialParts(u,x),C4)),
ISetDelayed(4167,TrinomialParts(u_,x_Symbol),
...
ISetDelayed(4168,GeneralizedBinomialDegree(u_,x_Symbol),
    $(Function(Plus(Part(Slot1,C3),Negate(Part(Slot1,C4)))),GeneralizedBinomialParts(u,x))),
ISetDelayed(4169,GeneralizedBinomialParts(Plus(Times(b_DEFAULT,Power(x_,n_DEFAULT)),Times(a_DEFAULT,Power(x_,q_DEFAULT))),x_Symbol),
    Condition(List(a,b,n,q),And(FreeQ(List(a,b,n,q),x),PosQ(Plus(n,Negate(q)))))),
ISetDelayed(4170,GeneralizedBinomialParts(Times(a_,u_),x_Symbol),
...
ISetDelayed(4171,GeneralizedBinomialParts(Times(u_,Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(4172,GeneralizedBinomialParts(Times(u_,Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(4173,GeneralizedBinomialParts(u_,x_Symbol),
    False),
ISetDelayed(4174,GeneralizedTrinomialDegree(u_,x_Symbol),
    $(Function(Plus(Part(Slot1,C4),Negate(Part(Slot1,C5)))),GeneralizedTrinomialParts(u,x))),
ISetDelayed(4175,GeneralizedTrinomialParts(Plus(Times(b_DEFAULT,Power(x_,n_DEFAULT)),Times(a_DEFAULT,Power(x_,q_DEFAULT)),Times(c_DEFAULT,Power(x_,r_DEFAULT))),x_Symbol),
    Condition(List(a,b,c,n,q),And(FreeQ(List(a,b,c,n,q),x),EqQ(r,Plus(Times(C2,n),Negate(q)))))),
ISetDelayed(4176,GeneralizedTrinomialParts(Times(a_,u_),x_Symbol),
...
ISetDelayed(4177,GeneralizedTrinomialParts(u_,x_Symbol),
...
ISetDelayed(4178,GeneralizedTrinomialParts(Times(u_,Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(4179,GeneralizedTrinomialParts(Times(u_,Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(4180,GeneralizedTrinomialParts(u_,x_Symbol),
    False),
ISetDelayed(4181,IntPart(Times(m_,u_),$p(n, null,C1)),
    Condition(IntPart(u,Times(m,n)),RationalQ(m))),
ISetDelayed(4182,IntPart(u_,$p(n, null,C1)),
    If(RationalQ(u),IntegerPart(Times(n,u)),If(SumQ(u),Map(Function(IntPart(Slot1,n)),u),C0))),
ISetDelayed(4183,FracPart(Times(m_,u_),$p(n, null,C1)),
    Condition(FracPart(u,Times(m,n)),RationalQ(m))),
ISetDelayed(4184,FracPart(u_,$p(n, null,C1)),
    If(RationalQ(u),FractionalPart(Times(n,u)),If(SumQ(u),Map(Function(FracPart(Slot1,n)),u),Times(n,u)))),
ISetDelayed(4185,NumericFactor(u_),
...
ISetDelayed(4186,NonnumericFactors(u_),
...
ISetDelayed(4187,RemoveContent(u_,x_Symbol),
...
ISetDelayed(4188,RemoveContentAux(Plus(Times(Power(a_,m_),u_DEFAULT),Times(b_,v_DEFAULT)),x_Symbol),
...
ISetDelayed(4189,RemoveContentAux(Plus(Times(Power(a_,m_DEFAULT),u_DEFAULT),Times(Power(a_,n_DEFAULT),v_DEFAULT)),x_Symbol),
...
ISetDelayed(4190,RemoveContentAux(Plus(Times(Power(a_,m_DEFAULT),u_DEFAULT),Times(Power(a_,n_DEFAULT),v_DEFAULT),Times(Power(a_,p_DEFAULT),w_DEFAULT)),x_Symbol),
...
ISetDelayed(4200,LeadTerm(u_),
    If(SumQ(u),First(u),u)),
ISetDelayed(4201,RemainingTerms(u_),
    If(SumQ(u),Rest(u),C0)),
ISetDelayed(4202,LeadFactor(u_),
    If(ProductQ(u),LeadFactor(First(u)),If(And(ComplexNumberQ(u),SameQ(Re(u),C0)),If(SameQ(Im(u),C1),u,LeadFactor(Im(u))),u))),
ISetDelayed(4203,RemainingFactors(u_),
...
ISetDelayed(4204,LeadBase(u_),
    With(List(Set(v,LeadFactor(u))),If(PowerQ(v),Part(v,C1),v))),
ISetDelayed(4205,LeadDegree(u_),
    With(List(Set(v,LeadFactor(u))),If(PowerQ(v),Part(v,C2),C1))),
ISetDelayed(4206,$($s("§numer"),Power($p(m, Integer),$p(n,$s("Rational")))),
    Condition(C1,Less(n,C0))),
ISetDelayed(4207,$($s("§numer"),Times(u_,v_)),
    Times($($s("§numer"),u),$($s("§numer"),v))),
ISetDelayed(4208,$($s("§numer"),u_),
    Numerator(u)),
ISetDelayed(4209,$($s("§denom"),Power($p(m, Integer),$p(n,$s("Rational")))),
    Condition(Power(m,Negate(n)),Less(n,C0))),
ISetDelayed(4210,$($s("§denom"),Times(u_,v_)),
    Times($($s("§denom"),u),$($s("§denom"),v))),
ISetDelayed(4211,$($s("§denom"),u_),
    Denominator(u)),
ISetDelayed(4212,LinearQ(u_,x_Symbol),
    If(ListQ(u),Catch(CompoundExpression(Scan(Function(If(PolyQ(Slot1,x,C1),Null,Throw(False))),u),True)),PolyQ(u,x,C1))),
ISetDelayed(4213,QuadraticProductQ(u_,x_Symbol),
...
ISetDelayed(4214,PowerOfLinearQ(Power(u_,m_DEFAULT),x_Symbol),
...
ISetDelayed(4215,QuadraticQ(u_,x_Symbol),
...
ISetDelayed(4216,LinearPairQ(u_,v_,x_Symbol),
...
ISetDelayed(4217,MonomialQ(u_,x_Symbol),
