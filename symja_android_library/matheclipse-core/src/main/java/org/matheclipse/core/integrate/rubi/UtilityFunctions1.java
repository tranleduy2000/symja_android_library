...
ISetDelayed(4137,LeQ(u_,v_,w_),
    And(LeQ(u,v),LeQ(v,w))),
ISetDelayed(4138,RealNumberQ(u_),
    And(NumberQ(u),UnsameQ(Head(u),$s("Complex")))),
ISetDelayed(4139,PolyQ(u_,x_Symbol,n_),
...
ISetDelayed(4140,PolyQ(u_,Power(x_Symbol,v_),n_),
    And(PolyQ(u,Power(x,v)),EqQ(Expon(u,Power(x,v)),n),NeQ(Coeff(u,Power(x,v),n),C0))),
ISetDelayed(4141,PolyQ(u_,x_Symbol),
    Or(PolynomialQ(u,x),PolynomialQ(Together(u),x))),
ISetDelayed(4142,PolyQ(u_,Power(x_Symbol,$p(n, Integer))),
...
ISetDelayed(4143,PolyQ(u_,Power(x_Symbol,v_)),
...
ISetDelayed(4148,TrinomialQ(u_,x_Symbol),
...
ISetDelayed(4149,GeneralizedBinomialQ(u_,x_Symbol),
...
ISetDelayed(4150,GeneralizedTrinomialQ(u_,x_Symbol),
...
ISetDelayed(4151,PosQ(u_),
    PosAux(TogetherSimplify(u))),
ISetDelayed(4152,PosAux(u_),
...
ISetDelayed(4153,NegQ(u_),
    And(Not(PosQ(u)),NeQ(u,C0))),
ISetDelayed(4154,NiceSqrtQ(u_),
    And(Not(LtQ(u,C0)),NiceSqrtAuxQ(u))),
ISetDelayed(4155,NiceSqrtAuxQ(u_),
...
ISetDelayed(4156,PerfectSquareQ(u_),
...
ISetDelayed(4157,SimplerQ(u_,v_),
...
ISetDelayed(4158,SimplerSqrtQ(u_,v_),
...
ISetDelayed(4159,SumSimplerQ(u_,v_),
...
ISetDelayed(4162,SumSimplerAuxQ(u_,v_),
...
ISetDelayed(4163,SimplerIntegrandQ(u_,v_,x_Symbol),
...
ISetDelayed(4164,CancelCommonFactors(u_,v_),
...
ISetDelayed(4165,BinomialDegree(u_,x_Symbol),
    Part(BinomialParts(u,x),C3)),
ISetDelayed(4166,BinomialParts(u_,x_Symbol),
...
ISetDelayed(4167,TrinomialDegree(u_,x_Symbol),
    Part(TrinomialParts(u,x),C4)),
ISetDelayed(4168,TrinomialParts(u_,x_Symbol),
...
ISetDelayed(4169,GeneralizedBinomialDegree(u_,x_Symbol),
    $(Function(Plus(Part(Slot1,C3),Negate(Part(Slot1,C4)))),GeneralizedBinomialParts(u,x))),
ISetDelayed(4170,GeneralizedBinomialParts(Plus(Times(b_DEFAULT,Power(x_,n_DEFAULT)),Times(a_DEFAULT,Power(x_,q_DEFAULT))),x_Symbol),
    Condition(List(a,b,n,q),And(FreeQ(List(a,b,n,q),x),PosQ(Plus(n,Negate(q)))))),
ISetDelayed(4171,GeneralizedBinomialParts(Times(a_,u_),x_Symbol),
...
ISetDelayed(4173,GeneralizedBinomialParts(Times(u_,Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(4174,GeneralizedBinomialParts(u_,x_Symbol),
    False),
ISetDelayed(4175,GeneralizedTrinomialDegree(u_,x_Symbol),
    $(Function(Plus(Part(Slot1,C4),Negate(Part(Slot1,C5)))),GeneralizedTrinomialParts(u,x))),
ISetDelayed(4176,GeneralizedTrinomialParts(Plus(Times(b_DEFAULT,Power(x_,n_DEFAULT)),Times(a_DEFAULT,Power(x_,q_DEFAULT)),Times(c_DEFAULT,Power(x_,r_DEFAULT))),x_Symbol),
    Condition(List(a,b,c,n,q),And(FreeQ(List(a,b,c,n,q),x),EqQ(r,Plus(Times(C2,n),Negate(q)))))),
ISetDelayed(4177,GeneralizedTrinomialParts(Times(a_,u_),x_Symbol),
...
ISetDelayed(4178,GeneralizedTrinomialParts(u_,x_Symbol),
...
ISetDelayed(4180,GeneralizedTrinomialParts(Times(u_,Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(4181,GeneralizedTrinomialParts(u_,x_Symbol),
    False),
ISetDelayed(4182,IntPart(Times(m_,u_),$p(n, null,C1)),
    Condition(IntPart(u,Times(m,n)),RationalQ(m))),
ISetDelayed(4183,IntPart(u_,$p(n, null,C1)),
    If(RationalQ(u),IntegerPart(Times(n,u)),If(SumQ(u),Map(Function(IntPart(Slot1,n)),u),C0))),
ISetDelayed(4184,FracPart(Times(m_,u_),$p(n, null,C1)),
    Condition(FracPart(u,Times(m,n)),RationalQ(m))),
ISetDelayed(4185,FracPart(u_,$p(n, null,C1)),
    If(RationalQ(u),FractionalPart(Times(n,u)),If(SumQ(u),Map(Function(FracPart(Slot1,n)),u),Times(n,u)))),
ISetDelayed(4186,NumericFactor(u_),
...
ISetDelayed(4187,NonnumericFactors(u_),
...
ISetDelayed(4188,RemoveContent(u_,x_Symbol),
...
ISetDelayed(4189,RemoveContentAux(Plus(Times(Power(a_,m_),u_DEFAULT),Times(b_,v_DEFAULT)),x_Symbol),
...
ISetDelayed(4190,RemoveContentAux(Plus(Times(Power(a_,m_DEFAULT),u_DEFAULT),Times(Power(a_,n_DEFAULT),v_DEFAULT)),x_Symbol),
...
ISetDelayed(4191,RemoveContentAux(Plus(Times(Power(a_,m_DEFAULT),u_DEFAULT),Times(Power(a_,n_DEFAULT),v_DEFAULT),Times(Power(a_,p_DEFAULT),w_DEFAULT)),x_Symbol),
...
ISetDelayed(4201,LeadTerm(u_),
    If(SumQ(u),First(u),u)),
ISetDelayed(4202,RemainingTerms(u_),
    If(SumQ(u),Rest(u),C0)),
ISetDelayed(4203,LeadFactor(u_),
    If(ProductQ(u),LeadFactor(First(u)),If(And(ComplexNumberQ(u),SameQ(Re(u),C0)),If(SameQ(Im(u),C1),u,LeadFactor(Im(u))),u))),
ISetDelayed(4204,RemainingFactors(u_),
...
ISetDelayed(4205,LeadBase(u_),
    With(List(Set(v,LeadFactor(u))),If(PowerQ(v),Part(v,C1),v))),
ISetDelayed(4206,LeadDegree(u_),
    With(List(Set(v,LeadFactor(u))),If(PowerQ(v),Part(v,C2),C1))),
ISetDelayed(4207,$($s("§numer"),Power($p(m, Integer),$p(n,$s("Rational")))),
    Condition(C1,Less(n,C0))),
ISetDelayed(4208,$($s("§numer"),Times(u_,v_)),
    Times($($s("§numer"),u),$($s("§numer"),v))),
ISetDelayed(4209,$($s("§numer"),u_),
    Numerator(u)),
ISetDelayed(4210,$($s("§denom"),Power($p(m, Integer),$p(n,$s("Rational")))),
    Condition(Power(m,Negate(n)),Less(n,C0))),
ISetDelayed(4211,$($s("§denom"),Times(u_,v_)),
    Times($($s("§denom"),u),$($s("§denom"),v))),
ISetDelayed(4212,$($s("§denom"),u_),
    Denominator(u)),
ISetDelayed(4213,LinearQ(u_,x_Symbol),
    If(ListQ(u),Catch(CompoundExpression(Scan(Function(If(PolyQ(Slot1,x,C1),Null,Throw(False))),u),True)),PolyQ(u,x,C1))),
ISetDelayed(4214,QuadraticProductQ(u_,x_Symbol),
...
ISetDelayed(4215,PowerOfLinearQ(Power(u_,m_DEFAULT),x_Symbol),
...
ISetDelayed(4216,QuadraticQ(u_,x_Symbol),
