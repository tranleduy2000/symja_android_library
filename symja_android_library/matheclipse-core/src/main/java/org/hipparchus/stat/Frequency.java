...
public class Frequency<T extends Comparable<T>> implements Serializable {
    ...
    public void incrementValue(T v, long increment) {
        Long count = new MapWrapper<>(freqTable).getOrDefault(v, Long.valueOf(0));
    ...
    public long getSumFreq() {
        return new StreamWrapper<>(freqTable.values())
                        .stream()
    ...
    public long getCount(T v) {
        return new MapWrapper<>(freqTable).getOrDefault(v, 0L);
    }
    ...
    public long getCumFreq(T v) {
        ...
        return new StreamWrapper<>(headMap.values())
                      .stream()
                      .mapToLong(new ToLongFunction<Long>() {
                          @Override
                          public long applyAsLong(Long z) {
                              return z;
                          }
                      })
                      .sum();
    ...
    public List<T> getMode() {
        ...
        final long mostPopular =
                new StreamWrapper<>(freqTable.values())
                         .stream()
                         .mapToLong(new com.duy.lambda.ToLongFunction<Long>() {
                             @Override
                             public long applyAsLong(Long aLong) {
        ...
        return new StreamWrapper<>(freqTable.entrySet())
                        .stream()
    ...
    public boolean equals(Object obj) {
        ...
        return DObjects.equals(freqTable, other.freqTable);
    }
