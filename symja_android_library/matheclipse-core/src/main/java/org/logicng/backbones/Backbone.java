...
public final class Backbone {
    ...
    private Backbone(final boolean sat, final SortedSet<Variable> positiveBackbone, final SortedSet<Variable> negativeBackbone,
        ...
        this.sat = sat;
        this.positiveBackbone = positiveBackbone == null ? DCollections.<Variable>emptySortedSet() : positiveBackbone;
        this.negativeBackbone = negativeBackbone == null ? DCollections.<Variable>emptySortedSet() : negativeBackbone;
        this.optionalVariables = optionalVariables == null ? DCollections.<Variable>emptySortedSet() : optionalVariables;
    }
    ...
    public boolean equals(final Object other) {
        ...
        return DObjects.equals(this.positiveBackbone, backbone.positiveBackbone) &&
                DObjects.equals(this.negativeBackbone, backbone.negativeBackbone) &&
                DObjects.equals(this.optionalVariables, backbone.optionalVariables);
    }

    @Override
    public int hashCode() {
        return DObjects.hash(this.positiveBackbone, this.negativeBackbone, this.optionalVariables);
    }
