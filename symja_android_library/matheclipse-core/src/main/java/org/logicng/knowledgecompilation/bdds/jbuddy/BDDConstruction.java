...
public class BDDConstruction {
    ...
    public int not(final int r) {
        return this.k.doWithPotentialReordering(new BDDKernel.BddOperation() {
            @Override
            public int perform() throws BDDKernel.BddReorderRequest {
                return BDDConstruction.this.notRec(r);
            }
        });
    }
    ...
    public int restrict(final int r, final int var) {
        ...
        return this.k.doWithPotentialReordering(new BDDKernel.BddOperation() {
            @Override
            public int perform() throws BDDKernel.BddReorderRequest {
                return BDDConstruction.this.restrictRec(r, (var << 3) | CACHEID_RESTRICT);
            }
        });
    }
    ...
    public int exists(final int r, final int var) {
        ...
        return this.k.doWithPotentialReordering(new BDDKernel.BddOperation() {
            @Override
            public int perform() throws BDDKernel.BddReorderRequest {
                return BDDConstruction.this.quantRec(r, BDDKernel.Operand.OR, var << 3);
            }
        });
    }
    ...
    public int forAll(final int r, final int var) {
        ...
        return this.k.doWithPotentialReordering(new BDDKernel.BddOperation() {
            @Override
            public int perform() throws BDDKernel.BddReorderRequest {
                return BDDConstruction.this.quantRec(r, BDDKernel.Operand.AND, (var << 3) | CACHEID_FORALL);
            }
        });
    }
