...
public class FrenchSwitzerlandNumber extends SpokenNumber {
    ...
    private final static String NULL = "zéro";
    private final static String MINUS = "moins";
    private final static String CENT = " cent";
    private final static String CENTS = " cents";
    private final static String PLURAL = "s";

    public FrenchSwitzerlandNumber() {
        super();
    }

    public FrenchSwitzerlandNumber(long number) throws Exception {
        super(number);
    }

    public FrenchSwitzerlandNumber(String number) throws Exception {
        super(number);
    }
    ...
    public static String toString(long number) throws Exception {
        return (new FrenchSwitzerlandNumber(number)).toString();
    }
...
/*        for (int digit : digits) {
    ...
    private void triple(int index) {
        ...
        if (digits[index] == 0) {
            ...
            if (value > 0) {
                syllables.add(field[2][value - 1]);    // dix, vingt, trente, ...
            }
            // Zehner und Einer
        } else {
