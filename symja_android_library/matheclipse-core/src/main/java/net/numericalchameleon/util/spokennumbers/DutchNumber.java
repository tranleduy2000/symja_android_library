...
public class DutchNumber extends SpokenNumber {
    ...
    private final static String NULL = "nul";
    private final static String MINUS = "minus";
    private final static String EINS = "één";
    private final static String EINE = "één";
    private final static String EIN = "";
    private final static String UND = "en";
    private final static String HUNDERT = "honderd";
