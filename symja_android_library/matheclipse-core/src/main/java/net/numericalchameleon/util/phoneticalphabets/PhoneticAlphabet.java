...
public class PhoneticAlphabet {
    ...
    public final static String[]
            ...
            "Havanna", "Italia", "Jerusalem", "Kilogramme", "Liverpool", "Madagaskar", "New York",
            "Oslo", "Paris", "Québec", "Roma", "Santiago", "Tripoli", "Upsala", "Valencia", "Washington",
            "Xanthippe", "Yokohama", "Zürich"},
    ...
    AMERICAN = {
            "Abel", "Baker", "Charlie", "Dog", "Easy", "Fox", "George", "How", "Item", "Jig", "King", "Love",
    ...
    BRITISH = {
            ...
            "Jack", "King", "Lucy", "Mary", "Nellie", "Oliver", "Peter", "Queenie", "Robert", "Sugar",
            "Tommy", "Uncle", "Victor", "William", "Xmas", "Yellow", "Zebra"},

    // Langenscheidt
    GERMAN = {
            "Anton", "Ärger", "Berta", "Cäsar", "CHarlotte", "Dora", "Emil", "Friedrich", "Gustav",
            "Heinrich", "Ida", "Julius", "Kaufmann", "Ludwig", "Martha", "Nordpol", "Otto", "Ökonom",
            "Paula", "Quelle", "Richard", "Samuel", "SCHule", "Theodor", "Ulrich", "Übermut", "Viktor",
            "Wilhelm", "Xanthippe", "Ypsilon", "Zacharias"},

    // Berlitz phrase book
    FRENCH = {
            "Anatole", "Berthe", "Célestin", "Désiré", "Eugène", "Émile", "François", "Gaston",
            "Henri", "Irma", "Joseph", "Kléber", "Louis", "Marcel", "Nicolas", "Oscar", "Pierre",
            "Quintal", "Raoul", "Suzanne", "Thérèse", "Ursule", "Victor", "William", "Xavier",
            "Yvonne", "Zoé"},

    SPANISH = {
            "Antonio", "Barcelona", "Carmen", "CHocolate", "Dolores", "Enrique", "Francia",
            "Gerona", "Historia", "Inés", "José", "Kilo", "Lorenzo", "LLobregat", "Madrid",
            "Navarra", "Ñoño", "Oviedo", "París", "Querido", "Ramón", "Sábado", "Tarragona",
            "Ulises", "Valencia", "Washington", "Xiquena", "Yegua", "Zaragoza"},

    ITALIAN = {
            "Ancona", "Bologna", "Como", "Domodossola", "Empoli", "Forli", "Genova", "Hotel",
            "Imola", "Jolanda", "Kappa", "Livorno", "Milano", "Napoli", "Otranto", "Pisa",
            "Quattro", "Roma", "Salerno", "Torino", "Udine", "Venezia", "Washington",
            "Xilofono", "Ypsilon", "Zeta"
    },
    ...
    DUTCH = {
            ...
            "Jan", "Karel", "Lodewijk", "Marie", "Nico", "Otto", "Pieter", "Quadraat", "Rudolf", "Simon",
            "Teunis", "Utrecht", "Victor", "Willem", "Xantippe", "IJmuiden", "Ypsilon", "Zaandam"
    },
    ...
    HEBREW =
            {"Affula", "Binyamina", "Carmel", "Dalia", "Eretz", "France", "Gedera", "Haifa", "Israel",
                    "Jaffa", "Karkur", "Lod", "Moledet", "Naan", "Ogen", "Pardes", "Queen", "Rishon", "Sefer",
                    "Tveria", "Urim", "Vered", "Wingate", "Express", "Yavniel", "Zikhron"
            },

    // Royal Air Force (1924-1942)
    RAF_1924_1942 = {
            "Ace", "Beer", "Charlie", "Don", "Edward", "Freddie", "George", "Harry",
            "Ink", "Johnnie", "King", "London", "Monkey", "Nuts", "Orange", "Pip", "Queen",
            "Robert", "Sugar", "Toc", "Uncle", "Vic", "William", "X-ray", "Yorker", "Zebra"
    },

    // Royal Air Force (1942-1943)
    RAF_1942_1943 = {
            "Apple", "Beer", "Charlie", "Dog", "Edward", "Freddy", "George", "Harry", "In", "Johnny",
    ...
    RAF_1943_1956 = {
            "Able-Affirm", "Baker", "Charlie", "Dog", "Easy", "Fox", "George", "How", "Item", "Johnny",
    ...
    AUSTRIAN = {
            ...
            "Heinrich", "Ida", "Julius", "Konrad", "Ludwig", "Martha", "Nordpol", "Otto", "Österreich",
            "Paula", "Quelle", "Richard", "Siegfried", "SCHule", "Theodor", "Ulrich", "Übel", "Viktor",
            "Wilhelm", "Xaver", "Ypsilon", "Zürich"
    },

    SWISS = {
            "Anna", "Äsch", "Berta", "Cäsar", "Daniel", "Emil", "Friedrich", "Gustav",
            "Heinrich", "Ida", "Jakob", "Kaiser", "Leopold", "Marie", "Niklaus", "Otto", "Örlikon",
            "Peter", "Quasi", "Rosa", "Sophie", "Theodor", "Ulrich", "Übermut", "Viktor",
            "Wilhelm", "Xaver", "Yverdon", "Zürich"
    },
        ...
        if (alphabet == MORSE) {
            ...
            for (i = 0; i < alphabet.length; i++) {
                ...
                for (k = 0; k < alphabet[i].length(); k++) {
                    if (alphabet[i].charAt(k) == Character.toLowerCase(alphabet[i].charAt(k)))
                        break;
                }
                // Values with first uppercase only
                if (k <= 1)
                    hash.put(alphabet[i].substring(0, k), alphabet[i]);
                else {
