 ...
 * ******************************************************************************
 *
 * @authors: Johann N. Loefflmann, Germany in cooperation with
...
public class PortugueseBrazilNumber extends SpokenNumber {
    ...
    protected static final String[]
            ...
            protected static final String[] line2 = {"onze ", "doze ", "treze ", "quatorze ", "quinze ", "dezesseis ", "dezessete ", "dezoito ", "dezenove "}; // 11-19
            protected static final String[] line3 = {"dez ", "vinte ", "trinta ", "quarenta ", "cinqüenta ", "sessenta ", "setenta ", "oitenta ", "noventa "};
    protected static final String[] line4 = {"cento ", "duzentos ", "trezentos ", "quatrocentos ", "quinhentos ", "seiscentos ", "setecentos ", "oitocentos ", "novecentos "};
    ...
    protected final static String NULL = "zero";
    protected final static String MINUS = "menos ";
    protected final static String AND = "e ";
    protected final static String HUNDERT = "cem ";
