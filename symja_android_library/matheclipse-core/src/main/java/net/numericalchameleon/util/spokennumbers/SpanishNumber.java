...
public class SpanishNumber extends SpokenNumber {
    ...
    private final static String[]// Cardinal numbers 30, 40, ..., 90:
    prefixTenths = {"treinta", "cuarenta", "cincuenta", "sesenta", "setenta", "ochenta", "noventa"};
    private final static String[]// Cardinal numbers 100, 200, 300,..., 900:
    prefixHundreds = {"ciento", "doscientos", "trescientos", "cuatrocientos", "quinientos", "seiscientos",
            "setecientos", "ochocientos", "novecientos"};
    private final static String[]// Cardinal numbers 10^6, 10^12, 10^18 & 10^24.  Plural & singular forms (note accented singulars).
    prefixGillions = {" millones ", " billones ", " trillones ", " cuatrillones "};
    private final static String UN = "un";
    private final static String[] prefix1Gillion = {UN + " millón ", UN + " billón ", UN + " trillón ", UN + " cuatrillón "};
