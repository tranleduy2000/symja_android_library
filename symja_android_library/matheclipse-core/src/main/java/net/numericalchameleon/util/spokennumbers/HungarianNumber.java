...
public class HungarianNumber extends SpokenNumber {
    ...
    private final static String
            MINUS = "mínusz";
    private final static String NULL = "nulla";

    private final static String[] _1to9 = {"egy", "kettő", "három", "négy", "öt", "hat", "hét", "nyolc", "kilenc"};
    private final static String[] _10to90 = {"tíz", "húsz", "harminc", "negyven", "ötven", "hatvan", "hetven", "nyolcvan", "kilencven"};
    private final static String[] _11to99PREFIX = {"tizen", "huszon", _10to90[2], _10to90[3], _10to90[4], _10to90[5], _10to90[6], _10to90[7], _10to90[8]};
    private final static String[] _100and1000PREFIX = {_1to9[0], "két", _1to9[2], _1to9[3], _1to9[4], _1to9[5], _1to9[6], _1to9[7], _1to9[8]};
    private final static String HUNDRED = "száz";
