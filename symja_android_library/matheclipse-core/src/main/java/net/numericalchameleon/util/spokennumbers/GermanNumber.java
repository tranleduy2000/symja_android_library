...
public class GermanNumber extends SpokenNumber {
    ...
    protected static final String[] line2 = {"elf", "zwölf", "dreizehn", "vierzehn", "fünfzehn", "sechzehn", "siebzehn", "achtzehn", "neunzehn"};
    protected static final String[] line3 = {"zehn", "zwanzig", "drei\u00DFig", "vierzig", "fünfzig", "sechzig", "siebzig", "achtzig", "neunzig"};
    ...
    private final static String EINS = "eins";
    private final static String UND = "und";
    private final static String HUNDERT = "hundert";
