...
public class TurkishNumber extends SpokenNumber {
    ...
    private final static String[] amount = {"bin ", "milyon ", "milyar ", "bilyon ", "bin bilyon", "trilyon ", "bin trilyon "};
    private final static String NULL = "s\u0131f\u0131r";
    private final static String MINUS = "eksi";
    private final static String HUNDRED = "yüz ";
