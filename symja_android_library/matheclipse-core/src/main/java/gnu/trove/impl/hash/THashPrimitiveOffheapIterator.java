 ...
 */
public abstract class THashPrimitiveOffheapIterator implements TPrimitiveIterator {

    /** the data structure this iterator traverses */
    protected final TPrimitiveOffheapHash _hash;
    /**
    ...
    /**
     * Creates a <tt>TPrimitiveOffheapIterator</tt> for the specified collection.
     *
     * @param hash the <tt>TPrimitiveOffheapHash</tt> we want to iterate over.
     */
    public THashPrimitiveOffheapIterator( TPrimitiveOffheapHash hash ) {
        _hash = hash;
    ...
    protected final int nextIndex() {
        ...
        TByteOffheapArray states = _hash._states;
        int i = _index;
        while ( i-- > 0 && ( states.get( i ) != TPrimitiveHash.FULL ) ) {
            ;
        }
        return i;
    }
