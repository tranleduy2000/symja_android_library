...
public class SortedMultiset_BottomUp<T extends Comparable<T>> extends TreeMap<T, Integer> implements SortedMultiset<T> {
	...
	public void addAll(Multiset<T> other) {
		if (other!=null) {
			...
			for (Entry<T, Integer> entry : other.entrySet()) {
	...
	public SortedMultiset<T> intersect(Multiset<T> other) {
		...
		if (other != null) {
			for (Entry<T, Integer> myEntry: this.entrySet()) {
	...
	public List<T> toList() {
		...
		for (Entry<T, Integer> entry : this.entrySet()) {
	...
	@Override
	public Iterator<Entry<T, Integer>> getTopDownIterator() {
	...
	public int compareTo(SortedMultiset<T> other) {
		...
		Iterator<Entry<T, Integer>> myEntryIter = this.getTopDownIterator();
		Iterator<Entry<T, Integer>> otherEntryIter = other.getTopDownIterator();
		while (myEntryIter.hasNext() && otherEntryIter.hasNext()) {
			Entry<T, Integer> myEntry = myEntryIter.next();
			T myKey = (myEntry!=null) ? myEntry.getKey() : null;
			Entry<T, Integer> otherEntry = otherEntryIter.next();
