{ 
 ...
 ArcCsc(-2/Sqrt(2+Sqrt(2)))=-3/8*Pi,
 ArcCsc(2/Sqrt(3))=1/3*Pi,
 ArcCsc(Sqrt(5)-1)=3/10*Pi,
 ArcCsc(1-Sqrt(5))=-3/10*Pi,
 ArcCsc(Sqrt(2))=1/4*Pi,
 ArcCsc(Sqrt(2+2/Sqrt(5)))=1/5*Pi,
 ArcCsc(-Sqrt(2+2/Sqrt(5)))=-1/5*Pi,
 ArcCsc(2)=1/6*Pi,
 ArcCsc(Sqrt(2*(2+Sqrt(2))))=1/8*Pi,
 ArcCsc(-Sqrt(2*(2+Sqrt(2))))=-1/8*Pi,
 ArcCsc(1+Sqrt(5))=1/10*Pi,
 ArcCsc(-1-Sqrt(5))=-1/10*Pi,
 ArcCsc(Sqrt(2)+Sqrt(6))=1/12*Pi,
 ArcCsc(-Sqrt(6)-Sqrt(2))=-1/12*Pi,
