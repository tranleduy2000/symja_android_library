...
public class Pods {
  ...
  static com.gx.common.base.Supplier<Trie<String, ArrayList<IPod>>> SOUNDEX_SUPPLIER =
      new com.gx.common.base.Supplier<Trie<String, ArrayList<IPod>>>() {
  ...
  private static com.gx.common.base.Supplier<Trie<String, ArrayList<IPod>>> LAZY_SOUNDEX =
...
//    }
  ...
  static IExpr parseInput(String inputStr, EvalEngine engine) {
    ...
    try {
      ...
      // android changed: java.lang.UnsupportedOperationException
...
//            }
        ...
        if (rest.argSize() > 2) {
          rest = rest.removeIf(new Predicate<IExpr>() {
            @Override
            public boolean test(IExpr x) {
              return x.toString().equals("in");
            }
          });
        }
